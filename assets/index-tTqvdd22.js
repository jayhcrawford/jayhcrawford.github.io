	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            text-decoration: underline;
                    ...
                    `}),s.map((e,i)=>k.jsx("a",{"aria-label":`Our ${e.name}`,href:e.url,target:"_blank",className:"glow-button socialbrick-link",children:k.jsx(NA,{name:e.name})},i))]})})};function PA(s){return s?s.toLowerCase().split(" ").map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(" "):""}const Es=()=>k.jsx("span",{className:"ml-5 mr-5",children:"|"}),ka=s=>k.jsx("li",{className:"hover:underline",children:k.jsx(Ju,{to:`${s.name}`,children:PA(s.name)})}),BA=s=>s.path=="/"?k.jsxs(k.Fragment,{children:[k.jsx("nav",{className:"z-10 w-ful",children:k.jsxs("ul",{style:{fontFamily:hu},className:`list-none p-0 pb-4 m-0 flex justify-center text-xl sm:text-3xl md:text-5xl ${Ts}`,children:[k.jsx(ka,{name:"about"}),k.jsx(Es,{}),k.jsx(ka,{name:"art"}),k.jsx(Es,{}),k.jsx(ka,{name:"projects"}),k.jsx(Es,{}),k.jsx(ka,{name:"contact"})]})}),k.jsxs("header",{style:{marginBottom:"70px"},children:[k.jsx("h1",{className:"text-center text-white",style:{fontFamily:ko,fontSize:s.width<500?"3rem":"6rem",fontWeight:"bold"},children:qu}),k.jsx("p",{className:`${Ts} text-5xl text-center`,style:{fontFamily:hu},children:"Interdisciplinary Creative & Programmer"}),k.jsx("p",{style:{fontFamily:ra},className:`text-center p-4 ${Ts} text-3xl`,children:"Los Angeles, CA"}),k.jsx(OA,{})]})]}):k.jsxs(k.Fragment,{children:[k.jsx("nav",{className:"z-10 w-full mb-5",children:k.jsxs("ul",{style:{fontFamily:hu},className:`list-none p-0 m-0 flex sm:text-2xl md:text-5xl ${Ts}`,children:[k.jsx(ka,{name:"about"}),k.jsx(Es,{}),k.jsx(ka,{name:"art"}),k.jsx(Es,{}),k.jsx(ka,{name:"projects"}),k.jsx(Es,{}),k.jsx(ka,{name:"contact"})]})}),k.jsxs("header",{style:{marginBottom:"70px"},children:[k.jsx(Ju,{to:"/",children:k.jsx("h1",{className:"text-white",style:{fontFamily:ko,fontSize:s.width<500?"1rem":"2rem",fontWeight:"bold"},children:qu})}),k.jsx("p",{className:`${Ts} text-3xl text-left`,style:{fontFamily:hu},children:"Interdisciplinary Creative & Programmer"})]})]}),zA=()=>{const{width:s,height:e}=M1(),i=pe.useRef(null),l=Za().pathname;return console.log(l,"is curernt"),pe.useEffect(()=>{const u=new GM,h=new oi(75,window.innerWidth/window.innerHeight,.1,1e3),d=new DA({alpha:!0});d.setClearColor(0,0),d.setSize(window.innerWidth,window.innerHeight),d.domElement.style.position="absolute",d.domElement.style.top="0",d.domElement.style.left="0",d.domElement.style.zIndex="-1",i.current instanceof HTMLElement&&!i.current.hasChildNodes()&&i.current.appendChild(d.domElement);const m=new Ps,p=new jd({color:65280}),g=new Ri(m,p);u.add(g),h.position.z=5;const x=()=>{g.rotation.x+=.01,g.rotation.y+=.01,d.render(u,h),requestAnimationFrame(x)};return x(),()=>{i.current&&i.current.removeChild(d.domElement)}},[]),console.log(s,"is the width; and the height is: ",e),k.jsxs("div",{id:"outer_bg",children:[k.jsx("div",{style:{position:"fixed",top:0,left:0,width:`${s}px`,height:`${e}px`,overflow:"hidden"},children:k.jsx(IA,{})}),k.jsxs("div",{id:"inner_bg",ref:i,style:{position:"relative",width:"95vw",margin:"auto"},children:[k.jsx("div",{className:`flex justify-end ${l=="/"?"mb-60":"mb-30"}`,children:k.jsx("span",{className:"fixed z-100",children:k.jsx("a",{href:Av,target:"_blank",rel:"noopener noreferrer",children:k.jsx("button",{className:"mt-4 border-2 bg-white p-3 rounded-lg cursor-pointer",children:k.jsx(LA,{})})})})}),k.jsx("div",{children:k.jsx(BA,{width:s,path:l})}),k.jsxs("div",{id:"body_div",children:[k.jsx("main",{children:k.jsxs(CS,{children:[k.jsx(Fo,{path:"/about",element:k.jsx(u1,{})}),k.jsx(Fo,{path:"/projects",element:k.jsx(d1,{width:s})}),k.jsx(Fo,{path:"/art",element:k.jsx(y1,{width:s})}),k.jsx(Fo,{path:"/contact",element:k.jsx(S1,{})})]})}),k.jsx(UA,{path:l})]})]})]})},IA=()=>k.jsxs("svg",{id:"Layer_6","data-name":"Layer 6",xmlns:"http://www.w3.org/2000/svg",xmlnsXlink:"http://www.w3.org/1999/xlink",viewBox:"0 0 1050 990",children:[k.jsx("defs",{children:k.jsx("style",{children:`
      .cls-1 {
        fill: #0e1a34;
      }
