...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            opacity: 100%;
                    ...
                    `}),s.map((e,i)=>z.jsx("a",{"aria-label":`Our ${e.name}`,href:e.url,target:"_blank",className:"glow-button socialbrick-link",children:z.jsx(NA,{name:e.name})},i))]})})};function PA(s){return s?s.toLowerCase().split(" ").map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(" "):""}const bs=()=>z.jsx("span",{className:`${ko} ml-5 mr-5`,children:"|"}),ka=s=>z.jsx("li",{style:{transition:"opacity .1s .1s"},className:`${ko} hover:underline hover:opacity-100`,children:z.jsx(Ur,{to:`${s.name}`,children:PA(s.name)})}),BA=s=>s.path=="/"?z.jsxs(z.Fragment,{children:[z.jsx("nav",{className:"z-10 w-ful",children:z.jsxs("ul",{style:{fontFamily:Go},className:"list-none p-0 pb-4 m-0 flex justify-center text-xl sm:text-3xl md:text-5xl",children:[z.jsx(ka,{name:"about"}),z.jsx(bs,{}),z.jsx(ka,{name:"art"}),z.jsx(bs,{}),z.jsx(ka,{name:"projects"}),z.jsx(bs,{}),z.jsx(ka,{name:"contact"})]})}),z.jsxs("header",{style:{marginBottom:"70px"},children:[z.jsx("h1",{className:"text-center text-white",style:{fontFamily:Cs,fontSize:s.width<500?"3rem":"6rem",fontWeight:"bold"},children:jc}),z.jsx("p",{className:`${ko} text-5xl text-center`,style:{fontFamily:Go},children:"Interdisciplinary Creative & Programmer"}),z.jsx("p",{style:{fontFamily:ra},className:`text-center p-4 ${ko} text-3xl`,children:"Los Angeles, CA"}),z.jsx(OA,{})]})]}):z.jsxs(z.Fragment,{children:[z.jsx("nav",{className:"z-10 w-full mb-5",children:z.jsxs("ul",{style:{fontFamily:Go},className:"list-none p-0 m-0 flex sm:text-2xl md:text-5xl",children:[z.jsx(ka,{name:"about"}),z.jsx(bs,{}),z.jsx(ka,{name:"art"}),z.jsx(bs,{}),z.jsx(ka,{name:"projects"}),z.jsx(bs,{}),z.jsx(ka,{name:"contact"})]})}),z.jsxs("header",{style:{marginBottom:"70px"},children:[z.jsx(Ur,{to:"/",children:z.jsx("h1",{className:"text-white",style:{fontFamily:Cs,fontSize:s.width<500?"1rem":"2rem",fontWeight:"bold"},children:jc})}),z.jsx("p",{className:`${ko} text-3xl text-left`,style:{fontFamily:Go},children:"Interdisciplinary Creative & Programmer"})]})]}),zA=s=>{let e="";return z.jsxs(z.Fragment,{children:[z.jsx("style",{children:`
        #location-bar {
        }
    ...
    `}),z.jsx("div",{id:"location-bar",children:s.split().map((i,r)=>(e+="/"+i,z.jsxs("span",{children:[z.jsx(Ur,{to:e,children:z.jsx("button",{className:"location-bar-bttn",children:i})}),r<s.split().length-1&&z.jsx("span",{className:"location-bar-arrow",children:">"})]},`${r}-location`)))})]})},IA=()=>z.jsxs("svg",{id:"Layer_6","data-name":"Layer 6",xmlns:"http://www.w3.org/2000/svg",xmlnsXlink:"http://www.w3.org/1999/xlink",viewBox:"0 0 1050 990",children:[z.jsx("defs",{children:z.jsx("style",{children:`
      .cls-1 {
        fill: #0e1a34;
      }
      ...
      }`}),z.jsx(Ur,{to:s.url?s.url:"",children:z.jsx("div",{className:` text-white m-6 justify-center ${s.width<750?"flex flex-col":"flex"}`,children:z.jsxs("div",{className:` ${s.width<750?"flex flex-col items-center":"flex w-[70%]"}`,children:[z.jsx("div",{className:"p-1 m-1",children:z.jsx(HA,{img:s.img})}),z.jsxs("div",{className:`ml-10 ${s.width<750?"mt-8 w-full pr-20":"flex flex-col justify-center mb-10"}`,children:[z.jsx("h4",{style:{fontFamily:Cs},className:"text-2xl",children:s.title}),z.jsx("p",{style:{fontFamily:ra},children:s.about_txt})]})]})})}),z.jsx("hr",{})]}),HA=s=>z.jsxs(z.Fragment,{children:[z.jsx("div",{className:"h-30 w-30 absolute",children:z.jsx("img",{src:"./under_construction.svg"})}),z.jsx("div",{style:{boxShadow:"5px 5px 5px rgba(0, 0, 0, 1)"},className:"w-80 h-60",children:z.jsx("img",{className:"rounded-lg w-80 h-60",style:{objectFit:"cover"},src:s.img})})]}),GA=s=>z.jsxs("div",{style:{fontFamily:ra},children:[z.jsx("hr",{}),s.blog_array.map((e,i)=>z.jsx(FA,{url:e.url?e.url:"",title:e.title,about_txt:e.about_txt,img:e.img,width:s.width},i))]}),VA=s=>z.jsx(GA,{width:s.width,blog_array:s.blog_array}),kA=[{title:"My Place",img:"https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/web-icons/Web+Hosted/3d-project-icons/orthographic-icon.jpg",about_txt:"Autodesk Maya and Arnold project."},{title:"Door Project",img:"https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/web-icons/Web+Hosted/3d-project-icons/3d-door-project-icon.jpg",about_txt:"Based on a drawing, built in Blender to emulate the drawing."},{title:"3D Me :-)",img:"https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/web-icons/Web+Hosted/3d-project-icons/3d-jay-icon.jpg",about_txt:"Fully rigged, simple 3D character modeled after me. This helped me to better understand topology, weight-painting, and rigging."}],XA=[{category:"3D Projects",img:"https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/web-icons/Web+Hosted/3d-project-icons/orthographic-icon.jpg",url:"3d"},{category:"UrFriends - SASS",img:"https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/web-icons/Web+Hosted/blog-images/UR_Friends.webp"},{category:"The Book",img:"https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/web-icons/Web+Hosted/blog-images/TheBook.webp"},{category:"The RIP Sheet",img:"https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/web-icons/Web+Hosted/blog-images/RIP.webp"},{category:"Widow Bags",img:"https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/web-icons/Web+Hosted/product-design-icons/widow-icon.jpg"}],WA=[{title:"Projects",url:"/projects"},{title:"3D Projects",url:"hi"}],qA=()=>{const{width:s,height:e}=M1(),i=pe.useRef(null),l=Za().pathname;function c(){return l.split("/").filter((h,d)=>d!==0)}return console.log(l,"is curernt"),pe.useEffect(()=>{const h=new GM,d=new oi(75,window.innerWidth/window.innerHeight,.1,1e3),p=new DA({alpha:!0});p.setClearColor(0,0),p.setSize(window.innerWidth,window.innerHeight),p.domElement.style.position="absolute",p.domElement.style.top="0",p.domElement.style.left="0",p.domElement.style.zIndex="-1",i.current instanceof HTMLElement&&!i.current.hasChildNodes()&&i.current.appendChild(p.domElement);const m=new zs,g=new Yd({color:65280}),x=new Ri(m,g);h.add(x),d.position.z=5;const v=()=>{x.rotation.x+=.01,x.rotation.y+=.01,p.render(h,d),requestAnimationFrame(v)};return v(),()=>{i.current&&i.current.removeChild(p.domElement)}},[]),console.log(s,"is the width; and the height is: ",e),z.jsxs("div",{id:"outer_bg",children:[z.jsx("div",{style:{position:"fixed",top:0,left:0,width:`${s}px`,height:`${e}px`,overflow:"hidden"},children:z.jsx(IA,{})}),z.jsxs("div",{id:"inner_bg",ref:i,style:{position:"relative",width:"95vw",margin:"auto"},children:[z.jsx("div",{className:`flex justify-end ${l=="/"?"mb-60":"mb-30"}`,children:z.jsx("span",{className:"fixed z-100",children:z.jsx("a",{href:Rv,target:"_blank",rel:"noopener noreferrer",children:z.jsx("button",{className:"mt-4 border-2 bg-white p-3 rounded-lg cursor-pointer",children:z.jsx(LA,{})})})})}),z.jsxs("div",{children:[z.jsx(BA,{width:s,path:l}),c().length>1&&z.jsx(zA,{split:c,locationData:WA})]}),z.jsxs("div",{id:"body_div",children:[z.jsx("main",{children:z.jsxs(DS,{children:[z.jsx(Ts,{path:"/about",element:z.jsx(u1,{})}),z.jsx(Ts,{path:"/projects/3d",element:z.jsx(VA,{width:s,blog_array:kA})}),z.jsx(Ts,{path:"/projects",element:z.jsx(m1,{width:s,category_array:XA})}),z.jsx(Ts,{path:"/art",element:z.jsx(y1,{width:s})}),z.jsx(Ts,{path:"/contact",element:z.jsx(S1,{})})]})}),z.jsx(UA,{path:l})]})]})]})};Fy.createRoot(document.getElementById("root")).render(z.jsx(pe.StrictMode,{children:z.jsx(e1,{children:z.jsx(qA,{})})}));
