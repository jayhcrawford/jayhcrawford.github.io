 ...
 */var M0;function Dy(){if(M0)return Lo;M0=1;var s=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(r,l,c){var h=null;if(c!==void 0&&(h=""+c),l.key!==void 0&&(h=""+l.key),"key"in l){c={};for(var d in l)d!=="key"&&(c[d]=l[d])}else c=l;return l=c.ref,{$$typeof:s,type:r,key:h,ref:l!==void 0?l:null,props:c}}return Lo.Fragment=e,Lo.jsx=i,Lo.jsxs=i,Lo}var E0;function Uy(){return E0||(E0=1,rh.exports=Dy()),rh.exports}var z=Uy(),sh={exports:{}},rt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
`)+`
`+_);const U=O+y+h,C=O+_+d,H=b_(l,l.VERTEX_SHADER,U),k=b_(l,l.FRAGMENT_SHADER,C);l.attachShader(A,H),l.attachShader(A,k),i.index0AttributeName!==void 0?l.bindAttribLocation(A,0,i.index0AttributeName):i.morphTargets===!0&&l.bindAttribLocation(A,0,"position"),l.linkProgram(A);function I(V){if(s.debug.checkShaderErrors){const ce=l.getProgramInfoLog(A).trim(),oe=l.getShaderInfoLog(H).trim(),xe=l.getShaderInfoLog(k).trim();let de=!0,B=!0;if(l.getProgramParameter(A,l.LINK_STATUS)===!1)if(de=!1,typeof s.debug.onShaderError=="function")s.debug.onShaderError(l,A,H,k);else{const K=A_(l,H,"vertex"),Y=A_(l,k,"fragment");console.error("THREE.WebGLProgram: Shader Error "+l.getError()+" - VALIDATE_STATUS "+l.getProgramParameter(A,l.VALIDATE_STATUS)+`
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            opacity: 100%;
                    ...
                    `}),s.map((e,i)=>z.jsx("a",{"aria-label":`Our ${e.name}`,href:e.url,target:"_blank",className:"glow-button socialbrick-link",children:z.jsx(NA,{name:e.name})},i))]})})};function PA(s){return s?s.toLowerCase().split(" ").map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(" "):""}const Es=()=>z.jsx("span",{className:`${ko} ml-5 mr-5`,children:"|"}),ka=s=>z.jsx("li",{style:{transition:"opacity .1s .1s"},className:`${ko} hover:underline hover:opacity-100`,children:z.jsx(Ps,{to:`${s.name}`,children:PA(s.name)})}),BA=s=>s.path=="/"?z.jsxs(z.Fragment,{children:[z.jsx("nav",{className:"z-10 w-ful",children:z.jsxs("ul",{style:{fontFamily:Go},className:"list-none p-0 pb-4 m-0 flex justify-center text-xl sm:text-3xl md:text-5xl",children:[z.jsx(ka,{name:"about"}),z.jsx(Es,{}),z.jsx(ka,{name:"art"}),z.jsx(Es,{}),z.jsx(ka,{name:"projects"}),z.jsx(Es,{}),z.jsx(ka,{name:"contact"})]})}),z.jsxs("header",{style:{marginBottom:"70px"},children:[z.jsx("h1",{className:"text-center text-white",style:{fontFamily:ws,fontSize:s.width<500?"3rem":"6rem",fontWeight:"bold"},children:jc}),z.jsx("p",{className:`${ko} text-5xl text-center`,style:{fontFamily:Go},children:"Interdisciplinary Creative & Programmer"}),z.jsx("p",{style:{fontFamily:ra},className:`text-center p-4 ${ko} text-3xl`,children:"Los Angeles, CA"}),z.jsx(OA,{})]})]}):z.jsxs(z.Fragment,{children:[z.jsx("nav",{className:"z-10 w-full mb-5",children:z.jsxs("ul",{style:{fontFamily:Go},className:"list-none p-0 m-0 flex sm:text-2xl md:text-5xl",children:[z.jsx(ka,{name:"about"}),z.jsx(Es,{}),z.jsx(ka,{name:"art"}),z.jsx(Es,{}),z.jsx(ka,{name:"projects"}),z.jsx(Es,{}),z.jsx(ka,{name:"contact"})]})}),z.jsxs("header",{style:{marginBottom:"70px"},children:[z.jsx(Ps,{to:"/",children:z.jsx("h1",{className:"text-white",style:{fontFamily:ws,fontSize:s.width<500?"1rem":"2rem",fontWeight:"bold"},children:jc})}),z.jsx("p",{className:`${ko} text-3xl text-left`,style:{fontFamily:Go},children:"Interdisciplinary Creative & Programmer"})]})]}),zA=s=>z.jsxs(z.Fragment,{children:[z.jsx("style",{children:`
        #location-bar {
        }
