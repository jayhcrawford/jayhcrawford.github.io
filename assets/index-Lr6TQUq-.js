 ...
 */var M0;function Dy(){if(M0)return Do;M0=1;var s=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(r,l,u){var h=null;if(u!==void 0&&(h=""+u),l.key!==void 0&&(h=""+l.key),"key"in l){u={};for(var d in l)d!=="key"&&(u[d]=l[d])}else u=l;return l=u.ref,{$$typeof:s,type:r,key:h,ref:l!==void 0?l:null,props:u}}return Do.Fragment=e,Do.jsx=i,Do.jsxs=i,Do}var E0;function Uy(){return E0||(E0=1,ah.exports=Dy()),ah.exports}var W=Uy(),rh={exports:{}},rt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
`)}function G2(s,e){let i;switch(e){case q1:i="Linear";break;case Y1:i="Reinhard";break;case j1:i="Cineon";break;case Z1:i="ACESFilmic";break;case Q1:i="AgX";break;case J1:i="Neutral";break;case K1:i="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),i="Linear"}return"vec3 "+s+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Ou=new se;function V2(){bt.getLuminanceCoefficients(Ou);const s=Ou.x.toFixed(4),e=Ou.y.toFixed(4),i=Ou.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${s}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function k2(s){return[s.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",s.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Ho).join(`
`)}function X2(s){const e=[];for(const i in s){const r=s[i];r!==!1&&e.push("#define "+i+" "+r)}return e.join(`
`)}function W2(s,e){const i={},r=s.getProgramParameter(e,s.ACTIVE_ATTRIBUTES);for(let l=0;l<r;l++){const u=s.getActiveAttrib(e,l),h=u.name;let d=1;u.type===s.FLOAT_MAT2&&(d=2),u.type===s.FLOAT_MAT3&&(d=3),u.type===s.FLOAT_MAT4&&(d=4),i[h]={type:u.type,location:s.getAttribLocation(e,h),locationSize:d}}return i}function Ho(s){return s!==""}function w_(s,e){const i=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return s.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function C_(s,e){return s.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const q2=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ud(s){return s.replace(q2,j2)}const Y2=new Map;function j2(s,e){let i=lt[e];if(i===void 0){const r=Y2.get(e);if(r!==void 0)i=lt[r],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,r);else throw new Error("Can not resolve #include <"+e+">")}return Ud(i)}const Z2=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function D_(s){return s.replace(Z2,K2)}function K2(s,e,i,r){let l="";for(let u=parseInt(e);u<parseInt(i);u++)l+=r.replace(/\[\s*i\s*\]/g,"[ "+u+" ]").replace(/UNROLLED_LOOP_INDEX/g,u);return l}function U_(s){let e=`precision ${s.precision} float;
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            text-decoration: underline;
            }`}),W.jsx("ul",{id:"footer-contact-ul",className:"text-md text-left",children:W.jsx("li",{children:W.jsxs("a",{href:"mailto:jayhcrawford@gmail.com",children:[W.jsx("p",{className:"font-bold",children:Wu}),W.jsxs("span",{className:"font-normal",style:{fontFamily:ra},children:[W.jsx("p",{children:"Los Angeles, CA"}),W.jsx("p",{children:"jayhcrawford@gmail.com"})]})]})})})]}),W.jsxs("div",{className:"grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2 text-left",children:[W.jsxs("div",{children:[W.jsx("h2",{className:"text-sm font-bold uppercase text-white",children:"Social"}),W.jsxs("ul",{style:{fontFamily:ra},className:"text-white  font-medium mt-3 mb-10",children:[W.jsx("li",{children:W.jsx("a",{href:Rv,target:"new",className:"hover:underline",children:"LinkedIn"})}),W.jsx("li",{className:"",children:W.jsx("a",{href:bv,target:"new",className:"hover:underline",children:"Instagram"})}),W.jsx("li",{children:W.jsx("a",{href:Av,target:"new",className:"hover:underline",children:"TikTok"})}),W.jsx("li",{children:W.jsx("a",{href:Ld,target:"new",className:"hover:underline",children:"Github"})})]})]}),W.jsx("div",{})]})]}),W.jsxs("div",{className:"sm:flex sm:items-center sm:justify-between",children:[W.jsxs("span",{style:{fontFamily:ra},className:"font-normal text-sm text-white sm:text-center",children:[e," - ",Wu]}),W.jsx("div",{className:"flex mt-4 sm:justify-center sm:mt-0",children:W.jsxs("a",{href:Ld,target:"new",className:"text-white hover:white ms-5",children:[W.jsx("svg",{className:"w-4 h-4","aria-hidden":"true",xmlns:"http://www.w3.org/2000/svg",fill:"currentColor",viewBox:"0 0 20 20",children:W.jsx("path",{fillRule:"evenodd",d:"M10 .333A9.911 9.911 0 0 0 6.866 19.65c.5.092.678-.215.678-.477 0-.237-.01-1.017-.014-1.845-2.757.6-3.338-1.169-3.338-1.169a2.627 2.627 0 0 0-1.1-1.451c-.9-.615.07-.6.07-.6a2.084 2.084 0 0 1 1.518 1.021 2.11 2.11 0 0 0 2.884.823c.044-.503.268-.973.63-1.325-2.2-.25-4.516-1.1-4.516-4.9A3.832 3.832 0 0 1 4.7 7.068a3.56 3.56 0 0 1 .095-2.623s.832-.266 2.726 1.016a9.409 9.409 0 0 1 4.962 0c1.89-1.282 2.717-1.016 2.717-1.016.366.83.402 1.768.1 2.623a3.827 3.827 0 0 1 1.02 2.659c0 3.807-2.319 4.644-4.525 4.889a2.366 2.366 0 0 1 .673 1.834c0 1.326-.012 2.394-.012 2.72 0 .263.18.572.681.475A9.911 9.911 0 0 0 10 .333Z",clipRule:"evenodd"})}),W.jsx("span",{className:"sr-only",children:"GitHub account"})]})})]})]})})},LA=()=>W.jsx("div",{style:{fontFamily:ra,display:"flex",justifyContent:"center"},children:W.jsx("div",{children:W.jsx("img",{className:" w-30",style:{marginLeft:"10px"},src:"./LinkedIn_Logo.svg"})})}),NA=s=>W.jsx("div",{className:"social_brick_icon_container",style:{width:"150px"},children:W.jsxs("svg",{id:"Layer_1","data-name":"Layer 1",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 40 40",className:"social-svg",children:[W.jsx("defs",{children:W.jsx("style",{children:`
                    .social-svg {
                        fill: white;
                    ...
                    `}),s.map((e,i)=>W.jsx("a",{"aria-label":`Our ${e.name}`,href:e.url,target:"_blank",className:"glow-button socialbrick-link",children:W.jsx(NA,{name:e.name})},i))]})})};function PA(s){return s?s.toLowerCase().split(" ").map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(" "):""}const Es=()=>W.jsx("span",{className:"ml-5 mr-5",children:"|"}),ka=s=>W.jsx("li",{children:W.jsx(Qu,{to:`${s.name}`,children:PA(s.name)})}),BA=s=>s.path=="/"?W.jsxs(W.Fragment,{children:[W.jsx("nav",{className:"z-10 w-ful",children:W.jsxs("ul",{style:{fontFamily:fu},className:`list-none p-0 m-0 flex justify-center sm:text-lg md:text-5xl ${Ts}`,children:[W.jsx(ka,{name:"about"}),W.jsx(Es,{}),W.jsx(ka,{name:"art"}),W.jsx(Es,{}),W.jsx(ka,{name:"projects"}),W.jsx(Es,{}),W.jsx(ka,{name:"contact"})]})}),W.jsxs("header",{style:{marginBottom:"70px"},children:[W.jsx("h1",{className:"text-center text-white",style:{fontFamily:Vo,fontSize:s.width<500?"3rem":"6rem",fontWeight:"bold"},children:Wu}),W.jsx("p",{className:`${Ts} text-5xl text-center`,style:{fontFamily:fu},children:"Interdisciplinary Creative & Programmer"}),W.jsx("p",{style:{fontFamily:ra},className:`text-center p-4 ${Ts} text-3xl`,children:"Los Angeles, CA"}),W.jsx(OA,{})]})]}):W.jsxs(W.Fragment,{children:[W.jsx("nav",{className:"z-10 w-full mb-5",children:W.jsxs("ul",{style:{fontFamily:fu},className:`list-none p-0 m-0 flex sm:text-2xl md:text-5xl ${Ts}`,children:[W.jsx(ka,{name:"about"}),W.jsx(Es,{}),W.jsx(ka,{name:"art"}),W.jsx(Es,{}),W.jsx(ka,{name:"projects"}),W.jsx(Es,{}),W.jsx(ka,{name:"contact"})]})}),W.jsxs("header",{style:{marginBottom:"70px"},children:[W.jsx(Qu,{to:"/",children:W.jsx("h1",{className:"text-white",style:{fontFamily:Vo,fontSize:s.width<500?"1rem":"2rem",fontWeight:"bold"},children:Wu})}),W.jsx("p",{className:`${Ts} text-3xl text-left`,style:{fontFamily:fu},children:"Interdisciplinary Creative & Programmer"})]})]}),zA=()=>{const{width:s,height:e}=M1(),i=pe.useRef(null),l=Za().pathname;return console.log(l,"is curernt"),pe.useEffect(()=>{const u=new GM,h=new oi(75,window.innerWidth/window.innerHeight,.1,1e3),d=new DA({alpha:!0});d.setClearColor(0,0),d.setSize(window.innerWidth,window.innerHeight),d.domElement.style.position="absolute",d.domElement.style.top="0",d.domElement.style.left="0",d.domElement.style.zIndex="-1",i.current instanceof HTMLElement&&!i.current.hasChildNodes()&&i.current.appendChild(d.domElement);const m=new Ps,p=new jd({color:65280}),g=new Ri(m,p);u.add(g),h.position.z=5;const x=()=>{g.rotation.x+=.01,g.rotation.y+=.01,d.render(u,h),requestAnimationFrame(x)};return x(),()=>{i.current&&i.current.removeChild(d.domElement)}},[]),console.log(s,"is the width; and the height is: ",e),W.jsxs("div",{id:"outer_bg",children:[W.jsx("div",{style:{position:"fixed",top:0,left:0,width:`${s}px`,height:`${e}px`,overflow:"hidden"},children:W.jsx(IA,{})}),W.jsxs("div",{id:"inner_bg",ref:i,style:{position:"relative",width:"95vw",margin:"auto"},children:[W.jsx("div",{className:`flex justify-end ${l=="/"?"mb-60":"mb-30"}`,children:W.jsx("span",{className:"fixed z-100",children:W.jsx("a",{href:Rv,target:"_blank",rel:"noopener noreferrer",children:W.jsx("button",{className:"mt-4 border-2 bg-white p-3 rounded-lg cursor-pointer",children:W.jsx(LA,{})})})})}),W.jsx("div",{children:W.jsx(BA,{width:s,path:l})}),W.jsxs("div",{id:"body_div",children:[W.jsx("main",{children:W.jsxs(DS,{children:[W.jsx(Fo,{path:"/about",element:W.jsx(c1,{})}),W.jsx(Fo,{path:"/projects",element:W.jsx(d1,{width:s})}),W.jsx(Fo,{path:"/art",element:W.jsx(y1,{width:s})}),W.jsx(Fo,{path:"/contact",element:W.jsx(S1,{})})]})}),W.jsx(UA,{path:l})]})]})]})},IA=()=>W.jsxs("svg",{id:"Layer_6","data-name":"Layer 6",xmlns:"http://www.w3.org/2000/svg",xmlnsXlink:"http://www.w3.org/1999/xlink",viewBox:"0 0 1050 990",children:[W.jsx("defs",{children:W.jsx("style",{children:`
      .cls-1 {
        fill: #0e1a34;
      }
