...
#define LOW_PRECISION`),e}function YA(s){let e="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===qv?e="SHADOWMAP_TYPE_PCF":s.shadowMapType===MM?e="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===$i&&(e="SHADOWMAP_TYPE_VSM"),e}function jA(s){let e="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case As:case Rs:e="ENVMAP_TYPE_CUBE";break;case Wu:e="ENVMAP_TYPE_CUBE_UV";break}return e}function ZA(s){let e="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Rs:e="ENVMAP_MODE_REFRACTION";break}return e}function KA(s){let e="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case Yv:e="ENVMAP_BLENDING_MULTIPLY";break;case GM:e="ENVMAP_BLENDING_MIX";break;case VM:e="ENVMAP_BLENDING_ADD";break}return e}function QA(s){const e=s.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,r=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),7*16)),texelHeight:r,maxMip:i}}function JA(s,e,i,r){const l=s.getContext(),u=i.defines;let h=i.vertexShader,d=i.fragmentShader;const m=YA(i),p=jA(i),g=ZA(i),x=KA(i),v=QA(i),M=FA(i),E=HA(u),A=l.createProgram();let S,_,O=i.glslVersion?"#version "+i.glslVersion+`
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            text-decoration: underline;
                    ...
                    `}),s.map((e,i)=>ue.jsx("a",{"aria-label":`Our ${e.name}`,href:e.url,target:"_blank",className:"glow-button socialbrick-link",children:ue.jsx(DR,{name:e.name})},i))]})})},LR=s=>ue.jsxs(ue.Fragment,{children:[ue.jsx("nav",{className:"z-10 w-full",children:ue.jsxs("ul",{style:{fontFamily:U_},className:`list-none p-0 m-0 flex justify-center ${L_}`,children:[ue.jsx("li",{className:"",children:ue.jsx(ys,{to:"/about",children:"About"})}),ue.jsx(Bh,{}),ue.jsx("li",{children:ue.jsx(ys,{to:"/projects",children:"Projects"})}),ue.jsx(Bh,{}),ue.jsx("li",{children:ue.jsx(ys,{to:"/art",children:"Art"})}),ue.jsx(Bh,{}),ue.jsx("li",{children:ue.jsx(ys,{to:"/contact",children:"Contact"})})]})}),ue.jsxs("header",{style:{marginBottom:"70px"},children:[ue.jsx("h1",{style:{fontFamily:lM,fontSize:s.width<500?"3rem":"6rem",fontWeight:"bold"},children:Fh}),ue.jsx(UR,{}),ue.jsx("p",{className:`${L_}`,style:{fontFamily:U_},children:"Interdisciplinary Creative & Programmer"})]})]}),NR=()=>{const{width:s,height:e}=Wv(),i=pe.useRef(null);return pe.useEffect(()=>{const r=new d0,l=new Qn(75,window.innerWidth/window.innerHeight,.1,1e3),u=new y0({alpha:!0});u.setClearColor(0,0),u.setSize(window.innerWidth,window.innerHeight),u.domElement.style.position="absolute",u.domElement.style.top="0",u.domElement.style.left="0",u.domElement.style.zIndex="-1",i.current instanceof HTMLElement&&!i.current.hasChildNodes()&&i.current.appendChild(u.domElement);const h=new wr,d=new Yu({color:65280}),m=new gi(h,d);r.add(m),l.position.z=5;const p=()=>{m.rotation.x+=.01,m.rotation.y+=.01,u.render(r,l),requestAnimationFrame(p)};return p(),()=>{i.current&&i.current.removeChild(u.domElement)}},[]),console.log(s,"is the width; and the height is: ",e),ue.jsxs("div",{id:"outer_bg",children:[ue.jsx(AR,{}),ue.jsxs("div",{id:"inner_bg",ref:i,style:{position:"relative",width:"95vw",margin:"auto"},children:[ue.jsx("div",{className:"flex justify-end mb-60",children:ue.jsx("span",{className:"fixed",children:ue.jsx("a",{href:"https://www.linkedin.com/in/jay-crawford-prod/",target:"_blank",rel:"noopener noreferrer",children:ue.jsx("button",{className:"border-2",children:ue.jsx(CR,{width:s})})})})}),ue.jsx("div",{children:ue.jsx(LR,{width:s})}),ue.jsxs("div",{id:"body_div",style:{textAlign:"center"},children:[ue.jsx("main",{children:ue.jsxs(Ry,{children:[ue.jsx(Bo,{path:"/about",element:ue.jsx(oM,{})}),ue.jsx(Bo,{path:"/projects",element:ue.jsx(cM,{})}),ue.jsx(Bo,{path:"/art",element:ue.jsx(vM,{})}),ue.jsx(Bo,{path:"/contact",element:ue.jsx(xM,{})})]})}),ue.jsx(wR,{})]})]})]})};BS.createRoot(document.getElementById("root")).render(ue.jsx(pe.StrictMode,{children:ue.jsx(Qy,{children:ue.jsx(NR,{})})}));
