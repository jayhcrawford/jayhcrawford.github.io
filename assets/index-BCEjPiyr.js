...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `}),rw(a.name)]})}),sw=a=>a.path=="/"?b.jsxs(b.Fragment,{children:[b.jsx("nav",{className:"z-10 w-ful",children:b.jsxs("ul",{style:{fontFamily:kr},className:"list-none p-0 pb-4 m-0 flex justify-center text-xl sm:text-3xl md:text-5xl",children:[b.jsx(rr,{name:"about"}),b.jsx(Fs,{}),b.jsx(rr,{name:"art"}),b.jsx(Fs,{}),b.jsx(rr,{name:"projects"}),b.jsx(Fs,{}),b.jsx(rr,{name:"contact"})]})}),b.jsxs("header",{style:{marginBottom:"70px"},children:[b.jsx("h1",{className:"text-center text-white",style:{fontFamily:ki,fontSize:a.width<500?"3rem":"6rem",fontWeight:"bold"},children:ol}),b.jsxs("p",{className:`${il} text-5xl text-center`,style:{fontFamily:kr},children:[b.jsx("span",{className:"block",children:"Engineering Student,"}),b.jsx("span",{children:"Interdisciplinary Creative & Programmer"})]}),b.jsx("p",{style:{fontFamily:Vi},className:`text-center p-4 ${il} text-3xl`,children:"Los Angeles, CA"}),b.jsx(aw,{})]})]}):b.jsxs(b.Fragment,{children:[b.jsx("nav",{className:"z-10 w-full mb-5",children:b.jsxs("ul",{style:{fontFamily:kr},className:"list-none p-0 m-0 flex sm:text-2xl md:text-5xl",children:[b.jsx(rr,{name:"about"}),b.jsx(Fs,{}),b.jsx(rr,{name:"art"}),b.jsx(Fs,{}),b.jsx(rr,{name:"projects"}),b.jsx(Fs,{}),b.jsx(rr,{name:"contact"})]})}),b.jsxs("header",{style:{marginBottom:"70px"},children:[b.jsx(Wr,{to:"/",children:b.jsx("h1",{className:"text-white",style:{fontFamily:ki,fontSize:a.width<500?"1rem":"2rem",fontWeight:"bold"},children:ol})}),b.jsx("p",{className:`${il} text-3xl text-left`,style:{fontFamily:kr},children:"Interdisciplinary Creative & Programmer"})]})]}),ow=()=>b.jsx("img",{className:"w-30 ",src:"./LinkedIn_Logo.svg"}),lw=a=>{let e="";const n=new Map(a.locationData.map(l=>[l.url.replace(/^\//,""),l.title])),s=l=>l.replace(/[_-]/g," ").trim().split(" ").filter(Boolean).map(f=>f.charAt(0).toUpperCase()+f.slice(1)).join(" ");return b.jsxs(b.Fragment,{children:[b.jsx("style",{children:`
        #location-bar {
        }
