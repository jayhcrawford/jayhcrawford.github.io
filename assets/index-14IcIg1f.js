...
void main() {
	...
	if ( coord.x >= 1.0 ) {
        ...
        `}),fw(a.name)]})}),hw=a=>a.path=="/"?M.jsxs(M.Fragment,{children:[M.jsx("nav",{className:"z-10 w-ful",children:M.jsxs("ul",{style:{fontFamily:Xr},className:"list-none p-0 pb-4 m-0 flex justify-center text-xl sm:text-3xl md:text-5xl",children:[M.jsx(sr,{name:"about"}),M.jsx(Gs,{}),M.jsx(sr,{name:"art"}),M.jsx(Gs,{}),M.jsx(sr,{name:"projects"}),M.jsx(Gs,{}),M.jsx(sr,{name:"contact"})]})}),M.jsxs("header",{style:{marginBottom:"70px"},children:[M.jsx("h1",{className:"text-center text-white",style:{fontFamily:ji,fontSize:a.width<500?"3rem":"6rem",fontWeight:"bold"},children:ul}),M.jsxs("p",{className:`${rl} text-5xl text-center`,style:{fontFamily:Xr},children:[M.jsx("span",{className:"block",children:"Engineering Student,"}),M.jsx("span",{children:"Interdisciplinary Creative & Programmer"})]}),M.jsx("p",{style:{fontFamily:ki},className:`text-center p-4 ${rl} text-3xl`,children:"Los Angeles, CA"}),M.jsx(uw,{})]})]}):M.jsxs(M.Fragment,{children:[M.jsx("nav",{className:"z-10 w-full mb-5",children:M.jsxs("ul",{style:{fontFamily:Xr},className:"list-none p-0 m-0 flex sm:text-2xl md:text-5xl",children:[M.jsx(sr,{name:"about"}),M.jsx(Gs,{}),M.jsx(sr,{name:"art"}),M.jsx(Gs,{}),M.jsx(sr,{name:"projects"}),M.jsx(Gs,{}),M.jsx(sr,{name:"contact"})]})}),M.jsxs("header",{style:{marginBottom:"70px"},children:[M.jsx(Yr,{to:"/",children:M.jsx("h1",{className:"text-white",style:{fontFamily:ji,fontSize:a.width<500?"1rem":"2rem",fontWeight:"bold"},children:ul})}),M.jsx("p",{className:`${rl} text-3xl text-left`,style:{fontFamily:Xr},children:"Interdisciplinary Creative & Programmer"})]})]}),dw=()=>M.jsx("img",{className:"w-30 ",src:"./LinkedIn_Logo.svg"}),pw=a=>{let e="";const n=new Map(a.locationData.map(l=>[l.url.replace(/^\//,""),l.title])),s=l=>l.replace(/[_-]/g," ").trim().split(" ").filter(Boolean).map(f=>f.charAt(0).toUpperCase()+f.slice(1)).join(" ");return M.jsxs(M.Fragment,{children:[M.jsx("style",{children:`
        #location-bar {
        }
 ...
 * @license Zlib
 */var cd=1/1e3,gw=1e3,vw=class{constructor(){this.startTime=performance.now(),this.previousTime=0,this.currentTime=0,this._delta=0,this._elapsed=0,this._fixedDelta=1e3/60,this.timescale=1,this.useFixedDelta=!1,this._autoReset=!1}get autoReset(){return this._autoReset}set autoReset(a){typeof document<"u"&&document.hidden!==void 0&&(a?document.addEventListener("visibilitychange",this):document.removeEventListener("visibilitychange",this),this._autoReset=a)}get delta(){return this._delta*cd}get fixedDelta(){return this._fixedDelta*cd}set fixedDelta(a){this._fixedDelta=a*gw}get elapsed(){return this._elapsed*cd}update(a){this.useFixedDelta?this._delta=this.fixedDelta:(this.previousTime=this.currentTime,this.currentTime=(a!==void 0?a:performance.now())-this.startTime,this._delta=this.currentTime-this.previousTime),this._delta*=this.timescale,this._elapsed+=this._delta}reset(){this._delta=0,this._elapsed=0,this.currentTime=performance.now()-this.startTime}getDelta(){return this.delta}getElapsed(){return this.elapsed}handleEvent(a){document.hidden||(this.currentTime=performance.now()-this.startTime)}dispose(){this.autoReset=!1}},_w=(()=>{const a=new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),e=new Float32Array([0,0,2,0,0,2]),n=new Aa;return n.setAttribute("position",new Si(a,3)),n.setAttribute("uv",new Si(e,2)),n})(),Ni=class tp{static get fullscreenGeometry(){return _w}constructor(e="Pass",n=new pu,s=new gp){this.name=e,this.renderer=null,this.scene=n,this.camera=s,this.screen=null,this.rtt=!0,this.needsSwap=!0,this.needsDepthTexture=!1,this.enabled=!0}get renderToScreen(){return!this.rtt}set renderToScreen(e){if(this.rtt===e){const n=this.fullscreenMaterial;n!==null&&(n.needsUpdate=!0),this.rtt=!e}}set mainScene(e){}set mainCamera(e){}setRenderer(e){this.renderer=e}isEnabled(){return this.enabled}setEnabled(e){this.enabled=e}get fullscreenMaterial(){return this.screen!==null?this.screen.material:null}set fullscreenMaterial(e){let n=this.screen;n!==null?n.material=e:(n=new yi(tp.fullscreenGeometry,e),n.frustumCulled=!1,this.scene===null&&(this.scene=new pu),this.scene.add(n),this.screen=n)}getFullscreenMaterial(){return this.fullscreenMaterial}setFullscreenMaterial(e){this.fullscreenMaterial=e}getDepthTexture(){return null}setDepthTexture(e,n=gl){}render(e,n,s,l,c){throw new Error("Render method not implemented!")}setSize(e,n){}initialize(e,n,s){}dispose(){for(const e of Object.keys(this)){const n=this[e];(n instanceof Gn||n instanceof Js||n instanceof zn||n instanceof tp)&&this[e].dispose()}this.fullscreenMaterial!==null&&this.fullscreenMaterial.dispose()}},xw=class extends Ni{constructor(){super("ClearMaskPass",null,null),this.needsSwap=!1}render(a,e,n,s,l){const c=a.state.buffers.stencil;c.setLocked(!1),c.setTest(!1)}},yw=`#include <common>
#include <dithering_pars_fragment>
