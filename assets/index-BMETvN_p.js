...
`)}function uw(a,e){let n;switch(e){case vE:n="Linear";break;case _E:n="Reinhard";break;case xE:n="Cineon";break;case yE:n="ACESFilmic";break;case EE:n="AgX";break;case ME:n="Neutral";break;case SE:n="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),n="Linear"}return"vec3 "+a+"( vec3 color ) { return "+n+"ToneMapping( color ); }"}const Qc=new se;function fw(){At.getLuminanceCoefficients(Qc);const a=Qc.x.toFixed(4),e=Qc.y.toFixed(4),n=Qc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${a}, ${e}, ${n} );`,"	return dot( weights, rgb );","}"].join(`
`)}function hw(a){return[a.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",a.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(il).join(`
	...
	if ( coord.x >= 1.0 ) {
        ...
        `,"`"]}),M.jsx("div",{className:"relative flex items-center justify-center rounded-2xl border border-dashed border-white/20 bg-slate-800/40 p-6 text-center",children:M.jsxs("div",{children:[M.jsx("p",{className:`text-sm uppercase tracking-[0.3em] ${zs}`,children:"Portrait Placeholder"}),M.jsx("p",{className:"mt-3 text-xl font-semibold text-white",children:"Drop a high-contrast photo here"}),M.jsx("p",{className:"mt-2 text-sm text-slate-300",children:"Suggested: clean lighting, subtle gradient background, confident but relaxed posture."})]})}),M.jsxs("div",{className:"space-y-16 text-slate-100",children:[M.jsx("section",{className:"grid gap-10 rounded-2xl p-8 lg:grid-cols-[3fr,2fr]",children:M.jsxs("div",{className:"space-y-6",children:[M.jsx("p",{className:`text-center text-sm uppercase tracking-[0.3em] ${zs}`,children:"Designer · Builder · Storyteller"}),M.jsxs("h1",{className:"text-4xl font-semibold leading-tight text-white sm:text-5xl mt-10 mb-10",children:["Context-switching between ",M.jsx("strong",{children:"construction sites"}),", ",M.jsx("strong",{children:"code editors"}),", and ",M.jsx("strong",{children:"sketchbooks"})," is my normal."]}),M.jsxs(Yt,{children:["I grew up in Kentucky, cut my teeth in ",M.jsx("strong",{children:"art school"})," at SAIC, and moved to Los Angeles in 2017 to pursue dreams; ",M.jsx("i",{children:"LA has become home now. "}),"The city's beauty, its diversity, the weather, the culture, I love what it has to offer here  — here I've worked across specialty construction, hospitality, and entertainment. Today I split my time between BuildLACCD ",M.jsx("strong",{children:"project management"}),", UrFriends",M.jsx("strong",{children:" full-stack development"}),", ",M.jsx("strong",{children:"engineering school"}),", my passion for the fitness & creativity."]}),M.jsxs("div",{className:"space-y-3 rounded-2xl border border-white/5 bg-white/5/20 mt-5 pt-1 p-6",children:[M.jsx("p",{className:`text-xs uppercase tracking-[0.4em] pb-5 pt-5 ${zs}`,children:"What Drives Me"}),M.jsx("div",{className:"flex flex-wrap gap-3",children:nA.map(a=>M.jsx("span",{className:"rounded-full border border-white/10 bg-white/5 px-3 py-1 text-sm",children:a},a))})]})]})}),M.jsx("section",{className:"grid gap-6 lg:grid-cols-3",children:tA.map(a=>M.jsxs("article",{className:"rounded-2xl border border-white/10 bg-slate-900/40 p-6 shadow-lg shadow-black/20",children:[M.jsx("p",{className:`text-xs uppercase tracking-[0.4em] ${zs}`,children:a.label}),M.jsx("ul",{className:"mt-3 space-y-2",children:a.items.map(e=>M.jsxs("li",{className:"text-lg font-semibold text-white flex items-start",children:[M.jsx("span",{className:"mr-3",children:"•"}),M.jsx("span",{children:e})]},e))})]},a.label))}),M.jsxs("section",{className:"space-y-6 text-lg leading-relaxed text-slate-200",children:[M.jsxs(Yt,{children:["I thrive where ",M.jsx("strong",{children:"hands-on execution"})," meets ",M.jsx("strong",{children:"polished storytelling"}),". I have ",M.jsx("strong",{children:M.jsx("a",{href:ll,target:"_blank",className:"hover:text-white/80 transition-colors",children:M.jsx("u",{children:"managed multimillion-dollar campus upgrades"})})}),", ",M.jsx("strong",{children:M.jsx("a",{href:"/projects/urfriends",className:"hover:text-white/80 transition-colors",children:M.jsx("u",{children:"shipped SaaS products"})})}),", led hospitality teams, fabricated sets for film & TV, and still carve out time to paint, sketch, and cycle the Los Angeles river paths. Fitness is a huge passion of mine, especially running and cycling. As a runner, I love the distance and concentration, and as a cyclist I love the freedom. Each lane teaches me to stay calm, design deliberately, and communicate with clarity — and in every world thoughts of finding cross-pollination drive my imagination wild! I'm always looking for new ways to learn."]}),M.jsxs(Yt,{children:["Engineering school sharpened my math and systems thinking; art school wired me to experiment without fear; years in hospitality taught me to keep people seen and to communicate ",M.jsx("i",{children:"thoroughly"}),". School in STEM has been extremely rewarding — it has exposed me to tools that I've used for refining and analyzing",M.jsx("strong",{children:M.jsxs("a",{href:"/projects/ripsheet",className:"hover:text-white/80 transition-colors",children:[" ",M.jsx("u",{children:"personal fitness systems"})]})}),", allowed me to tutor fellow students at MESA; I've celebrated and philosophized in the Human Computer Interaction Club, helped organize a hackathon, I've gone from 'self-taught' programmer to someone who understands computer science paradigms, and become ",M.jsx("i",{children:"actually"})," kind of fascinated by math."]}),M.jsx(Yt,{children:`When I am not laboring (with love ofc), you will find me studying new fabrication techniques, spelunking the wiki of my latest fascination, long-distnace or trail running, homecanning beans (they're SO good), riding my bike around LA, going to an art museum, or tinkering creatively. I'm big on "hippie" type stuff, get way into reading about future green-tech, and resonate with preserving the environment — you can absolutely find me using a bicycle and public transit.`}),M.jsx(Yt,{children:"I still say yes to the weird gigs — they keep me humble and curious."})]}),M.jsxs("section",{className:"space-y-8 rounded-2xl border border-white/10 bg-slate-900/40 p-6",children:[M.jsx("div",{className:"flex items-baseline justify-between",children:M.jsx("h2",{className:"text-2xl font-semibold text-white",children:"Digital skills"})}),M.jsx("div",{className:"space-y-6",children:iA.map(a=>M.jsxs("div",{className:"space-y-3",children:[M.jsx("p",{className:`text-s uppercase tracking-[0.4em]  p-5 text-center font-bold ${zs}`,children:a.title}),M.jsx("div",{className:"grid grid-cols-[repeat(auto-fit,minmax(140px,1fr))] gap-4",children:a.tools.map(e=>{const s={Photoshop:"photoshop_logo_40pt.svg",Illustrator:"illustrator_logo_40pt.svg",Maya:"maya_logo_40pt.svg",Blender:"blender_logo_40pt.svg","Fusion 360":"fusion_logo_40pt.svg",SOLIDWORKS:"solidworks_logo_40pt.svg",TypeScript:"typescript_logo_40pt.svg",JavaScript:"javascript_logo_40pt.svg",Python:"python_logo_40pt.svg","C++":"cpp_logo_40pt.svg",Firebase:"firebase_logo_40pt.svg","Next.js":"next_logo_40pt.svg",Stripe:"stripe_logo_40pt.svg",Tailwind:"tailwind_logo_40pt.svg",Vercel:"vercel_logo_40pt.svg",Render:"render_logo_40pt.svg"}[e];return M.jsxs("div",{className:"flex flex-col items-center gap-2 text-center",children:[M.jsx("div",{className:`flex h-16 w-16 items-center justify-center rounded-full text-xs uppercase tracking-wide text-slate-400 ${s?"":"border border-white/15 bg-slate-800/60"}`,children:s?M.jsx("img",{src:`/${s}`,alt:`${e} logo`,className:"h-16 w-16"}):"Logo"}),M.jsx("p",{className:"text-sm font-medium text-white",children:e})]},e)})})]},a.title))})]}),M.jsxs("section",{className:`flex flex-col items-center gap-4 rounded-2xl border border-white/20 bg-slate-800/40 px-6 py-5 text-sm ${zs}`,children:[M.jsx("p",{className:"text-xs uppercase tracking-[0.4em]",children:"Next steps"}),M.jsxs("div",{className:"flex flex-col gap-3 text-base text-slate-100",children:[M.jsxs("p",{className:"text-center",children:["I love ",M.jsx("strong",{children:"building"})," and ",M.jsx("strong",{children:"creating"}),", and if you can use my help, ",M.jsx("strong",{children:"please reach out!"})]}),M.jsx(tx,{href:"/contact",label:"Open Contact Page",newTab:!1})]})]})]})]}),rA=()=>M.jsx("div",{className:"text-white",style:{fontFamily:Vi},children:M.jsx("div",{className:"mx-auto w-full max-w-6xl px-6 py-20",children:M.jsxs("div",{className:"grid gap-10 md:grid-cols-2 md:items-center",children:[M.jsxs("div",{children:[M.jsx("p",{className:"uppercase tracking-[0.3em] text-sm opacity-70",children:"Contact"}),M.jsx("h1",{style:{fontFamily:ji},className:"text-4xl md:text-6xl font-bold mt-4",children:"Let's build something bold."}),M.jsx("p",{className:"mt-4 text-lg opacity-80 max-w-xl",children:"Reach out for collaborations, commissions, or just to say hello. I'm based in Los Angeles and always open to new ideas."}),M.jsxs("div",{className:"mt-8 flex flex-col sm:flex-row gap-4",children:[M.jsx("a",{href:"mailto:jayhcrawford@gmail.com",className:"inline-flex items-center justify-center rounded-lg border border-white/30 px-6 py-3 text-sm font-semibold uppercase tracking-wider hover:border-white hover:bg-white/10",children:"Email Me"}),M.jsx("a",{href:ll,target:"new",className:"inline-flex items-center justify-center rounded-lg border border-white/30 px-6 py-3 text-sm font-semibold uppercase tracking-wider hover:border-white hover:bg-white/10",children:"LinkedIn"})]})]}),M.jsxs("div",{className:"rounded-2xl border border-white/20 bg-white/5 p-8 backdrop-blur",children:[M.jsx("p",{className:"text-sm uppercase tracking-[0.3em] opacity-70",children:"Direct"}),M.jsx("h2",{style:{fontFamily:ji},className:"text-3xl font-semibold mt-3",children:cl}),M.jsx("p",{className:"opacity-80 mt-2",children:"Los Angeles, CA"}),M.jsxs("div",{className:"mt-6",children:[M.jsx("p",{className:"text-sm uppercase tracking-[0.3em] opacity-70",children:"Email"}),M.jsx("a",{className:"text-lg font-semibold hover:underline",href:"mailto:jayhcrawford@gmail.com",children:"jayhcrawford@gmail.com"})]}),M.jsxs("div",{className:"mt-6",children:[M.jsx("p",{className:"text-sm uppercase tracking-[0.3em] opacity-70",children:"Social"}),M.jsxs("div",{className:"mt-3 flex flex-wrap gap-4 text-sm",children:[M.jsx("a",{className:"hover:underline",href:ll,target:"new",children:"LinkedIn"}),M.jsx("a",{className:"hover:underline",href:yp,target:"new",children:"Instagram"}),M.jsx("a",{className:"hover:underline",href:mu,target:"new",children:"Github"})]})]})]})]})})}),sA=a=>M.jsxs(M.Fragment,{children:[a.url==""&&M.jsx("div",{id:"this_one",className:"h-30 w-30 absolute",children:M.jsx("img",{src:"/under_construction.svg"})}),M.jsx("div",{style:{boxShadow:"5px 5px 5px rgba(0, 0, 0, 1)"},className:"gridPhoto_Image_container w-80 h-60",children:M.jsx("img",{className:"rounded-lg w-80 h-60",style:{objectFit:"cover"},src:a.img})})]}),oA=a=>{const[e,n]=he.useState(!1);return M.jsx("div",{onMouseEnter:()=>n(!0),onMouseLeave:()=>n(!1),children:M.jsx(Xr,{id:"",to:a.url?a.url:"",children:M.jsx("div",{className:"gridPhoto_container p-1 m-2 flex justify-center",children:M.jsxs("div",{className:`gridPhoto_item_container m-2 inline ${a.url==""&&"cursor-not-allowed"}`,children:[M.jsx("style",{children:`
            ...
            opacity: 100%;
                    ...
                    `}),a.map((e,n)=>M.jsx("a",{"aria-label":`Our ${e.name}`,href:e.url,target:"_blank",className:"glow-button socialbrick-link",children:M.jsx(uA,{name:e.name})},n))]})})};function hA(a){return a?a.toLowerCase().split(" ").map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(" "):""}const Is=()=>M.jsx("span",{className:`${al} ml-5 mr-5`,children:"|"}),lr=a=>M.jsx("li",{style:{transition:"opacity .1s .1s"},className:`outline_nav_elem_text ${al} hover:underline hover:opacity-100`,children:M.jsxs(Xr,{to:`/${a.name}`,children:[M.jsx("style",{children:`
 
        
        `}),hA(a.name)]})}),dA=a=>a.path=="/"?M.jsxs(M.Fragment,{children:[M.jsx("nav",{className:"z-10 w-ful",children:M.jsxs("ul",{style:{fontFamily:ur},className:"list-none p-0 pb-4 m-0 flex justify-center text-xl sm:text-3xl md:text-5xl",children:[M.jsx(lr,{name:"about"}),M.jsx(Is,{}),M.jsx(lr,{name:"art"}),M.jsx(Is,{}),M.jsx(lr,{name:"projects"}),M.jsx(Is,{}),M.jsx(lr,{name:"contact"})]})}),M.jsxs("header",{style:{marginBottom:"70px"},children:[M.jsx("h1",{className:"text-center text-white",style:{fontFamily:ji,fontSize:a.width<500?"3rem":"6rem",fontWeight:"bold"},children:cl}),M.jsxs("p",{className:`${al} text-5xl text-center`,style:{fontFamily:ur},children:[M.jsx("span",{className:"block",children:"Engineering Student,"}),M.jsx("span",{children:"Interdisciplinary Creative & Programmer"})]}),M.jsx("p",{style:{fontFamily:Vi},className:`text-center p-4 ${al} text-3xl`,children:"Los Angeles, CA"}),M.jsx(fA,{})]})]}):M.jsxs(M.Fragment,{children:[M.jsx("nav",{className:"z-10 w-full mb-5",children:M.jsxs("ul",{style:{fontFamily:ur},className:"list-none p-0 m-0 flex sm:text-2xl md:text-5xl",children:[M.jsx(lr,{name:"about"}),M.jsx(Is,{}),M.jsx(lr,{name:"art"}),M.jsx(Is,{}),M.jsx(lr,{name:"projects"}),M.jsx(Is,{}),M.jsx(lr,{name:"contact"})]})}),M.jsxs("header",{style:{marginBottom:"70px"},children:[M.jsx(Xr,{to:"/",children:M.jsx("h1",{className:"text-white",style:{fontFamily:ji,fontSize:a.width<500?"1rem":"2rem",fontWeight:"bold"},children:cl})}),M.jsx("p",{className:`${al} text-3xl text-left`,style:{fontFamily:ur},children:"Interdisciplinary Creative & Programmer"})]})]}),pA=()=>M.jsx("img",{className:"w-30",src:"/LinkedIn_Logo.svg",alt:"LinkedIn logo"}),mA=a=>{let e="";const n=new Map(a.locationData.map(l=>[l.url.replace(/^\//,""),l.title])),s=l=>l.replace(/[_-]/g," ").trim().split(" ").filter(Boolean).map(f=>f.charAt(0).toUpperCase()+f.slice(1)).join(" ");return M.jsxs(M.Fragment,{children:[M.jsx("style",{children:`
        #location-bar {
        }
 ...
 * @license Zlib
 */var cd=1/1e3,vA=1e3,_A=class{constructor(){this.startTime=performance.now(),this.previousTime=0,this.currentTime=0,this._delta=0,this._elapsed=0,this._fixedDelta=1e3/60,this.timescale=1,this.useFixedDelta=!1,this._autoReset=!1}get autoReset(){return this._autoReset}set autoReset(a){typeof document<"u"&&document.hidden!==void 0&&(a?document.addEventListener("visibilitychange",this):document.removeEventListener("visibilitychange",this),this._autoReset=a)}get delta(){return this._delta*cd}get fixedDelta(){return this._fixedDelta*cd}set fixedDelta(a){this._fixedDelta=a*vA}get elapsed(){return this._elapsed*cd}update(a){this.useFixedDelta?this._delta=this.fixedDelta:(this.previousTime=this.currentTime,this.currentTime=(a!==void 0?a:performance.now())-this.startTime,this._delta=this.currentTime-this.previousTime),this._delta*=this.timescale,this._elapsed+=this._delta}reset(){this._delta=0,this._elapsed=0,this.currentTime=performance.now()-this.startTime}getDelta(){return this.delta}getElapsed(){return this.elapsed}handleEvent(a){document.hidden||(this.currentTime=performance.now()-this.startTime)}dispose(){this.autoReset=!1}},xA=(()=>{const a=new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),e=new Float32Array([0,0,2,0,0,2]),n=new Ca;return n.setAttribute("position",new yi(a,3)),n.setAttribute("uv",new yi(e,2)),n})(),Ui=class tp{static get fullscreenGeometry(){return xA}constructor(e="Pass",n=new pu,s=new gp){this.name=e,this.renderer=null,this.scene=n,this.camera=s,this.screen=null,this.rtt=!0,this.needsSwap=!0,this.needsDepthTexture=!1,this.enabled=!0}get renderToScreen(){return!this.rtt}set renderToScreen(e){if(this.rtt===e){const n=this.fullscreenMaterial;n!==null&&(n.needsUpdate=!0),this.rtt=!e}}set mainScene(e){}set mainCamera(e){}setRenderer(e){this.renderer=e}isEnabled(){return this.enabled}setEnabled(e){this.enabled=e}get fullscreenMaterial(){return this.screen!==null?this.screen.material:null}set fullscreenMaterial(e){let n=this.screen;n!==null?n.material=e:(n=new ui(tp.fullscreenGeometry,e),n.frustumCulled=!1,this.scene===null&&(this.scene=new pu),this.scene.add(n),this.screen=n)}getFullscreenMaterial(){return this.fullscreenMaterial}setFullscreenMaterial(e){this.fullscreenMaterial=e}getDepthTexture(){return null}setDepthTexture(e,n=ml){}render(e,n,s,l,c){throw new Error("Render method not implemented!")}setSize(e,n){}initialize(e,n,s){}dispose(){for(const e of Object.keys(this)){const n=this[e];(n instanceof Gn||n instanceof Ks||n instanceof zn||n instanceof tp)&&this[e].dispose()}this.fullscreenMaterial!==null&&this.fullscreenMaterial.dispose()}},yA=class extends Ui{constructor(){super("ClearMaskPass",null,null),this.needsSwap=!1}render(a,e,n,s,l){const c=a.state.buffers.stencil;c.setLocked(!1),c.setTest(!1)}},SA=`#include <common>
#include <dithering_pars_fragment>
...
#`));this.skipRendering=e===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(a)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(a,e=ml){this.fullscreenMaterial.depthBuffer=a,this.fullscreenMaterial.depthPacking=e;for(const n of this.effects)n.setDepthTexture(a,e)}render(a,e,n,s,l){for(const c of this.effects)c.update(a,e,s);if(!this.skipRendering||this.renderToScreen){const c=this.fullscreenMaterial;c.inputBuffer=e.texture,c.time+=s*this.timeScale,a.setRenderTarget(this.renderToScreen?null:n),a.render(this.scene,this.camera)}}setSize(a,e){this.fullscreenMaterial.setSize(a,e);for(const n of this.effects)n.setSize(a,e)}initialize(a,e,n){this.renderer=a;for(const s of this.effects)s.initialize(a,e,n);this.updateMaterial(),n!==void 0&&n!==In&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH="1")}dispose(){super.dispose();for(const a of this.effects)a.removeEventListener("change",this.listener),a.dispose()}handleEvent(a){switch(a.type){case"change":this.recompile();break}}};const UR=()=>{const{width:a,height:e}=$_(),n=he.useRef(null);return he.useEffect(()=>{const s=new pu,l=new Kn(75,a/e,.1,1e3),c=new J_({alpha:!0,antialias:!0,powerPreference:"high-performance"});c.setClearColor(0,0),c.outputColorSpace=Lt,c.toneMapping=Ea,c.setPixelRatio(Math.min(window.devicePixelRatio||1,2)),c.setSize(a,e),c.domElement.style.position="absolute",c.domElement.style.inset="0",c.domElement.style.zIndex="0",c.domElement.style.pointerEvents="none",c.domElement.style.background="transparent";const f=n.current;f instanceof HTMLElement&&!f.hasChildNodes()&&f.appendChild(c.domElement);const h=new nl;for(let S=0;S<50;S++){const b=.03+Math.random()*.07,A=new _p(b,7,7),y=new xu({color:"white"}),v=new ui(A,y);v.position.x=(Math.random()-.5)*10,v.position.y=(Math.random()-.5)*10,v.position.z=(Math.random()-.5)*10,h.add(v)}s.add(h),l.position.z=5;const p=new bA(c);p.addPass(new bR(s,l));const m=new MR({intensity:.03,luminanceThreshold:.25,luminanceSmoothing:.35,radius:.5}),g=new CR(l,m);g.renderToScreen=!0,p.addPass(g);let _=0;const x=()=>{_=window.requestAnimationFrame(x),h.rotation.x+=89e-6,h.rotation.y+=99e-6,p.render()};return x(),()=>{window.cancelAnimationFrame(_),h.traverse(S=>{S instanceof ui&&(S.geometry.dispose(),Array.isArray(S.material)?S.material.forEach(b=>b.dispose()):S.material.dispose())}),p.dispose(),c.dispose(),f&&f.removeChild(c.domElement)}},[a,e]),M.jsx("div",{id:"three_background",style:{position:"fixed",top:0,left:0,width:`${a}px`,height:`${e}px`,overflow:"hidden",pointerEvents:"none"},ref:n})},fd=a=>(console.log(a),M.jsx("div",{children:M.jsx(nx,{width:a.width,categories:a.category_array})})),DR=()=>M.jsx("div",{children:M.jsxs(xl,{construction:!0,title:"The Book",children:[M.jsx(Yt,{children:"The Book is a project that I started in highschool. This is an expansive collection of great thoughts, ideas, practices, and philosphies."}),M.jsx(Yt,{children:"Sun Tzu quotes, storytelling ideas from PIXAR, biographical information about great artists and thinkers, reading lists from our planet's great innovative minds, and a mixed-bag of other written ideas."}),M.jsx(Yt,{children:"After UrFriends is fully migrated to AWS, turning this inspirational collection of highly motivational material into a simple mobile app is up next."})]})}),zi=["https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_ALL_WORKOUTS.png","https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_DATA_BOARD.png","https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_DATA_BOARD_REGRESSION.png","https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_DATA_CHART.png","https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_ORIGIN_SHEET.png","https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_G_SHEET.png","https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_RAW_JSON.png","https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_FILE.jpg","https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_AP_TIME.png","https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_HERO_PIC.webp"],NR=()=>{const a=ex,e="border border-1 border-white/20 p-5 rounded-2xl";return M.jsx(xl,{construction:!1,title:"",children:M.jsxs("div",{className:"space-y-8 text-slate-100",children:[M.jsx(tl,{align:"left",children:"Case Study: The RIP Sheet"}),M.jsxs("section",{className:"rip-section--intro ",children:[M.jsxs("div",{id:"rip-hero",className:"m-5",children:[M.jsx("style",{children:`
        ...
        `}),M.jsx("div",{id:"rip-hero-image",children:M.jsx("img",{src:zi[9],alt:"Hero image",className:"rounded-full w-full h-full object-cover"})}),M.jsx("div",{id:"rip-hero-text",className:"flex align-center justify-center text-4xl sm:text-6xl xl:text-7xl text-center sm:p-10 leading-tight",style:{fontFamily:ur},children:"In 2018 I decided to learn weightlifting."})]}),M.jsx("div",{className:a,children:M.jsx(Jc,{quote:"Since then, I’ve been developing tools and systems to become stronger and to consistently learn.",sizePreset:"compact"})}),M.jsx(Yt,{children:"In 2018, I set out to learn weightlifting. Over time, through repeated iteration, I built a system I call the RIP Sheet. Early versions failed to track progress and enforce consistency — but I kept refining, testing, and improving. The name is a double entendre: a memento mori and a call to get ripped. Today is the day you make that change — this very rep."}),M.jsx("div",{className:"rip-figure rip-figure--single",children:M.jsx(va,{variant:"quarter",src:zi[4],alt:"Origin version of the RIP sheet layout",figureLabel:"Figure 1",figureCaption:"Early (circa 2018) RIP sheet worksheet.",withMatte:!0,figcaptionClassName:a})})]}),M.jsxs("section",{className:`rip-section rip-section--analog ${e}`,children:[M.jsx(tl,{align:"left",children:"Analog beginnings"}),M.jsx(Yt,{children:"At first, there were multiple different supporting checklists based upon what I wanted to achieve in the gym any given 'day' — a 'back day' for example. I found that to be overly restrictive and not in line with life's unpredictability. I thought to put it together into a single document, one worksheet, and came up with a sassy name: the RIP Sheet. Getting 'stronger' has resonated with me all of my life, for me that's what weightlifting is about, and I need to do it while I'm still breathing! The worksheet was a structured attempt to bring discipline into the gym without relying on screens. The layout was clear, but the medium wasn’t. Tracking progress across loose pages quickly became impractical, and paper doesn’t hold up well in a gym environment where gains are a factor."}),M.jsx(Yt,{children:"Alongside the sheet, I created a small reference packet for stretching and brought both with me to train."}),M.jsx("div",{className:"rip-figure rip-figure--single",children:M.jsx(va,{variant:"half",src:zi[7],alt:"Original workbook used for tracking workouts in the initial prototyping phase",figureLabel:"Figure 2",figureCaption:"The workbook taken to the gym in the initial prototyping phase.",withMatte:!0,figcaptionClassName:a})}),M.jsx(Yt,{children:"This workbook was the version I brought with me to the gym during early prototyping — an attempt to turn structure into habit. I found keeping track of the physical worksheets and transferring them into a digital format was very inconvenient."})]}),M.jsxs("section",{className:`rip-section rip-section--digital ${e}`,children:[M.jsx(tl,{align:"left",children:"From paper to data"}),M.jsx(Yt,{children:"Eventually, I moved to Google Sheets, which made tracking progress far more efficient and reliable, allowing me to easily track every rep I've made since 2022. Because I had already been collecting this data, I was able to analyze it later in a Linear Algebra for Data Science course in 2025."}),M.jsx(Yt,{children:"In that class, I used Python to create least square regression analyses of each one of my exercises a period of 2.5 years. Seeing visualizations was highly motivational and validating for my stronger routines, but it also showed me clearly where I've been slacking recently. That was kind of like a bell ringing in the distance — effective visualizations can powerfully reinforce habits."}),M.jsx(Yt,{children:"Processing the raw data was complicated at first, and I tailored it using JavaScript and C++. Over time, I simplified the system: each set is stored as JSON, defined by exercise name, weight, reps, and date. This structure makes generating visualizations straightforward, with same-day workouts naturally aligning in the data."}),M.jsxs("div",{className:"rip-cta",children:[M.jsx("p",{className:`rip-cta__label ${a}`,children:"Explore the notebooks + regression overlays"}),M.jsx(tx,{href:"https://colab.research.google.com/drive/1ENZlQbCl78q4ilT7lTgQ9YkcPgvTLV9d?usp=sharing",label:"View the Python analysis in Google Colab"})]}),M.jsxs("div",{className:"rip-gallery rip-gallery--grid",children:[M.jsx(va,{variant:"full",src:zi[6],alt:"Origin version of the RIP sheet layout",figureLabel:"Figure 3",figureCaption:"The data is stored in a way that makes it easy to analyze.",withMatte:!0,imgClassName:"mx-auto w-full max-w-sm aspect-square object-cover",figcaptionClassName:a}),M.jsx(va,{variant:"full",src:zi[5],alt:"Origin version of the RIP sheet layout",figureLabel:"Figure 4",figureCaption:"Although it looks basic, this is the system I've found supports consistency.",withMatte:!0,imgClassName:"mx-auto w-full max-w-sm aspect-square object-cover",figcaptionClassName:a}),M.jsx(va,{variant:"full",src:zi[0],alt:"Collection of all workouts tracked in the RIP sheet",figureLabel:"Figure 5",figureCaption:"Consolidated workout history view.",withMatte:!0,imgClassName:"mx-auto w-full max-w-sm aspect-square object-cover",figcaptionClassName:a})]})]}),M.jsxs("section",{className:`rip-section rip-section--insights ${e}`,children:[M.jsx(tl,{align:"left",children:"Insights"}),M.jsx(Yt,{children:"The very first thing that I wanted to see was the data related to every workout, all in one place. Being able to visualize the data seemed like it could be powerful, and it was. The first time the Python spit out this image my jaw dropped. This is a tool that can help make that life change."}),M.jsx("div",{className:"rip-figure rip-figure--wide",children:M.jsx(va,{variant:"centered",src:zi[1],alt:"RIP sheet data board showing tracked exercise metrics",figureLabel:"Figure 6",figureCaption:"Data board used to monitor progress over time.",withMatte:!0,figcaptionClassName:a})}),M.jsx("div",{className:a,children:M.jsx(Jc,{quote:"Today is the day you make that life change — this very rep.",sizePreset:"balanced"})}),M.jsx(Yt,{children:"Visualizations expose my habits instantly — what’s strong, what’s falling off, and where volume spikes. When I fit least-squares regressions to each lift and saw their slopes, I knew I'd found a powerful way to encourage progress."}),M.jsxs("div",{className:"rip-gallery rip-gallery--dual",children:[M.jsx(va,{variant:"centered",src:zi[8],alt:"Regression analysis chart generated from RIP sheet data",figureLabel:"Figure 7",figureCaption:"Visualization of intuitively finding an ideal weight (40lb) for Arnold press over time.",withMatte:!0,figcaptionClassName:a}),M.jsx(va,{variant:"centered",src:zi[3],alt:"Progress chart visualizing workout performance changes",figureLabel:"Figure 8",figureCaption:"Bar chart showing exercise type counts for the data captured.",withMatte:!0,figcaptionClassName:a})]}),M.jsx(Yt,{children:"The Arnold press visualization shows my workout routine ramping up from 20lb to 50lb, and settling on 40lb for that exercise. To me, it helps to see the progress and the pattern; knowing what to do next to improve is useful, and so is seeing how far I've come."}),M.jsx("div",{className:a,children:M.jsx(Jc,{quote:"Fitting a least-squares regression to the data shows interesting trends:",sizePreset:"compact"})}),M.jsx("div",{className:"rip-figure rip-figure--wide",children:M.jsx(va,{variant:"centered",src:zi[2],alt:"RIP sheet data board showing tracked exercise metrics",figureLabel:"Figure 9",figureCaption:"Least-squares regression snapshot for exercise trends.",withMatte:!0,figcaptionClassName:a})}),M.jsx(Yt,{children:"I know that there are many more methods and styles of visualizations that can facilitate positive change, help people to understand their progress, be inspired, and make informed decisions."})]}),M.jsxs("section",{className:`rip-section rip-section--future ${e}`,children:[M.jsx(tl,{align:"left",children:"What’s next"}),M.jsx(Yt,{children:"My hope is to create a fitness app that allows people to develop realistic and healthy physical fitness routines and give useful visualizations that will let users know for sure how to generate real physical progress. The gym habit can be challenging to adopt, and I want to help people realize that learning that habit is counter-intuitive to first impressions."}),M.jsx(Yt,{children:"A major aspect of my routine has been settling on a system that is sustainable, repeatable, and useful. Google Sheets has allowed me to find the *steps* for a system that is sustainable, flexible, and accurate — migrating those steps into a tailor made UI will make a powerful tool for progress."}),M.jsx("div",{className:a,children:M.jsx(Jc,{quote:"I believe I can help people to adopt a habit that they love.",sizePreset:"balanced"})})]})]})})},LR=()=>M.jsx("div",{children:M.jsxs(xl,{construction:!1,title:"UrFriends",children:[M.jsx(Yt,{children:'UrFriends is designed to help you build real, lasting relationships using your device. "'}),M.jsx(eA,{url:"https://public--urfriends-beta.us-central1.hosted.app/",linkText:"The Latest UrFriends Deployment"}),M.jsx(Yt,{children:"Inspired by the documented habits of highly influential thinkers like Benjamin Franklin and Charles Darwin, and by the routines of my endlessly social Grandmother Faye, UrFriends is about staying connected with intention—not just collecting contacts. Organize your relationships into tiers and set unique reminder timeframes for each. A tier could be set for a daily reach-out, weekly, or even yearly. Each contact has a conversations journal, so you can take notes after reaching out and remember the things that matter. There is a functional beta for a single user on my Github. The beta started on Vercel with React.js, Node, and MongoDB. Then it migrated to AWS, and Amplify. Finally, I've settled on Firebase, because of the ease of accomplishing everything that I want to."}),M.jsx(Yt,{children:"I’m currently migrating functionality to AWS to support real users. Google and Apple integration is on the way. UrFriends is for people who believe technology should bring us together—not make us busier."})]})}),OR=()=>M.jsx("div",{children:M.jsxs(xl,{construction:!0,title:"Widow Bags",children:[M.jsx(Yt,{children:"Widow Bags is an conceptual, apparel company currently under development. More details coming soon."}),M.jsx(Yt,{children:"My initial design was formulated at the School of the Art Institute of Chicago."})]})}),PR="https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/painting/",BR=["KP.webp","G.webp","alien_invasion.webp","alley.webp","bad_painting.webp","bada_bing.webp","behind.webp","blinker.webp","blue_girl_1.webp","blue_girl_2.webp","bouquet.webp","bright_lights_big_city.webp","business_card.webp","california_onlookers.webp","connection.webp","dips.webp","eyes.webp","following.webp","funny_mustache_guy.webp","hilltop_city.webp","hollywood_hills.webp","house.webp","in_the_city.webp","jacks.webp","jacks_2.webp","james.webp","locked_away.webp","network.webp","night.webp","one_way.webp","online.webp","outlooker.webp","perspective.webp","pictures_of_then.webp","portrait_copy.webp","rainy_sun.webp","researchers.webp","street_corner.webp","sunday.webp","time.webp","tornado.webp","transfer.webp","victorian.webp","what_do_you.webp","woah_dude.webp","worm.webp","x.webp"],zR=a=>a&&a.endsWith(".webp")?a.slice(0,-5):"",IR=(a,e)=>a.map(n=>({src:`${e}${n}`,alt:n,title:n})),l_=a=>{const e=()=>a.current>=a.gallery_images.length-5?a.gallery_images.slice(a.gallery_images.length-5,a.gallery_images.length):a.gallery_images.slice(a.current+1,a.current+6);return M.jsx("div",{className:"gallery_subImages",children:e().map(n=>M.jsxs("button",{className:"mini_gallery_image",onClick:()=>a.setCurrent(a.images_array.indexOf(n.title?n.title:"")),children:[M.jsx("style",{children:`
