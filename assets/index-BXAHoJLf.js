...
Please change the parent <Route path="${C}"> to <Route path="${C==="/"?"*":`${C}/*`}">.`)}let x=ur(),y;if(e){let C=typeof e=="string"?Vr(e):e;Jt(g==="/"||((L=C.pathname)==null?void 0:L.startsWith(g)),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${g}" but pathname "${C.pathname}" was given in the \`location\` prop.`),y=C}else y=x;let M=y.pathname||"/",A=M;if(g!=="/"){let C=g.replace(/^\//,"").split("/");A="/"+M.replace(/^\//,"").split("/").slice(C.length).join("/")}let S=!u&&i&&i.matches&&i.matches.length>0?i.matches:i_(a,{pathname:A});Ui(_||S!=null,`No routes matched location "${y.pathname}${y.search}${y.hash}" `),Ui(S==null||S[S.length-1].route.element!==void 0||S[S.length-1].route.Component!==void 0||S[S.length-1].route.lazy!==void 0,`Matched leaf route at location "${y.pathname}${y.search}${y.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let v=qy(S&&S.map(C=>Object.assign({},C,{params:Object.assign({},p,C.params),pathname:va([g,l.encodeLocation?l.encodeLocation(C.pathname).pathname:C.pathname]),pathnameBase:C.pathnameBase==="/"?g:va([g,l.encodeLocation?l.encodeLocation(C.pathnameBase).pathname:C.pathnameBase])})),f,i,s);return e&&v?he.createElement(rl.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...y},navigationType:"POP"}},v):v}function ky(){let a=Jy(),e=Py(a)?`${a.status} ${a.statusText}`:a instanceof Error?a.message:JSON.stringify(a),i=a instanceof Error?a.stack:null,s="rgba(200,200,200, 0.5)",l={padding:"0.5rem",backgroundColor:s},u={padding:"2px 4px",backgroundColor:s},f=null;return console.error("Error handled by React Router default ErrorBoundary:",a),f=he.createElement(he.Fragment,null,he.createElement("p",null,"💿 Hey developer 👋"),he.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",he.createElement("code",{style:u},"ErrorBoundary")," or"," ",he.createElement("code",{style:u},"errorElement")," prop on your route.")),he.createElement(he.Fragment,null,he.createElement("h2",null,"Unexpected Application Error!"),he.createElement("h3",{style:{fontStyle:"italic"}},e),i?he.createElement("pre",{style:l},i):null,f)}var Xy=he.createElement(ky,null),Wy=class extends he.Component{constructor(a){super(a),this.state={location:a.location,revalidation:a.revalidation,error:a.error}}static getDerivedStateFromError(a){return{error:a}}static getDerivedStateFromProps(a,e){return e.location!==a.location||e.revalidation!=="idle"&&a.revalidation==="idle"?{error:a.error,location:a.location,revalidation:a.revalidation}:{error:a.error!==void 0?a.error:e.error,location:e.location,revalidation:a.revalidation||e.revalidation}}componentDidCatch(a,e){console.error("React Router caught the following error during render",a,e)}render(){return this.state.error!==void 0?he.createElement(Ma.Provider,{value:this.props.routeContext},he.createElement(Qd.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function jy({routeContext:a,match:e,children:i}){let s=he.useContext(qs);return s&&s.static&&s.staticContext&&(e.route.errorElement||e.route.ErrorBoundary)&&(s.staticContext._deepestRenderedBoundaryId=e.route.id),he.createElement(Ma.Provider,{value:a},i)}function qy(a,e=[],i=null,s=null){if(a==null){if(!i)return null;if(i.errors)a=i.matches;else if(e.length===0&&!i.initialized&&i.matches.length>0)a=i.matches;else return null}let l=a,u=i==null?void 0:i.errors;if(u!=null){let p=l.findIndex(m=>m.route.id&&(u==null?void 0:u[m.route.id])!==void 0);Jt(p>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(u).join(",")}`),l=l.slice(0,Math.min(l.length,p+1))}let f=!1,h=-1;if(i)for(let p=0;p<l.length;p++){let m=l[p];if((m.route.HydrateFallback||m.route.hydrateFallbackElement)&&(h=p),m.route.id){let{loaderData:g,errors:_}=i,x=m.route.loader&&!g.hasOwnProperty(m.route.id)&&(!_||_[m.route.id]===void 0);if(m.route.lazy||x){f=!0,h>=0?l=l.slice(0,h+1):l=[l[0]];break}}}return l.reduceRight((p,m,g)=>{let _,x=!1,y=null,M=null;i&&(_=u&&m.route.id?u[m.route.id]:void 0,y=m.route.errorElement||Xy,f&&(h<0&&g===0?(d_("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),x=!0,M=null):h===g&&(x=!0,M=m.route.hydrateFallbackElement||null)));let A=e.concat(l.slice(0,g+1)),S=()=>{let v;return _?v=y:x?v=M:m.route.Component?v=he.createElement(m.route.Component,null):m.route.element?v=m.route.element:v=p,he.createElement(jy,{match:m,routeContext:{outlet:p,matches:A,isDataRoute:i!=null},children:v})};return i&&(m.route.ErrorBoundary||m.route.errorElement||g===0)?he.createElement(Wy,{location:i.location,revalidation:i.revalidation,component:y,error:_,children:S(),routeContext:{outlet:null,matches:A,isDataRoute:!0}}):S()},null)}function Jd(a){return`${a} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Yy(a){let e=he.useContext(qs);return Jt(e,Jd(a)),e}function Zy(a){let e=he.useContext(cc);return Jt(e,Jd(a)),e}function Ky(a){let e=he.useContext(Ma);return Jt(e,Jd(a)),e}function $d(a){let e=Ky(a),i=e.matches[e.matches.length-1];return Jt(i.route.id,`${a} can only be used on routes that contain a unique "id"`),i.route.id}function Qy(){return $d("useRouteId")}function Jy(){var s;let a=he.useContext(Qd),e=Zy("useRouteError"),i=$d("useRouteError");return a!==void 0?a:(s=e.errors)==null?void 0:s[i]}function $y(){let{router:a}=Yy("useNavigate"),e=$d("useNavigate"),i=he.useRef(!1);return f_(()=>{i.current=!0}),he.useCallback(async(l,u={})=>{Ui(i.current,c_),i.current&&(typeof l=="number"?a.navigate(l):await a.navigate(l,{fromRouteId:e,...u}))},[a,e])}var t0={};function d_(a,e,i){!e&&!t0[a]&&(t0[a]=!0,Ui(!1,i))}he.memo(e1);function e1({routes:a,future:e,state:i}){return h_(a,void 0,i,e)}function Ii(a){Jt(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function t1({basename:a="/",children:e=null,location:i,navigationType:s="POP",navigator:l,static:u=!1}){Jt(!sl(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let f=a.replace(/^\/*/,"/"),h=he.useMemo(()=>({basename:f,navigator:l,static:u,future:{}}),[f,l,u]);typeof i=="string"&&(i=Vr(i));let{pathname:p="/",search:m="",hash:g="",state:_=null,key:x="default"}=i,y=he.useMemo(()=>{let M=Sa(p,f);return M==null?null:{location:{pathname:M,search:m,hash:g,state:_,key:x},navigationType:s}},[f,p,m,g,_,x,s]);return Ui(y!=null,`<Router basename="${f}"> is not able to match the URL "${p}${m}${g}" because it does not start with the basename, so the <Router> won't render anything.`),y==null?null:he.createElement(ki.Provider,{value:h},he.createElement(rl.Provider,{children:e,value:y}))}function n1({children:a,location:e}){return Vy(rd(a),e)}function rd(a,e=[]){let i=[];return he.Children.forEach(a,(s,l)=>{if(!he.isValidElement(s))return;let u=[...e,l];if(s.type===he.Fragment){i.push.apply(i,rd(s.props.children,u));return}Jt(s.type===Ii,`[${typeof s.type=="string"?s.type:s.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),Jt(!s.props.index||!s.props.children,"An index route cannot have child routes.");let f={id:s.props.id||u.join("-"),caseSensitive:s.props.caseSensitive,element:s.props.element,Component:s.props.Component,index:s.props.index,path:s.props.path,loader:s.props.loader,action:s.props.action,hydrateFallbackElement:s.props.hydrateFallbackElement,HydrateFallback:s.props.HydrateFallback,errorElement:s.props.errorElement,ErrorBoundary:s.props.ErrorBoundary,hasErrorBoundary:s.props.hasErrorBoundary===!0||s.props.ErrorBoundary!=null||s.props.errorElement!=null,shouldRevalidate:s.props.shouldRevalidate,handle:s.props.handle,lazy:s.props.lazy};s.props.children&&(f.children=rd(s.props.children,u)),i.push(f)}),i}var Yu="get",Zu="application/x-www-form-urlencoded";function fc(a){return a!=null&&typeof a.tagName=="string"}function i1(a){return fc(a)&&a.tagName.toLowerCase()==="button"}function a1(a){return fc(a)&&a.tagName.toLowerCase()==="form"}function r1(a){return fc(a)&&a.tagName.toLowerCase()==="input"}function s1(a){return!!(a.metaKey||a.altKey||a.ctrlKey||a.shiftKey)}function o1(a,e){return a.button===0&&(!e||e==="_self")&&!s1(a)}var bu=null;function l1(){if(bu===null)try{new FormData(document.createElement("form"),0),bu=!1}catch{bu=!0}return bu}var u1=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function bh(a){return a!=null&&!u1.has(a)?(Ui(!1,`"${a}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${Zu}"`),null):a}function c1(a,e){let i,s,l,u,f;if(a1(a)){let h=a.getAttribute("action");s=h?Sa(h,e):null,i=a.getAttribute("method")||Yu,l=bh(a.getAttribute("enctype"))||Zu,u=new FormData(a)}else if(i1(a)||r1(a)&&(a.type==="submit"||a.type==="image")){let h=a.form;if(h==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let p=a.getAttribute("formaction")||h.getAttribute("action");if(s=p?Sa(p,e):null,i=a.getAttribute("formmethod")||h.getAttribute("method")||Yu,l=bh(a.getAttribute("formenctype"))||bh(h.getAttribute("enctype"))||Zu,u=new FormData(h,a),!l1()){let{name:m,type:g,value:_}=a;if(g==="image"){let x=m?`${m}.`:"";u.append(`${x}x`,"0"),u.append(`${x}y`,"0")}else m&&u.append(m,_)}}else{if(fc(a))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');i=Yu,s=null,l=Zu,f=a}return u&&l==="text/plain"&&(f=u,u=void 0),{action:s,method:i.toLowerCase(),encType:l,formData:u,body:f}}function ep(a,e){if(a===!1||a===null||typeof a>"u")throw new Error(e)}async function f1(a,e){if(a.id in e)return e[a.id];try{let i=await import(a.module);return e[a.id]=i,i}catch(i){return console.error(`Error loading route module \`${a.module}\`, reloading page...`),console.error(i),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function h1(a){return a==null?!1:a.href==null?a.rel==="preload"&&typeof a.imageSrcSet=="string"&&typeof a.imageSizes=="string":typeof a.rel=="string"&&typeof a.href=="string"}async function d1(a,e,i){let s=await Promise.all(a.map(async l=>{let u=e.routes[l.route.id];if(u){let f=await f1(u,i);return f.links?f.links():[]}return[]}));return v1(s.flat(1).filter(h1).filter(l=>l.rel==="stylesheet"||l.rel==="preload").map(l=>l.rel==="stylesheet"?{...l,rel:"prefetch",as:"style"}:{...l,rel:"prefetch"}))}function n0(a,e,i,s,l,u){let f=(p,m)=>i[m]?p.route.id!==i[m].route.id:!0,h=(p,m)=>{var g;return i[m].pathname!==p.pathname||((g=i[m].route.path)==null?void 0:g.endsWith("*"))&&i[m].params["*"]!==p.params["*"]};return u==="assets"?e.filter((p,m)=>f(p,m)||h(p,m)):u==="data"?e.filter((p,m)=>{var _;let g=s.routes[p.route.id];if(!g||!g.hasLoader)return!1;if(f(p,m)||h(p,m))return!0;if(p.route.shouldRevalidate){let x=p.route.shouldRevalidate({currentUrl:new URL(l.pathname+l.search+l.hash,window.origin),currentParams:((_=i[0])==null?void 0:_.params)||{},nextUrl:new URL(a,window.origin),nextParams:p.params,defaultShouldRevalidate:!0});if(typeof x=="boolean")return x}return!0}):[]}function p1(a,e,{includeHydrateFallback:i}={}){return m1(a.map(s=>{let l=e.routes[s.route.id];if(!l)return[];let u=[l.module];return l.clientActionModule&&(u=u.concat(l.clientActionModule)),l.clientLoaderModule&&(u=u.concat(l.clientLoaderModule)),i&&l.hydrateFallbackModule&&(u=u.concat(l.hydrateFallbackModule)),l.imports&&(u=u.concat(l.imports)),u}).flat(1))}function m1(a){return[...new Set(a)]}function g1(a){let e={},i=Object.keys(a).sort();for(let s of i)e[s]=a[s];return e}function v1(a,e){let i=new Set;return new Set(e),a.reduce((s,l)=>{let u=JSON.stringify(g1(l));return i.has(u)||(i.add(u),s.push({key:u,link:l})),s},[])}var _1=new Set([100,101,204,205]);function x1(a,e){let i=typeof a=="string"?new URL(a,typeof window>"u"?"server://singlefetch/":window.location.origin):a;return i.pathname==="/"?i.pathname="_root.data":e&&Sa(i.pathname,e)==="/"?i.pathname=`${e.replace(/\/$/,"")}/_root.data`:i.pathname=`${i.pathname.replace(/\/$/,"")}.data`,i}function p_(){let a=he.useContext(qs);return ep(a,"You must render this element inside a <DataRouterContext.Provider> element"),a}function S1(){let a=he.useContext(cc);return ep(a,"You must render this element inside a <DataRouterStateContext.Provider> element"),a}var tp=he.createContext(void 0);tp.displayName="FrameworkContext";function m_(){let a=he.useContext(tp);return ep(a,"You must render this element inside a <HydratedRouter> element"),a}function y1(a,e){let i=he.useContext(tp),[s,l]=he.useState(!1),[u,f]=he.useState(!1),{onFocus:h,onBlur:p,onMouseEnter:m,onMouseLeave:g,onTouchStart:_}=e,x=he.useRef(null);he.useEffect(()=>{if(a==="render"&&f(!0),a==="viewport"){let A=v=>{v.forEach(L=>{f(L.isIntersecting)})},S=new IntersectionObserver(A,{threshold:.5});return x.current&&S.observe(x.current),()=>{S.disconnect()}}},[a]),he.useEffect(()=>{if(s){let A=setTimeout(()=>{f(!0)},100);return()=>{clearTimeout(A)}}},[s]);let y=()=>{l(!0)},M=()=>{l(!1),f(!1)};return i?a!=="intent"?[u,x,{}]:[u,x,{onFocus:qo(h,y),onBlur:qo(p,M),onMouseEnter:qo(m,y),onMouseLeave:qo(g,M),onTouchStart:qo(_,y)}]:[!1,x,{}]}function qo(a,e){return i=>{a&&a(i),i.defaultPrevented||e(i)}}function E1({page:a,...e}){let{router:i}=p_(),s=he.useMemo(()=>i_(i.routes,a,i.basename),[i.routes,a,i.basename]);return s?he.createElement(T1,{page:a,matches:s,...e}):null}function M1(a){let{manifest:e,routeModules:i}=m_(),[s,l]=he.useState([]);return he.useEffect(()=>{let u=!1;return d1(a,e,i).then(f=>{u||l(f)}),()=>{u=!0}},[a,e,i]),s}function T1({page:a,matches:e,...i}){let s=ur(),{manifest:l,routeModules:u}=m_(),{basename:f}=p_(),{loaderData:h,matches:p}=S1(),m=he.useMemo(()=>n0(a,e,p,l,s,"data"),[a,e,p,l,s]),g=he.useMemo(()=>n0(a,e,p,l,s,"assets"),[a,e,p,l,s]),_=he.useMemo(()=>{if(a===s.pathname+s.search+s.hash)return[];let M=new Set,A=!1;if(e.forEach(v=>{var C;let L=l.routes[v.route.id];!L||!L.hasLoader||(!m.some(U=>U.route.id===v.route.id)&&v.route.id in h&&((C=u[v.route.id])!=null&&C.shouldRevalidate)||L.hasClientLoader?A=!0:M.add(v.route.id))}),M.size===0)return[];let S=x1(a,f);return A&&M.size>0&&S.searchParams.set("_routes",e.filter(v=>M.has(v.route.id)).map(v=>v.route.id).join(",")),[S.pathname+S.search]},[f,h,s,l,m,e,a,u]),x=he.useMemo(()=>p1(g,l),[g,l]),y=M1(g);return he.createElement(he.Fragment,null,_.map(M=>he.createElement("link",{key:M,rel:"prefetch",as:"fetch",href:M,...i})),x.map(M=>he.createElement("link",{key:M,rel:"modulepreload",href:M,...i})),y.map(({key:M,link:A})=>he.createElement("link",{key:M,...A})))}function b1(...a){return e=>{a.forEach(i=>{typeof i=="function"?i(e):i!=null&&(i.current=e)})}}var g_=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{g_&&(window.__reactRouterVersion="7.5.3")}catch{}function A1({basename:a,children:e,window:i}){let s=he.useRef();s.current==null&&(s.current=dy({window:i,v5Compat:!0}));let l=s.current,[u,f]=he.useState({action:l.action,location:l.location}),h=he.useCallback(p=>{he.startTransition(()=>f(p))},[f]);return he.useLayoutEffect(()=>l.listen(h),[l,h]),he.createElement(t1,{basename:a,children:e,location:u.location,navigationType:u.action,navigator:l})}var v_=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,kr=he.forwardRef(function({onClick:e,discover:i="render",prefetch:s="none",relative:l,reloadDocument:u,replace:f,state:h,target:p,to:m,preventScrollReset:g,viewTransition:_,...x},y){let{basename:M}=he.useContext(ki),A=typeof m=="string"&&v_.test(m),S,v=!1;if(typeof m=="string"&&A&&(S=m,g_))try{let D=new URL(window.location.href),w=m.startsWith("//")?new URL(D.protocol+m):new URL(m),k=Sa(w.pathname,M);w.origin===D.origin&&k!=null?m=k+w.search+w.hash:v=!0}catch{Ui(!1,`<Link to="${m}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let L=Fy(m,{relative:l}),[C,U,F]=y1(s,x),G=U1(m,{replace:f,state:h,target:p,preventScrollReset:g,relative:l,viewTransition:_});function I(D){e&&e(D),D.defaultPrevented||G(D)}let j=he.createElement("a",{...x,...F,href:S||L,onClick:v||u?e:I,ref:b1(y,U),target:p,"data-discover":!A&&i==="render"?"true":void 0});return C&&!A?he.createElement(he.Fragment,null,j,he.createElement(E1,{page:L})):j});kr.displayName="Link";var R1=he.forwardRef(function({"aria-current":e="page",caseSensitive:i=!1,className:s="",end:l=!1,style:u,to:f,viewTransition:h,children:p,...m},g){let _=ol(f,{relative:m.relative}),x=ur(),y=he.useContext(cc),{navigator:M,basename:A}=he.useContext(ki),S=y!=null&&P1(_)&&h===!0,v=M.encodeLocation?M.encodeLocation(_).pathname:_.pathname,L=x.pathname,C=y&&y.navigation&&y.navigation.location?y.navigation.location.pathname:null;i||(L=L.toLowerCase(),C=C?C.toLowerCase():null,v=v.toLowerCase()),C&&A&&(C=Sa(C,A)||C);const U=v!=="/"&&v.endsWith("/")?v.length-1:v.length;let F=L===v||!l&&L.startsWith(v)&&L.charAt(U)==="/",G=C!=null&&(C===v||!l&&C.startsWith(v)&&C.charAt(v.length)==="/"),I={isActive:F,isPending:G,isTransitioning:S},j=F?e:void 0,D;typeof s=="function"?D=s(I):D=[s,F?"active":null,G?"pending":null,S?"transitioning":null].filter(Boolean).join(" ");let w=typeof u=="function"?u(I):u;return he.createElement(kr,{...m,"aria-current":j,className:D,ref:g,style:w,to:f,viewTransition:h},typeof p=="function"?p(I):p)});R1.displayName="NavLink";var w1=he.forwardRef(({discover:a="render",fetcherKey:e,navigate:i,reloadDocument:s,replace:l,state:u,method:f=Yu,action:h,onSubmit:p,relative:m,preventScrollReset:g,viewTransition:_,...x},y)=>{let M=N1(),A=O1(h,{relative:m}),S=f.toLowerCase()==="get"?"get":"post",v=typeof h=="string"&&v_.test(h),L=C=>{if(p&&p(C),C.defaultPrevented)return;C.preventDefault();let U=C.nativeEvent.submitter,F=(U==null?void 0:U.getAttribute("formmethod"))||f;M(U||C.currentTarget,{fetcherKey:e,method:F,navigate:i,replace:l,state:u,relative:m,preventScrollReset:g,viewTransition:_})};return he.createElement("form",{ref:y,method:S,action:A,onSubmit:s?p:L,...x,"data-discover":!v&&a==="render"?"true":void 0})});w1.displayName="Form";function C1(a){return`${a} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function __(a){let e=he.useContext(qs);return Jt(e,C1(a)),e}function U1(a,{target:e,replace:i,state:s,preventScrollReset:l,relative:u,viewTransition:f}={}){let h=Hy(),p=ur(),m=ol(a,{relative:u});return he.useCallback(g=>{if(o1(g,e)){g.preventDefault();let _=i!==void 0?i:nl(p)===nl(m);h(a,{replace:_,state:s,preventScrollReset:l,relative:u,viewTransition:f})}},[p,h,m,i,s,e,a,l,u,f])}var D1=0,L1=()=>`__${String(++D1)}__`;function N1(){let{router:a}=__("useSubmit"),{basename:e}=he.useContext(ki),i=Qy();return he.useCallback(async(s,l={})=>{let{action:u,method:f,encType:h,formData:p,body:m}=c1(s,e);if(l.navigate===!1){let g=l.fetcherKey||L1();await a.fetch(g,i,l.action||u,{preventScrollReset:l.preventScrollReset,formData:p,body:m,formMethod:l.method||f,formEncType:l.encType||h,flushSync:l.flushSync})}else await a.navigate(l.action||u,{preventScrollReset:l.preventScrollReset,formData:p,body:m,formMethod:l.method||f,formEncType:l.encType||h,replace:l.replace,state:l.state,fromRouteId:i,flushSync:l.flushSync,viewTransition:l.viewTransition})},[a,e,i])}function O1(a,{relative:e}={}){let{basename:i}=he.useContext(ki),s=he.useContext(Ma);Jt(s,"useFormAction must be used inside a RouteContext");let[l]=s.matches.slice(-1),u={...ol(a||".",{relative:e})},f=ur();if(a==null){u.search=f.search;let h=new URLSearchParams(u.search),p=h.getAll("index");if(p.some(g=>g==="")){h.delete("index"),p.filter(_=>_).forEach(_=>h.append("index",_));let g=h.toString();u.search=g?`?${g}`:""}}return(!a||a===".")&&l.route.index&&(u.search=u.search?u.search.replace(/^\?/,"?index&"):"?index"),i!=="/"&&(u.pathname=u.pathname==="/"?i:va([i,u.pathname])),nl(u)}function P1(a,e={}){let i=he.useContext(u_);Jt(i!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:s}=__("useViewTransitionState"),l=ol(a,{relative:e.relative});if(!i.isTransitioning)return!1;let u=Sa(i.currentLocation.pathname,s)||i.currentLocation.pathname,f=Sa(i.nextLocation.pathname,s)||i.nextLocation.pathname;return ac(l.pathname,f)!=null||ac(l.pathname,u)!=null}new TextEncoder;[..._1];const Hs="Cal Sans",Bs="Oswald",_a="Arial, sans",B1=1e3,rc="Jay H. Crawford",Ku="65",tl="opacity-65 font-bold text-white",ll=a=>N.jsx(N.Fragment,{children:N.jsxs("div",{className:"text-white m-10",children:[a.construction==!0&&N.jsx("div",{className:"flex justify-center mb-10",children:N.jsxs("div",{className:"flex flex-col",children:[N.jsx("div",{className:"flex justify-center",children:N.jsx("div",{className:"h-40 w-40",children:N.jsx("img",{src:"./under_construction.svg"})})}),N.jsx("p",{className:"inline-block bg-red-500 rounded-xl text-center font-extrabold text-4xl",children:"This section is under construction"})]})}),N.jsx("h1",{style:{fontFamily:Bs},id:"blog_header",className:"text-5xl text-white font-extrabold pb-10 ",children:a.title}),N.jsx("div",{className:"p-5",style:{backgroundColor:"#0b0f17",borderRadius:"20px"},children:a.children})]})}),Pn=a=>N.jsx("section",{id:"blog_standardParagraph",className:"mt-0",style:{fontFamily:_a},children:N.jsx("p",{className:"indent-20 pb-5",children:a.text})}),z1=()=>N.jsxs(N.Fragment,{children:[N.jsx("style",{children:`
        ...
        `}),N.jsxs(ll,{title:"About",construction:!1,children:[N.jsx(Pn,{text:"I’m an artist and engineering student based in Los Angeles. I grew up in Kentucky and earned my BFA from the School of the Art Institute of Chicago before moving to LA in 2017. In moving to LA, my goal was to study alongside great acting teachers and I did that twice weekly, for four years. (Performance and emotion other fascinations of mine) "}),N.jsx(Pn,{text:`My paintings explore the tension between painting as image and painting as object, where flatness meets surface. Something about the line in between object and image draws me into experimenting with what I consider to be "wrong-ness" in the work. I’m drawn to that moment when something feels just slightly off, when a move on a painting initially strikes me with revolting inadequacy—I'll often stop there.`}),N.jsx(Pn,{text:"Alongside my art practice, my studies as an engineering student have a focus on product design, app interfaces, and data analysis. I’m interested in how systems break down and reassemble—whether in a canvas or a codebase. My work moves between those worlds, and they feed each other in unexpected ways."}),N.jsx(Pn,{text:"As an artist, I like breaking things. As an engineer, creating things."})]})]}),I1=a=>N.jsxs(N.Fragment,{children:[a.url==""&&N.jsx("div",{id:"this_one",className:"h-30 w-30 absolute",children:N.jsx("img",{src:"./under_construction.svg"})}),N.jsx("div",{style:{boxShadow:"5px 5px 5px rgba(0, 0, 0, 1)"},className:"gridPhoto_Image_container w-80 h-60",children:N.jsx("img",{className:"rounded-lg w-80 h-60",style:{objectFit:"cover"},src:a.img})})]}),F1=a=>{const[e,i]=he.useState(!1);return N.jsx("div",{onMouseEnter:()=>i(!0),onMouseLeave:()=>i(!1),children:N.jsx(kr,{id:"",to:a.url?a.url:"",children:N.jsx("div",{className:"gridPhoto_container p-1 m-2 flex justify-center",children:N.jsxs("div",{className:`gridPhoto_item_container m-2 inline ${a.url==""&&"cursor-not-allowed"}`,children:[N.jsx("style",{children:`
...
`)}function uA(a,e){let i;switch(e){case gE:i="Linear";break;case vE:i="Reinhard";break;case _E:i="Cineon";break;case xE:i="ACESFilmic";break;case yE:i="AgX";break;case EE:i="Neutral";break;case SE:i="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),i="Linear"}return"vec3 "+a+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const qu=new se;function cA(){Rt.getLuminanceCoefficients(qu);const a=qu.x.toFixed(4),e=qu.y.toFixed(4),i=qu.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${a}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            opacity: 100%;
                    ...
                    `}),a.map((e,i)=>N.jsx("a",{"aria-label":`Our ${e.name}`,href:e.url,target:"_blank",className:"glow-button socialbrick-link",children:N.jsx(eR,{name:e.name})},i))]})})};function nR(a){return a?a.toLowerCase().split(" ").map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(" "):""}const Ps=()=>N.jsx("span",{className:`${tl} ml-5 mr-5`,children:"|"}),ar=a=>N.jsx("li",{style:{transition:"opacity .1s .1s"},className:`outline_nav_elem_text ${tl} hover:underline hover:opacity-100`,children:N.jsxs(kr,{to:`${a.name}`,children:[N.jsx("style",{children:`
 
        
        `}),nR(a.name)]})}),iR=a=>a.path=="/"?N.jsxs(N.Fragment,{children:[N.jsx("nav",{className:"z-10 w-ful",children:N.jsxs("ul",{style:{fontFamily:Bs},className:"list-none p-0 pb-4 m-0 flex justify-center text-xl sm:text-3xl md:text-5xl",children:[N.jsx(ar,{name:"about"}),N.jsx(Ps,{}),N.jsx(ar,{name:"art"}),N.jsx(Ps,{}),N.jsx(ar,{name:"projects"}),N.jsx(Ps,{}),N.jsx(ar,{name:"contact"})]})}),N.jsxs("header",{style:{marginBottom:"70px"},children:[N.jsx("h1",{className:"text-center text-white",style:{fontFamily:Hs,fontSize:a.width<500?"3rem":"6rem",fontWeight:"bold"},children:rc}),N.jsx("p",{className:`${tl} text-5xl text-center`,style:{fontFamily:Bs},children:"Interdisciplinary Creative & Programmer"}),N.jsx("p",{style:{fontFamily:_a},className:`text-center p-4 ${tl} text-3xl`,children:"Los Angeles, CA"}),N.jsx(tR,{})]})]}):N.jsxs(N.Fragment,{children:[N.jsx("nav",{className:"z-10 w-full mb-5",children:N.jsxs("ul",{style:{fontFamily:Bs},className:"list-none p-0 m-0 flex sm:text-2xl md:text-5xl",children:[N.jsx(ar,{name:"about"}),N.jsx(Ps,{}),N.jsx(ar,{name:"art"}),N.jsx(Ps,{}),N.jsx(ar,{name:"projects"}),N.jsx(Ps,{}),N.jsx(ar,{name:"contact"})]})}),N.jsxs("header",{style:{marginBottom:"70px"},children:[N.jsx(kr,{to:"/",children:N.jsx("h1",{className:"text-white",style:{fontFamily:Hs,fontSize:a.width<500?"1rem":"2rem",fontWeight:"bold"},children:rc})}),N.jsx("p",{className:`${tl} text-3xl text-left`,style:{fontFamily:Bs},children:"Interdisciplinary Creative & Programmer"})]})]}),aR=a=>{let e="";return N.jsxs(N.Fragment,{children:[N.jsx("style",{children:`
        #location-bar {
        }
 ...
 * @license Zlib
 */var nd=1/1e3,hR=1e3,dR=class{constructor(){this.startTime=performance.now(),this.previousTime=0,this.currentTime=0,this._delta=0,this._elapsed=0,this._fixedDelta=1e3/60,this.timescale=1,this.useFixedDelta=!1,this._autoReset=!1}get autoReset(){return this._autoReset}set autoReset(a){typeof document<"u"&&document.hidden!==void 0&&(a?document.addEventListener("visibilitychange",this):document.removeEventListener("visibilitychange",this),this._autoReset=a)}get delta(){return this._delta*nd}get fixedDelta(){return this._fixedDelta*nd}set fixedDelta(a){this._fixedDelta=a*hR}get elapsed(){return this._elapsed*nd}update(a){this.useFixedDelta?this._delta=this.fixedDelta:(this.previousTime=this.currentTime,this.currentTime=(a!==void 0?a:performance.now())-this.startTime,this._delta=this.currentTime-this.previousTime),this._delta*=this.timescale,this._elapsed+=this._delta}reset(){this._delta=0,this._elapsed=0,this.currentTime=performance.now()-this.startTime}getDelta(){return this.delta}getElapsed(){return this.elapsed}handleEvent(a){document.hidden||(this.currentTime=performance.now()-this.startTime)}dispose(){this.autoReset=!1}},pR=(()=>{const a=new Float32Array([-1,-1,0,3,-1,0,-1,3,0]),e=new Float32Array([0,0,2,0,0,2]),i=new ba;return i.setAttribute("position",new Si(a,3)),i.setAttribute("uv",new Si(e,2)),i})(),Di=class Zd{static get fullscreenGeometry(){return pR}constructor(e="Pass",i=new uc,s=new cp){this.name=e,this.renderer=null,this.scene=i,this.camera=s,this.screen=null,this.rtt=!0,this.needsSwap=!0,this.needsDepthTexture=!1,this.enabled=!0}get renderToScreen(){return!this.rtt}set renderToScreen(e){if(this.rtt===e){const i=this.fullscreenMaterial;i!==null&&(i.needsUpdate=!0),this.rtt=!e}}set mainScene(e){}set mainCamera(e){}setRenderer(e){this.renderer=e}isEnabled(){return this.enabled}setEnabled(e){this.enabled=e}get fullscreenMaterial(){return this.screen!==null?this.screen.material:null}set fullscreenMaterial(e){let i=this.screen;i!==null?i.material=e:(i=new xi(Zd.fullscreenGeometry,e),i.frustumCulled=!1,this.scene===null&&(this.scene=new uc),this.scene.add(i),this.screen=i)}getFullscreenMaterial(){return this.fullscreenMaterial}setFullscreenMaterial(e){this.fullscreenMaterial=e}getDepthTexture(){return null}setDepthTexture(e,i=fl){}render(e,i,s,l,u){throw new Error("Render method not implemented!")}setSize(e,i){}initialize(e,i,s){}dispose(){for(const e of Object.keys(this)){const i=this[e];(i instanceof Gn||i instanceof Ys||i instanceof Bn||i instanceof Zd)&&this[e].dispose()}this.fullscreenMaterial!==null&&this.fullscreenMaterial.dispose()}},mR=class extends Di{constructor(){super("ClearMaskPass",null,null),this.needsSwap=!1}render(a,e,i,s,l){const u=a.state.buffers.stencil;u.setLocked(!1),u.setTest(!1)}},gR=`#include <common>
#include <dithering_pars_fragment>
...
#include <colorspace_fragment>
}`,fw="uniform vec2 texelSize;varying vec2 vUv;varying vec2 vUv00;varying vec2 vUv01;varying vec2 vUv02;varying vec2 vUv03;varying vec2 vUv04;varying vec2 vUv05;varying vec2 vUv06;varying vec2 vUv07;varying vec2 vUv08;varying vec2 vUv09;varying vec2 vUv10;varying vec2 vUv11;void main(){vUv=position.xy*0.5+0.5;vUv00=vUv+texelSize*vec2(-1.0,1.0);vUv01=vUv+texelSize*vec2(1.0,1.0);vUv02=vUv+texelSize*vec2(-1.0,-1.0);vUv03=vUv+texelSize*vec2(1.0,-1.0);vUv04=vUv+texelSize*vec2(-2.0,2.0);vUv05=vUv+texelSize*vec2(0.0,2.0);vUv06=vUv+texelSize*vec2(2.0,2.0);vUv07=vUv+texelSize*vec2(-2.0,0.0);vUv08=vUv+texelSize*vec2(2.0,0.0);vUv09=vUv+texelSize*vec2(-2.0,-2.0);vUv10=vUv+texelSize*vec2(0.0,-2.0);vUv11=vUv+texelSize*vec2(2.0,-2.0);gl_Position=vec4(position.xy,1.0,1.0);}",hw=class extends Vn{constructor(){super({name:"DownsamplingMaterial",uniforms:{inputBuffer:new Lt(null),texelSize:new Lt(new ot)},blending:Jn,toneMapped:!1,depthWrite:!1,depthTest:!1,fragmentShader:cw,vertexShader:fw})}set inputBuffer(a){this.uniforms.inputBuffer.value=a}setSize(a,e){this.uniforms.texelSize.value.set(1/a,1/e)}},dw=`#ifdef FRAMEBUFFER_PRECISION_HIGH
...
#`));this.skipRendering=e===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(a)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(a,e=fl){this.fullscreenMaterial.depthBuffer=a,this.fullscreenMaterial.depthPacking=e;for(const i of this.effects)i.setDepthTexture(a,e)}render(a,e,i,s,l){for(const u of this.effects)u.update(a,e,s);if(!this.skipRendering||this.renderToScreen){const u=this.fullscreenMaterial;u.inputBuffer=e.texture,u.time+=s*this.timeScale,a.setRenderTarget(this.renderToScreen?null:i),a.render(this.scene,this.camera)}}setSize(a,e){this.fullscreenMaterial.setSize(a,e);for(const i of this.effects)i.setSize(a,e)}initialize(a,e,i){this.renderer=a;for(const s of this.effects)s.initialize(a,e,i);this.updateMaterial(),i!==void 0&&i!==zn&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH="1")}dispose(){super.dispose();for(const a of this.effects)a.removeEventListener("change",this.listener),a.dispose()}handleEvent(a){switch(a.type){case"change":this.recompile();break}}};const bw=()=>{const{width:a,height:e}=S_(),i=he.useRef(null);return he.useEffect(()=>{const s=new uc,l=new Kn(75,a/e,.1,1e3),u=new q_({alpha:!0});u.setClearColor(0,0),u.setSize(a,e),u.domElement.style.position="absolute",u.domElement.style.top="0",u.domElement.style.left="0",u.domElement.style.zIndex="-1";const f=i.current;f instanceof HTMLElement&&!f.hasChildNodes()&&f.appendChild(u.domElement);const h=new $o;for(let x=0;x<50;x++){const y=.03+Math.random()*.07,M=new hp(y,7,7),A=new dc({color:"white"}),S=new xi(M,A);S.position.x=(Math.random()-.5)*10,S.position.y=(Math.random()-.5)*10,S.position.z=(Math.random()-.5)*10,h.add(S)}s.add(h),l.position.z=5,h.children.forEach(x=>{});const p=new xR(u);p.addPass(new xw(s,l));const m=new _w({intensity:.15,luminanceThreshold:.007,luminanceSmoothing:.2,radius:15}),g=new Tw(l,m);g.renderToScreen=!0,p.addPass(g);const _=()=>{requestAnimationFrame(_),h.rotation.x+=89e-6,h.rotation.y+=99e-6,p.render()};return _(),()=>{f&&f.removeChild(u.domElement)}},[a,e]),N.jsx("div",{id:"three_background",style:{position:"fixed",top:0,left:0,width:`${a}px`,height:`${e}px`,overflow:"hidden"},ref:i})},Aw=()=>N.jsx("div",{children:N.jsxs(ll,{construction:!0,title:"UrFriends",children:[N.jsx(Pn,{text:"UrFriends is designed to help you build real, lasting relationships using your device. "}),N.jsx(Pn,{text:`
                ...
                UrFriends is for people who believe technology should bring us together—not make us busier.`})]})}),Rw=()=>N.jsx("div",{children:N.jsxs(ll,{construction:!0,title:"The Book",children:[N.jsx(Pn,{text:"The Book is a project that I started in highschool. This is an expansive collection of great thoughts, ideas, practices, and philosphies."}),N.jsx(Pn,{text:`
