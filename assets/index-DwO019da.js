 ...
 */var E0;function Uy(){if(E0)return Lo;E0=1;var r=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function i(s,l,c){var h=null;if(c!==void 0&&(h=""+c),l.key!==void 0&&(h=""+l.key),"key"in l){c={};for(var d in l)d!=="key"&&(c[d]=l[d])}else c=l;return l=c.ref,{$$typeof:r,type:s,key:h,ref:l!==void 0?l:null,props:c}}return Lo.Fragment=e,Lo.jsx=i,Lo.jsxs=i,Lo}var b0;function Ly(){return b0||(b0=1,rh.exports=Uy()),rh.exports}var z=Ly(),sh={exports:{}},rt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
Please change the parent <Route path="${U}"> to <Route path="${U==="/"?"*":`${U}/*`}">.`)}let v=Za(),M;if(e){let U=typeof e=="string"?Dr(e):e;jt(g==="/"||((O=U.pathname)==null?void 0:O.startsWith(g)),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${g}" but pathname "${U.pathname}" was given in the \`location\` prop.`),M=U}else M=v;let E=M.pathname||"/",A=E;if(g!=="/"){let U=g.replace(/^\//,"").split("/");A="/"+E.replace(/^\//,"").split("/").slice(U.length).join("/")}let y=!c&&i&&i.matches&&i.matches.length>0?i.matches:B_(r,{pathname:A});vi(x||y!=null,`No routes matched location "${M.pathname}${M.search}${M.hash}" `),vi(y==null||y[y.length-1].route.element!==void 0||y[y.length-1].route.Component!==void 0||y[y.length-1].route.lazy!==void 0,`Matched leaf route at location "${M.pathname}${M.search}${M.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let _=MS(y&&y.map(U=>Object.assign({},U,{params:Object.assign({},p,U.params),pathname:aa([g,l.encodeLocation?l.encodeLocation(U.pathname).pathname:U.pathname]),pathnameBase:U.pathnameBase==="/"?g:aa([g,l.encodeLocation?l.encodeLocation(U.pathnameBase).pathname:U.pathnameBase])})),h,i,s);return e&&_?pe.createElement(Zo.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...M},navigationType:"POP"}},_):_}function vS(){let r=RS(),e=uS(r)?`${r.status} ${r.statusText}`:r instanceof Error?r.message:JSON.stringify(r),i=r instanceof Error?r.stack:null,s="rgba(200,200,200, 0.5)",l={padding:"0.5rem",backgroundColor:s},c={padding:"2px 4px",backgroundColor:s},h=null;return console.error("Error handled by React Router default ErrorBoundary:",r),h=pe.createElement(pe.Fragment,null,pe.createElement("p",null,"💿 Hey developer 👋"),pe.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",pe.createElement("code",{style:c},"ErrorBoundary")," or"," ",pe.createElement("code",{style:c},"errorElement")," prop on your route.")),pe.createElement(pe.Fragment,null,pe.createElement("h2",null,"Unexpected Application Error!"),pe.createElement("h3",{style:{fontStyle:"italic"}},e),i?pe.createElement("pre",{style:l},i):null,h)}var xS=pe.createElement(vS,null),yS=class extends pe.Component{constructor(r){super(r),this.state={location:r.location,revalidation:r.revalidation,error:r.error}}static getDerivedStateFromError(r){return{error:r}}static getDerivedStateFromProps(r,e){return e.location!==r.location||e.revalidation!=="idle"&&r.revalidation==="idle"?{error:r.error,location:r.location,revalidation:r.revalidation}:{error:r.error!==void 0?r.error:e.error,location:e.location,revalidation:r.revalidation||e.revalidation}}componentDidCatch(r,e){console.error("React Router caught the following error during render",r,e)}render(){return this.state.error!==void 0?pe.createElement(ca.Provider,{value:this.props.routeContext},pe.createElement(Pd.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function SS({routeContext:r,match:e,children:i}){let s=pe.useContext(Ps);return s&&s.static&&s.staticContext&&(e.route.errorElement||e.route.ErrorBoundary)&&(s.staticContext._deepestRenderedBoundaryId=e.route.id),pe.createElement(ca.Provider,{value:r},i)}function MS(r,e=[],i=null,s=null){if(r==null){if(!i)return null;if(i.errors)r=i.matches;else if(e.length===0&&!i.initialized&&i.matches.length>0)r=i.matches;else return null}let l=r,c=i==null?void 0:i.errors;if(c!=null){let p=l.findIndex(m=>m.route.id&&(c==null?void 0:c[m.route.id])!==void 0);jt(p>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(c).join(",")}`),l=l.slice(0,Math.min(l.length,p+1))}let h=!1,d=-1;if(i)for(let p=0;p<l.length;p++){let m=l[p];if((m.route.HydrateFallback||m.route.hydrateFallbackElement)&&(d=p),m.route.id){let{loaderData:g,errors:x}=i,v=m.route.loader&&!g.hasOwnProperty(m.route.id)&&(!x||x[m.route.id]===void 0);if(m.route.lazy||v){h=!0,d>=0?l=l.slice(0,d+1):l=[l[0]];break}}}return l.reduceRight((p,m,g)=>{let x,v=!1,M=null,E=null;i&&(x=c&&m.route.id?c[m.route.id]:void 0,M=m.route.errorElement||xS,h&&(d<0&&g===0?(q_("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),v=!0,E=null):d===g&&(v=!0,E=m.route.hydrateFallbackElement||null)));let A=e.concat(l.slice(0,g+1)),y=()=>{let _;return x?_=M:v?_=E:m.route.Component?_=pe.createElement(m.route.Component,null):m.route.element?_=m.route.element:_=p,pe.createElement(SS,{match:m,routeContext:{outlet:p,matches:A,isDataRoute:i!=null},children:_})};return i&&(m.route.ErrorBoundary||m.route.errorElement||g===0)?pe.createElement(yS,{location:i.location,revalidation:i.revalidation,component:M,error:x,children:y(),routeContext:{outlet:null,matches:A,isDataRoute:!0}}):y()},null)}function Bd(r){return`${r} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function ES(r){let e=pe.useContext(Ps);return jt(e,Bd(r)),e}function bS(r){let e=pe.useContext(Qc);return jt(e,Bd(r)),e}function TS(r){let e=pe.useContext(ca);return jt(e,Bd(r)),e}function zd(r){let e=TS(r),i=e.matches[e.matches.length-1];return jt(i.route.id,`${r} can only be used on routes that contain a unique "id"`),i.route.id}function AS(){return zd("useRouteId")}function RS(){var s;let r=pe.useContext(Pd),e=bS("useRouteError"),i=zd("useRouteError");return r!==void 0?r:(s=e.errors)==null?void 0:s[i]}function wS(){let{router:r}=ES("useNavigate"),e=zd("useNavigate"),i=pe.useRef(!1);return X_(()=>{i.current=!0}),pe.useCallback(async(l,c={})=>{vi(i.current,k_),i.current&&(typeof l=="number"?r.navigate(l):await r.navigate(l,{fromRouteId:e,...c}))},[r,e])}var z0={};function q_(r,e,i){!e&&!z0[r]&&(z0[r]=!0,vi(!1,i))}pe.memo(CS);function CS({routes:r,future:e,state:i}){return W_(r,void 0,i,e)}function Ts(r){jt(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function DS({basename:r="/",children:e=null,location:i,navigationType:s="POP",navigator:l,static:c=!1}){jt(!Ko(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let h=r.replace(/^\/*/,"/"),d=pe.useMemo(()=>({basename:h,navigator:l,static:c,future:{}}),[h,l,c]);typeof i=="string"&&(i=Dr(i));let{pathname:p="/",search:m="",hash:g="",state:x=null,key:v="default"}=i,M=pe.useMemo(()=>{let E=sa(p,h);return E==null?null:{location:{pathname:E,search:m,hash:g,state:x,key:v},navigationType:s}},[h,p,m,g,x,v,s]);return vi(M!=null,`<Router basename="${h}"> is not able to match the URL "${p}${m}${g}" because it does not start with the basename, so the <Router> won't render anything.`),M==null?null:pe.createElement(Ci.Provider,{value:d},pe.createElement(Zo.Provider,{children:e,value:M}))}function US({children:r,location:e}){return _S(Xh(r),e)}function Xh(r,e=[]){let i=[];return pe.Children.forEach(r,(s,l)=>{if(!pe.isValidElement(s))return;let c=[...e,l];if(s.type===pe.Fragment){i.push.apply(i,Xh(s.props.children,c));return}jt(s.type===Ts,`[${typeof s.type=="string"?s.type:s.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),jt(!s.props.index||!s.props.children,"An index route cannot have child routes.");let h={id:s.props.id||c.join("-"),caseSensitive:s.props.caseSensitive,element:s.props.element,Component:s.props.Component,index:s.props.index,path:s.props.path,loader:s.props.loader,action:s.props.action,hydrateFallbackElement:s.props.hydrateFallbackElement,HydrateFallback:s.props.HydrateFallback,errorElement:s.props.errorElement,ErrorBoundary:s.props.ErrorBoundary,hasErrorBoundary:s.props.hasErrorBoundary===!0||s.props.ErrorBoundary!=null||s.props.errorElement!=null,shouldRevalidate:s.props.shouldRevalidate,handle:s.props.handle,lazy:s.props.lazy};s.props.children&&(h.children=Xh(s.props.children,c)),i.push(h)}),i}var Bc="get",zc="application/x-www-form-urlencoded";function Jc(r){return r!=null&&typeof r.tagName=="string"}function LS(r){return Jc(r)&&r.tagName.toLowerCase()==="button"}function NS(r){return Jc(r)&&r.tagName.toLowerCase()==="form"}function OS(r){return Jc(r)&&r.tagName.toLowerCase()==="input"}function PS(r){return!!(r.metaKey||r.altKey||r.ctrlKey||r.shiftKey)}function BS(r,e){return r.button===0&&(!e||e==="_self")&&!PS(r)}var hc=null;function zS(){if(hc===null)try{new FormData(document.createElement("form"),0),hc=!1}catch{hc=!0}return hc}var IS=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function hh(r){return r!=null&&!IS.has(r)?(vi(!1,`"${r}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${zc}"`),null):r}function FS(r,e){let i,s,l,c,h;if(NS(r)){let d=r.getAttribute("action");s=d?sa(d,e):null,i=r.getAttribute("method")||Bc,l=hh(r.getAttribute("enctype"))||zc,c=new FormData(r)}else if(LS(r)||OS(r)&&(r.type==="submit"||r.type==="image")){let d=r.form;if(d==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let p=r.getAttribute("formaction")||d.getAttribute("action");if(s=p?sa(p,e):null,i=r.getAttribute("formmethod")||d.getAttribute("method")||Bc,l=hh(r.getAttribute("formenctype"))||hh(d.getAttribute("enctype"))||zc,c=new FormData(d,r),!zS()){let{name:m,type:g,value:x}=r;if(g==="image"){let v=m?`${m}.`:"";c.append(`${v}x`,"0"),c.append(`${v}y`,"0")}else m&&c.append(m,x)}}else{if(Jc(r))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');i=Bc,s=null,l=zc,h=r}return c&&l==="text/plain"&&(h=c,c=void 0),{action:s,method:i.toLowerCase(),encType:l,formData:c,body:h}}function Id(r,e){if(r===!1||r===null||typeof r>"u")throw new Error(e)}async function HS(r,e){if(r.id in e)return e[r.id];try{let i=await import(r.module);return e[r.id]=i,i}catch(i){return console.error(`Error loading route module \`${r.module}\`, reloading page...`),console.error(i),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function GS(r){return r==null?!1:r.href==null?r.rel==="preload"&&typeof r.imageSrcSet=="string"&&typeof r.imageSizes=="string":typeof r.rel=="string"&&typeof r.href=="string"}async function VS(r,e,i){let s=await Promise.all(r.map(async l=>{let c=e.routes[l.route.id];if(c){let h=await HS(c,i);return h.links?h.links():[]}return[]}));return qS(s.flat(1).filter(GS).filter(l=>l.rel==="stylesheet"||l.rel==="preload").map(l=>l.rel==="stylesheet"?{...l,rel:"prefetch",as:"style"}:{...l,rel:"prefetch"}))}function I0(r,e,i,s,l,c){let h=(p,m)=>i[m]?p.route.id!==i[m].route.id:!0,d=(p,m)=>{var g;return i[m].pathname!==p.pathname||((g=i[m].route.path)==null?void 0:g.endsWith("*"))&&i[m].params["*"]!==p.params["*"]};return c==="assets"?e.filter((p,m)=>h(p,m)||d(p,m)):c==="data"?e.filter((p,m)=>{var x;let g=s.routes[p.route.id];if(!g||!g.hasLoader)return!1;if(h(p,m)||d(p,m))return!0;if(p.route.shouldRevalidate){let v=p.route.shouldRevalidate({currentUrl:new URL(l.pathname+l.search+l.hash,window.origin),currentParams:((x=i[0])==null?void 0:x.params)||{},nextUrl:new URL(r,window.origin),nextParams:p.params,defaultShouldRevalidate:!0});if(typeof v=="boolean")return v}return!0}):[]}function kS(r,e,{includeHydrateFallback:i}={}){return XS(r.map(s=>{let l=e.routes[s.route.id];if(!l)return[];let c=[l.module];return l.clientActionModule&&(c=c.concat(l.clientActionModule)),l.clientLoaderModule&&(c=c.concat(l.clientLoaderModule)),i&&l.hydrateFallbackModule&&(c=c.concat(l.hydrateFallbackModule)),l.imports&&(c=c.concat(l.imports)),c}).flat(1))}function XS(r){return[...new Set(r)]}function WS(r){let e={},i=Object.keys(r).sort();for(let s of i)e[s]=r[s];return e}function qS(r,e){let i=new Set;return new Set(e),r.reduce((s,l)=>{let c=JSON.stringify(WS(l));return i.has(c)||(i.add(c),s.push({key:c,link:l})),s},[])}var jS=new Set([100,101,204,205]);function YS(r,e){let i=typeof r=="string"?new URL(r,typeof window>"u"?"server://singlefetch/":window.location.origin):r;return i.pathname==="/"?i.pathname="_root.data":e&&sa(i.pathname,e)==="/"?i.pathname=`${e.replace(/\/$/,"")}/_root.data`:i.pathname=`${i.pathname.replace(/\/$/,"")}.data`,i}function j_(){let r=pe.useContext(Ps);return Id(r,"You must render this element inside a <DataRouterContext.Provider> element"),r}function ZS(){let r=pe.useContext(Qc);return Id(r,"You must render this element inside a <DataRouterStateContext.Provider> element"),r}var Fd=pe.createContext(void 0);Fd.displayName="FrameworkContext";function Y_(){let r=pe.useContext(Fd);return Id(r,"You must render this element inside a <HydratedRouter> element"),r}function KS(r,e){let i=pe.useContext(Fd),[s,l]=pe.useState(!1),[c,h]=pe.useState(!1),{onFocus:d,onBlur:p,onMouseEnter:m,onMouseLeave:g,onTouchStart:x}=e,v=pe.useRef(null);pe.useEffect(()=>{if(r==="render"&&h(!0),r==="viewport"){let A=_=>{_.forEach(O=>{h(O.isIntersecting)})},y=new IntersectionObserver(A,{threshold:.5});return v.current&&y.observe(v.current),()=>{y.disconnect()}}},[r]),pe.useEffect(()=>{if(s){let A=setTimeout(()=>{h(!0)},100);return()=>{clearTimeout(A)}}},[s]);let M=()=>{l(!0)},E=()=>{l(!1),h(!1)};return i?r!=="intent"?[c,v,{}]:[c,v,{onFocus:Po(d,M),onBlur:Po(p,E),onMouseEnter:Po(m,M),onMouseLeave:Po(g,E),onTouchStart:Po(x,M)}]:[!1,v,{}]}function Po(r,e){return i=>{r&&r(i),i.defaultPrevented||e(i)}}function QS({page:r,...e}){let{router:i}=j_(),s=pe.useMemo(()=>B_(i.routes,r,i.basename),[i.routes,r,i.basename]);return s?pe.createElement($S,{page:r,matches:s,...e}):null}function JS(r){let{manifest:e,routeModules:i}=Y_(),[s,l]=pe.useState([]);return pe.useEffect(()=>{let c=!1;return VS(r,e,i).then(h=>{c||l(h)}),()=>{c=!0}},[r,e,i]),s}function $S({page:r,matches:e,...i}){let s=Za(),{manifest:l,routeModules:c}=Y_(),{basename:h}=j_(),{loaderData:d,matches:p}=ZS(),m=pe.useMemo(()=>I0(r,e,p,l,s,"data"),[r,e,p,l,s]),g=pe.useMemo(()=>I0(r,e,p,l,s,"assets"),[r,e,p,l,s]),x=pe.useMemo(()=>{if(r===s.pathname+s.search+s.hash)return[];let E=new Set,A=!1;if(e.forEach(_=>{var U;let O=l.routes[_.route.id];!O||!O.hasLoader||(!m.some(C=>C.route.id===_.route.id)&&_.route.id in d&&((U=c[_.route.id])!=null&&U.shouldRevalidate)||O.hasClientLoader?A=!0:E.add(_.route.id))}),E.size===0)return[];let y=YS(r,h);return A&&E.size>0&&y.searchParams.set("_routes",e.filter(_=>E.has(_.route.id)).map(_=>_.route.id).join(",")),[y.pathname+y.search]},[h,d,s,l,m,e,r,c]),v=pe.useMemo(()=>kS(g,l),[g,l]),M=JS(g);return pe.createElement(pe.Fragment,null,x.map(E=>pe.createElement("link",{key:E,rel:"prefetch",as:"fetch",href:E,...i})),v.map(E=>pe.createElement("link",{key:E,rel:"modulepreload",href:E,...i})),M.map(({key:E,link:A})=>pe.createElement("link",{key:E,...A})))}function e1(...r){return e=>{r.forEach(i=>{typeof i=="function"?i(e):i!=null&&(i.current=e)})}}var Z_=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Z_&&(window.__reactRouterVersion="7.5.3")}catch{}function t1({basename:r,children:e,window:i}){let s=pe.useRef();s.current==null&&(s.current=Vy({window:i,v5Compat:!0}));let l=s.current,[c,h]=pe.useState({action:l.action,location:l.location}),d=pe.useCallback(p=>{pe.startTransition(()=>h(p))},[h]);return pe.useLayoutEffect(()=>l.listen(d),[l,d]),pe.createElement(DS,{basename:r,children:e,location:c.location,navigationType:c.action,navigator:l})}var K_=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Ur=pe.forwardRef(function({onClick:e,discover:i="render",prefetch:s="none",relative:l,reloadDocument:c,replace:h,state:d,target:p,to:m,preventScrollReset:g,viewTransition:x,...v},M){let{basename:E}=pe.useContext(Ci),A=typeof m=="string"&&K_.test(m),y,_=!1;if(typeof m=="string"&&A&&(y=m,Z_))try{let D=new URL(window.location.href),w=m.startsWith("//")?new URL(D.protocol+m):new URL(m),V=sa(w.pathname,E);w.origin===D.origin&&V!=null?m=V+w.search+w.hash:_=!0}catch{vi(!1,`<Link to="${m}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let O=pS(m,{relative:l}),[U,C,H]=KS(s,v),k=r1(m,{replace:h,state:d,target:p,preventScrollReset:g,relative:l,viewTransition:x});function I(D){e&&e(D),D.defaultPrevented||k(D)}let q=pe.createElement("a",{...v,...H,href:y||O,onClick:_||c?e:I,ref:e1(M,C),target:p,"data-discover":!A&&i==="render"?"true":void 0});return U&&!A?pe.createElement(pe.Fragment,null,q,pe.createElement(QS,{page:O})):q});Ur.displayName="Link";var n1=pe.forwardRef(function({"aria-current":e="page",caseSensitive:i=!1,className:s="",end:l=!1,style:c,to:h,viewTransition:d,children:p,...m},g){let x=Qo(h,{relative:m.relative}),v=Za(),M=pe.useContext(Qc),{navigator:E,basename:A}=pe.useContext(Ci),y=M!=null&&u1(x)&&d===!0,_=E.encodeLocation?E.encodeLocation(x).pathname:x.pathname,O=v.pathname,U=M&&M.navigation&&M.navigation.location?M.navigation.location.pathname:null;i||(O=O.toLowerCase(),U=U?U.toLowerCase():null,_=_.toLowerCase()),U&&A&&(U=sa(U,A)||U);const C=_!=="/"&&_.endsWith("/")?_.length-1:_.length;let H=O===_||!l&&O.startsWith(_)&&O.charAt(C)==="/",k=U!=null&&(U===_||!l&&U.startsWith(_)&&U.charAt(_.length)==="/"),I={isActive:H,isPending:k,isTransitioning:y},q=H?e:void 0,D;typeof s=="function"?D=s(I):D=[s,H?"active":null,k?"pending":null,y?"transitioning":null].filter(Boolean).join(" ");let w=typeof c=="function"?c(I):c;return pe.createElement(Ur,{...m,"aria-current":q,className:D,ref:g,style:w,to:h,viewTransition:d},typeof p=="function"?p(I):p)});n1.displayName="NavLink";var i1=pe.forwardRef(({discover:r="render",fetcherKey:e,navigate:i,reloadDocument:s,replace:l,state:c,method:h=Bc,action:d,onSubmit:p,relative:m,preventScrollReset:g,viewTransition:x,...v},M)=>{let E=l1(),A=c1(d,{relative:m}),y=h.toLowerCase()==="get"?"get":"post",_=typeof d=="string"&&K_.test(d),O=U=>{if(p&&p(U),U.defaultPrevented)return;U.preventDefault();let C=U.nativeEvent.submitter,H=(C==null?void 0:C.getAttribute("formmethod"))||h;E(C||U.currentTarget,{fetcherKey:e,method:H,navigate:i,replace:l,state:c,relative:m,preventScrollReset:g,viewTransition:x})};return pe.createElement("form",{ref:M,method:y,action:A,onSubmit:s?p:O,...v,"data-discover":!_&&r==="render"?"true":void 0})});i1.displayName="Form";function a1(r){return`${r} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Q_(r){let e=pe.useContext(Ps);return jt(e,a1(r)),e}function r1(r,{target:e,replace:i,state:s,preventScrollReset:l,relative:c,viewTransition:h}={}){let d=mS(),p=Za(),m=Qo(r,{relative:c});return pe.useCallback(g=>{if(BS(g,e)){g.preventDefault();let x=i!==void 0?i:Xo(p)===Xo(m);d(r,{replace:x,state:s,preventScrollReset:l,relative:c,viewTransition:h})}},[p,d,m,i,s,e,r,l,c,h])}var s1=0,o1=()=>`__${String(++s1)}__`;function l1(){let{router:r}=Q_("useSubmit"),{basename:e}=pe.useContext(Ci),i=AS();return pe.useCallback(async(s,l={})=>{let{action:c,method:h,encType:d,formData:p,body:m}=FS(s,e);if(l.navigate===!1){let g=l.fetcherKey||o1();await r.fetch(g,i,l.action||c,{preventScrollReset:l.preventScrollReset,formData:p,body:m,formMethod:l.method||h,formEncType:l.encType||d,flushSync:l.flushSync})}else await r.navigate(l.action||c,{preventScrollReset:l.preventScrollReset,formData:p,body:m,formMethod:l.method||h,formEncType:l.encType||d,replace:l.replace,state:l.state,fromRouteId:i,flushSync:l.flushSync,viewTransition:l.viewTransition})},[r,e,i])}function c1(r,{relative:e}={}){let{basename:i}=pe.useContext(Ci),s=pe.useContext(ca);jt(s,"useFormAction must be used inside a RouteContext");let[l]=s.matches.slice(-1),c={...Qo(r||".",{relative:e})},h=Za();if(r==null){c.search=h.search;let d=new URLSearchParams(c.search),p=d.getAll("index");if(p.some(g=>g==="")){d.delete("index"),p.filter(x=>x).forEach(x=>d.append("index",x));let g=d.toString();c.search=g?`?${g}`:""}}return(!r||r===".")&&l.route.index&&(c.search=c.search?c.search.replace(/^\?/,"?index&"):"?index"),i!=="/"&&(c.pathname=c.pathname==="/"?i:aa([i,c.pathname])),Xo(c)}function u1(r,e={}){let i=pe.useContext(V_);jt(i!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:s}=Q_("useViewTransitionState"),l=Qo(r,{relative:e.relative});if(!i.isTransitioning)return!1;let c=sa(i.currentLocation.pathname,s)||i.currentLocation.pathname,h=sa(i.nextLocation.pathname,s)||i.nextLocation.pathname;return qc(l.pathname,h)!=null||qc(l.pathname,c)!=null}new TextEncoder;[...jS];const f1=()=>z.jsxs(z.Fragment,{children:[z.jsx("style",{children:`
        ...
        `}),z.jsxs("div",{id:"about_me_txt",className:"w-[80%] ml-10 mb-10 text-white",children:[z.jsxs("p",{children:["I’m an artist and engineering student based in Los Angeles. I grew up in Kentucky and earned my BFA from the School of the Art Institute of Chicago before moving to LA in 2017. My goal was to study alongside great acting teachers and I did that twice weekly, for four years. (Performance and emotion are ",z.jsx("span",{style:{fontStyle:"italic"},children:"other"})," fascinations of mine) "]}),z.jsx("p",{children:`My paintings explore the tension between painting as image and painting as object, where flatness meets surface. Something about the line in between object and image draws me into experimenting with what I consider to be "wrong-ness" in the work. I’m drawn to that moment when something feels just slightly off, when a move on a painting initially strikes me with revolting inadequacy—I'll often stop there.`}),z.jsx("p",{children:"Alongside my art practice, my studies as an engineering student have a focus on product design, app interfaces, and data analysis. I’m interested in how systems break down and reassemble—whether in a canvas or a codebase. My work moves between those worlds, and they feed each other in unexpected ways."}),z.jsx("p",{children:"As an artist, I like breaking things. As an engineer, creating things."})]})]}),Cs="Cal Sans",Go="Oswald",Xa="Arial, sans",h1=1e3,jc="Jay H. Crawford",Ic="65",ko="opacity-65 font-bold text-white",d1=r=>z.jsxs(z.Fragment,{children:["      ",r.url==""&&z.jsx("div",{id:"this_one",className:"h-30 w-30 absolute",children:z.jsx("img",{src:"./under_construction.svg"})}),z.jsx("div",{style:{boxShadow:"5px 5px 5px rgba(0, 0, 0, 1)"},className:"gridPhoto_Image_container w-80 h-60",children:z.jsx("img",{className:"rounded-lg w-80 h-60",style:{objectFit:"cover"},src:r.img})})]}),p1=r=>{const[e,i]=pe.useState(!1);return z.jsx("div",{onMouseEnter:()=>i(!0),onMouseLeave:()=>i(!1),children:z.jsx(Ur,{id:"",to:r.url?r.url:"",children:z.jsx("div",{className:"gridPhoto_container p-1 m-2 flex justify-center",children:z.jsxs("div",{className:`gridPhoto_item_container m-2 inline ${r.url==""&&"cursor-not-allowed"}`,children:[z.jsx("style",{children:`
              ...
              `}),z.jsx("div",{className:"relative",children:z.jsxs("div",{className:" h-full w-full relative z-100",children:[z.jsx("div",{className:`${r.url==""&&e?"absolute":"hidden"} w-full absolute text-white font-black bg-red-600 top-[120px] p-4 text-center`,children:"Under Construction"}),z.jsx(d1,{img:r.img,url:r.url})]})}),z.jsx("div",{children:z.jsx("h4",{style:{fontFamily:Cs},className:"text-2xl text-white p-4 abt_gridPhotoItem",children:r.title})})]})})})})},m1=r=>{const e=()=>r.width<2e3?"w-full":"w-[60%]",i=()=>r.width<750?"grid-cols-1":"grid-cols-2";return z.jsx("div",{id:"grid_container",className:`grid ${e()} ${i()}`,children:r.categories.map((s,l)=>z.jsx("span",{children:z.jsx(p1,{title:s.category,img:s.img,url:s.url?s.url:""})},`${l}-${s.category}`))})},g1=r=>z.jsx(m1,{width:r.width,categories:r.category_array}),_1="https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/painting/",Wh=["KP.webp","G.webp","alien_invasion.webp","alley.webp","bad_painting.webp","bada_bing.webp","behind.webp","blinker.webp","blue_girl_1.webp","blue_girl_2.webp","bouquet.webp","bright_lights_big_city.webp","business_card.webp","california_onlookers.webp","connection.webp","dips.webp","eyes.webp","following.webp","funny_mustache_guy.webp","hilltop_city.webp","hollywood_hills.webp","house.webp","in_the_city.webp","jacks.webp","jacks_2.webp","james.webp","locked_away.webp","network.webp","night.webp","one_way.webp","online.webp","outlooker.webp","perspective.webp","pictures_of_then.webp","portrait_copy.webp","rainy_sun.webp","researchers.webp","street_corner.webp","sunday.webp","time.webp","tornado.webp","transfer.webp","victorian.webp","what_do_you.webp","woah_dude.webp","worm.webp","x.webp"],F0=r=>r&&r.endsWith(".webp")?r.slice(0,-5):"",H0=r=>{const e=()=>r.current>=Ln.length-5?Ln.slice(Ln.length-5,Ln.length):Ln.slice(r.current+1,r.current+6);return z.jsx("div",{className:"gallery_subImages",children:e().map(i=>z.jsxs("button",{className:"mini_gallery_image",onClick:()=>r.setCurrent(r.images_array.indexOf(i.title?i.title:"")),children:[z.jsx("style",{children:`
            ...
            `}),z.jsx("img",{src:i.src,alt:i.alt,title:i.title,className:"inline max-w-25 max-h-25 m-1 rounded-sm",loading:"lazy"},i.src)]}))})},Ln=Wh.map(r=>({src:`${_1}${r}`,alt:r,title:r})),J_="rgba(255,255,255,0.2)",v1={border:`3px solid ${J_}`,cursor:"not-allowed"},dc=r=>{const e=r.direction==="left"&&r.current===0||r.direction==="right"&&r.current===Ln.length-1;console.log(r.current,r.direction);const i=()=>{switch(r.graphic){case"caret-right":return z.jsx("div",{className:"h-10 w-10",children:z.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 320 512",children:z.jsx("path",{d:"M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"})})});case"caret-left":return z.jsx("div",{className:"h-10 w-10",children:z.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 320 512",children:z.jsx("path",{d:"M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l192 192c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L77.3 256 246.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192z"})})});case"arrow-right":return z.jsx("div",{className:" h-8 w-8",children:z.jsx("svg",{className:"",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 448 512",children:z.jsx("path",{d:"M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"})})});case"arrow-left":return z.jsx("div",{className:" h-8 w-8",children:z.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 448 512",children:z.jsx("path",{d:"M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.2 288 416 288c17.7 0 32-14.3 32-32s-14.3-32-32-32l-306.7 0L214.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z"})})})}};return z.jsxs("button",{style:{...(r.graphic=="arrow-left"||r.graphic=="arrow-right")&&e?v1:{}},className:`inline-block ${r.graphic=="caret-left"||r.graphic=="caret-right"?"LR_bttn":"border-3 border-white LR_bttn"} cursor-pointer p-1 h-20 w-20 bg-none rounded-[50%]`,onClick:r.onclick_func,disabled:e,"aria-label":r.direction==="right"?"Next painting":"Previous painting",type:"button",children:[z.jsx("style",{children:`
        .LR_bttn:hover {
...
void main() {
	...
	`}function FT(r){let e=new WeakMap,i=null;function s(d){if(d&&d.isTexture){const p=d.mapping,m=p===td||p===nd,g=p===Us||p===Ls;if(m||g){let x=e.get(d);const v=x!==void 0?x.texture.pmremVersion:0;if(d.isRenderTargetTexture&&d.pmremVersion!==v)return i===null&&(i=new m_(r)),x=m?i.fromEquirectangular(d,x):i.fromCubemap(d,x),x.texture.pmremVersion=d.pmremVersion,e.set(d,x),x.texture;if(x!==void 0)return x.texture;{const M=d.image;return m&&M&&M.height>0||g&&M&&l(M)?(i===null&&(i=new m_(r)),x=m?i.fromEquirectangular(d):i.fromCubemap(d),x.texture.pmremVersion=d.pmremVersion,e.set(d,x),d.addEventListener("dispose",c),x.texture):null}}}return d}function l(d){let p=0;const m=6;for(let g=0;g<m;g++)d[g]!==void 0&&p++;return p===m}function c(d){const p=d.target;p.removeEventListener("dispose",c);const m=e.get(p);m!==void 0&&(e.delete(p),m.dispose())}function h(){e=new WeakMap,i!==null&&(i.dispose(),i=null)}return{get:s,dispose:h}}function HT(r){const e={};function i(s){if(e[s]!==void 0)return e[s];let l;switch(s){case"WEBGL_depth_texture":l=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":l=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":l=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":l=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:l=r.getExtension(s)}return e[s]=l,l}return{has:function(s){return i(s)!==null},init:function(){i("EXT_color_buffer_float"),i("WEBGL_clip_cull_distance"),i("OES_texture_float_linear"),i("EXT_color_buffer_half_float"),i("WEBGL_multisampled_render_to_texture"),i("WEBGL_render_shared_exponent")},get:function(s){const l=i(s);return l===null&&Xc("THREE.WebGLRenderer: "+s+" extension not supported."),l}}}function GT(r,e,i,s){const l={},c=new WeakMap;function h(x){const v=x.target;v.index!==null&&e.remove(v.index);for(const E in v.attributes)e.remove(v.attributes[E]);v.removeEventListener("dispose",h),delete l[v.id];const M=c.get(v);M&&(e.remove(M),c.delete(v)),s.releaseStatesOfGeometry(v),v.isInstancedBufferGeometry===!0&&delete v._maxInstanceCount,i.memory.geometries--}function d(x,v){return l[v.id]===!0||(v.addEventListener("dispose",h),l[v.id]=!0,i.memory.geometries++),v}function p(x){const v=x.attributes;for(const M in v)e.update(v[M],r.ARRAY_BUFFER)}function m(x){const v=[],M=x.index,E=x.attributes.position;let A=0;if(M!==null){const O=M.array;A=M.version;for(let U=0,C=O.length;U<C;U+=3){const H=O[U+0],k=O[U+1],I=O[U+2];v.push(H,k,k,I,I,H)}}else if(E!==void 0){const O=E.array;A=E.version;for(let U=0,C=O.length/3-1;U<C;U+=3){const H=U+0,k=U+1,I=U+2;v.push(H,k,k,I,I,H)}}else return;const y=new(fv(v)?gv:mv)(v,1);y.version=A;const _=c.get(x);_&&e.remove(_),c.set(x,y)}function g(x){const v=c.get(x);if(v){const M=x.index;M!==null&&v.version<M.version&&m(x)}else m(x);return c.get(x)}return{get:d,update:p,getWireframeAttribute:g}}function VT(r,e,i){let s;function l(v){s=v}let c,h;function d(v){c=v.type,h=v.bytesPerElement}function p(v,M){r.drawElements(s,M,c,v*h),i.update(M,s,1)}function m(v,M,E){E!==0&&(r.drawElementsInstanced(s,M,c,v*h,E),i.update(M,s,E))}function g(v,M,E){if(E===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(s,M,0,c,v,0,E);let y=0;for(let _=0;_<E;_++)y+=M[_];i.update(y,s,1)}function x(v,M,E,A){if(E===0)return;const y=e.get("WEBGL_multi_draw");if(y===null)for(let _=0;_<v.length;_++)m(v[_]/h,M[_],A[_]);else{y.multiDrawElementsInstancedWEBGL(s,M,0,c,v,0,A,0,E);let _=0;for(let O=0;O<E;O++)_+=M[O]*A[O];i.update(_,s,1)}}this.setMode=l,this.setIndex=d,this.render=p,this.renderInstances=m,this.renderMultiDraw=g,this.renderMultiDrawInstances=x}function kT(r){const e={geometries:0,textures:0},i={frame:0,calls:0,triangles:0,points:0,lines:0};function s(c,h,d){switch(i.calls++,h){case r.TRIANGLES:i.triangles+=d*(c/3);break;case r.LINES:i.lines+=d*(c/2);break;case r.LINE_STRIP:i.lines+=d*(c-1);break;case r.LINE_LOOP:i.lines+=d*c;break;case r.POINTS:i.points+=d*c;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",h);break}}function l(){i.calls=0,i.triangles=0,i.points=0,i.lines=0}return{memory:e,render:i,programs:null,autoReset:!0,reset:l,update:s}}function XT(r,e,i){const s=new WeakMap,l=new $t;function c(h,d,p){const m=h.morphTargetInfluences,g=d.morphAttributes.position||d.morphAttributes.normal||d.morphAttributes.color,x=g!==void 0?g.length:0;let v=s.get(d);if(v===void 0||v.count!==x){let w=function(){q.dispose(),s.delete(d),d.removeEventListener("dispose",w)};var M=w;v!==void 0&&v.texture.dispose();const E=d.morphAttributes.position!==void 0,A=d.morphAttributes.normal!==void 0,y=d.morphAttributes.color!==void 0,_=d.morphAttributes.position||[],O=d.morphAttributes.normal||[],U=d.morphAttributes.color||[];let C=0;E===!0&&(C=1),A===!0&&(C=2),y===!0&&(C=3);let H=d.attributes.position.count*C,k=1;H>e.maxTextureSize&&(k=Math.ceil(H/e.maxTextureSize),H=e.maxTextureSize);const I=new Float32Array(H*k*4*x),q=new hv(I,H,k,x);q.type=na,q.needsUpdate=!0;const D=C*4;for(let V=0;V<x;V++){const ce=_[V],oe=O[V],xe=U[V],de=H*k*4*V;for(let B=0;B<ce.count;B++){const K=B*D;E===!0&&(l.fromBufferAttribute(ce,B),I[de+K+0]=l.x,I[de+K+1]=l.y,I[de+K+2]=l.z,I[de+K+3]=0),A===!0&&(l.fromBufferAttribute(oe,B),I[de+K+4]=l.x,I[de+K+5]=l.y,I[de+K+6]=l.z,I[de+K+7]=0),y===!0&&(l.fromBufferAttribute(xe,B),I[de+K+8]=l.x,I[de+K+9]=l.y,I[de+K+10]=l.z,I[de+K+11]=xe.itemSize===4?l.w:1)}}v={count:x,texture:q,size:new Ft(H,k)},s.set(d,v),d.addEventListener("dispose",w)}if(h.isInstancedMesh===!0&&h.morphTexture!==null)p.getUniforms().setValue(r,"morphTexture",h.morphTexture,i);else{let E=0;for(let y=0;y<m.length;y++)E+=m[y];const A=d.morphTargetsRelative?1:1-E;p.getUniforms().setValue(r,"morphTargetBaseInfluence",A),p.getUniforms().setValue(r,"morphTargetInfluences",m)}p.getUniforms().setValue(r,"morphTargetsTexture",v.texture,i),p.getUniforms().setValue(r,"morphTargetsTextureSize",v.size)}return{update:c}}function WT(r,e,i,s){let l=new WeakMap;function c(p){const m=s.render.frame,g=p.geometry,x=e.get(p,g);if(l.get(x)!==m&&(e.update(x),l.set(x,m)),p.isInstancedMesh&&(p.hasEventListener("dispose",d)===!1&&p.addEventListener("dispose",d),l.get(p)!==m&&(i.update(p.instanceMatrix,r.ARRAY_BUFFER),p.instanceColor!==null&&i.update(p.instanceColor,r.ARRAY_BUFFER),l.set(p,m))),p.isSkinnedMesh){const v=p.skeleton;l.get(v)!==m&&(v.update(),l.set(v,m))}return x}function h(){l=new WeakMap}function d(p){const m=p.target;m.removeEventListener("dispose",d),i.remove(m.instanceMatrix),m.instanceColor!==null&&i.remove(m.instanceColor)}return{update:c,dispose:h}}const Ev=new Gn,x_=new Sv(1,1),bv=new hv,Tv=new SM,Av=new xv,y_=[],S_=[],M_=new Float32Array(16),E_=new Float32Array(9),b_=new Float32Array(4);function Is(r,e,i){const s=r[0];if(s<=0||s>0)return r;const l=e*i;let c=y_[l];if(c===void 0&&(c=new Float32Array(l),y_[l]=c),e!==0){s.toArray(c,0);for(let h=1,d=0;h!==e;++h)d+=i,r[h].toArray(c,d)}return c}function fn(r,e){if(r.length!==e.length)return!1;for(let i=0,s=r.length;i<s;i++)if(r[i]!==e[i])return!1;return!0}function hn(r,e){for(let i=0,s=e.length;i<s;i++)r[i]=e[i]}function nu(r,e){let i=S_[e];i===void 0&&(i=new Int32Array(e),S_[e]=i);for(let s=0;s!==e;++s)i[s]=r.allocateTextureUnit();return i}function qT(r,e){const i=this.cache;i[0]!==e&&(r.uniform1f(this.addr,e),i[0]=e)}function jT(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2f(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(fn(i,e))return;r.uniform2fv(this.addr,e),hn(i,e)}}function YT(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3f(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else if(e.r!==void 0)(i[0]!==e.r||i[1]!==e.g||i[2]!==e.b)&&(r.uniform3f(this.addr,e.r,e.g,e.b),i[0]=e.r,i[1]=e.g,i[2]=e.b);else{if(fn(i,e))return;r.uniform3fv(this.addr,e),hn(i,e)}}function ZT(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4f(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(fn(i,e))return;r.uniform4fv(this.addr,e),hn(i,e)}}function KT(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(fn(i,e))return;r.uniformMatrix2fv(this.addr,!1,e),hn(i,e)}else{if(fn(i,s))return;b_.set(s),r.uniformMatrix2fv(this.addr,!1,b_),hn(i,s)}}function QT(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(fn(i,e))return;r.uniformMatrix3fv(this.addr,!1,e),hn(i,e)}else{if(fn(i,s))return;E_.set(s),r.uniformMatrix3fv(this.addr,!1,E_),hn(i,s)}}function JT(r,e){const i=this.cache,s=e.elements;if(s===void 0){if(fn(i,e))return;r.uniformMatrix4fv(this.addr,!1,e),hn(i,e)}else{if(fn(i,s))return;M_.set(s),r.uniformMatrix4fv(this.addr,!1,M_),hn(i,s)}}function $T(r,e){const i=this.cache;i[0]!==e&&(r.uniform1i(this.addr,e),i[0]=e)}function e2(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2i(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(fn(i,e))return;r.uniform2iv(this.addr,e),hn(i,e)}}function t2(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3i(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(fn(i,e))return;r.uniform3iv(this.addr,e),hn(i,e)}}function n2(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4i(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(fn(i,e))return;r.uniform4iv(this.addr,e),hn(i,e)}}function i2(r,e){const i=this.cache;i[0]!==e&&(r.uniform1ui(this.addr,e),i[0]=e)}function a2(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y)&&(r.uniform2ui(this.addr,e.x,e.y),i[0]=e.x,i[1]=e.y);else{if(fn(i,e))return;r.uniform2uiv(this.addr,e),hn(i,e)}}function r2(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z)&&(r.uniform3ui(this.addr,e.x,e.y,e.z),i[0]=e.x,i[1]=e.y,i[2]=e.z);else{if(fn(i,e))return;r.uniform3uiv(this.addr,e),hn(i,e)}}function s2(r,e){const i=this.cache;if(e.x!==void 0)(i[0]!==e.x||i[1]!==e.y||i[2]!==e.z||i[3]!==e.w)&&(r.uniform4ui(this.addr,e.x,e.y,e.z,e.w),i[0]=e.x,i[1]=e.y,i[2]=e.z,i[3]=e.w);else{if(fn(i,e))return;r.uniform4uiv(this.addr,e),hn(i,e)}}function o2(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l);let c;this.type===r.SAMPLER_2D_SHADOW?(x_.compareFunction=uv,c=x_):c=Ev,i.setTexture2D(e||c,l)}function l2(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture3D(e||Tv,l)}function c2(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTextureCube(e||Av,l)}function u2(r,e,i){const s=this.cache,l=i.allocateTextureUnit();s[0]!==l&&(r.uniform1i(this.addr,l),s[0]=l),i.setTexture2DArray(e||bv,l)}function f2(r){switch(r){case 5126:return qT;case 35664:return jT;case 35665:return YT;case 35666:return ZT;case 35674:return KT;case 35675:return QT;case 35676:return JT;case 5124:case 35670:return $T;case 35667:case 35671:return e2;case 35668:case 35672:return t2;case 35669:case 35673:return n2;case 5125:return i2;case 36294:return a2;case 36295:return r2;case 36296:return s2;case 35678:case 36198:case 36298:case 36306:case 35682:return o2;case 35679:case 36299:case 36307:return l2;case 35680:case 36300:case 36308:case 36293:return c2;case 36289:case 36303:case 36311:case 36292:return u2}}function h2(r,e){r.uniform1fv(this.addr,e)}function d2(r,e){const i=Is(e,this.size,2);r.uniform2fv(this.addr,i)}function p2(r,e){const i=Is(e,this.size,3);r.uniform3fv(this.addr,i)}function m2(r,e){const i=Is(e,this.size,4);r.uniform4fv(this.addr,i)}function g2(r,e){const i=Is(e,this.size,4);r.uniformMatrix2fv(this.addr,!1,i)}function _2(r,e){const i=Is(e,this.size,9);r.uniformMatrix3fv(this.addr,!1,i)}function v2(r,e){const i=Is(e,this.size,16);r.uniformMatrix4fv(this.addr,!1,i)}function x2(r,e){r.uniform1iv(this.addr,e)}function y2(r,e){r.uniform2iv(this.addr,e)}function S2(r,e){r.uniform3iv(this.addr,e)}function M2(r,e){r.uniform4iv(this.addr,e)}function E2(r,e){r.uniform1uiv(this.addr,e)}function b2(r,e){r.uniform2uiv(this.addr,e)}function T2(r,e){r.uniform3uiv(this.addr,e)}function A2(r,e){r.uniform4uiv(this.addr,e)}function R2(r,e,i){const s=this.cache,l=e.length,c=nu(i,l);fn(s,c)||(r.uniform1iv(this.addr,c),hn(s,c));for(let h=0;h!==l;++h)i.setTexture2D(e[h]||Ev,c[h])}function w2(r,e,i){const s=this.cache,l=e.length,c=nu(i,l);fn(s,c)||(r.uniform1iv(this.addr,c),hn(s,c));for(let h=0;h!==l;++h)i.setTexture3D(e[h]||Tv,c[h])}function C2(r,e,i){const s=this.cache,l=e.length,c=nu(i,l);fn(s,c)||(r.uniform1iv(this.addr,c),hn(s,c));for(let h=0;h!==l;++h)i.setTextureCube(e[h]||Av,c[h])}function D2(r,e,i){const s=this.cache,l=e.length,c=nu(i,l);fn(s,c)||(r.uniform1iv(this.addr,c),hn(s,c));for(let h=0;h!==l;++h)i.setTexture2DArray(e[h]||bv,c[h])}function U2(r){switch(r){case 5126:return h2;case 35664:return d2;case 35665:return p2;case 35666:return m2;case 35674:return g2;case 35675:return _2;case 35676:return v2;case 5124:case 35670:return x2;case 35667:case 35671:return y2;case 35668:case 35672:return S2;case 35669:case 35673:return M2;case 5125:return E2;case 36294:return b2;case 36295:return T2;case 36296:return A2;case 35678:case 36198:case 36298:case 36306:case 35682:return R2;case 35679:case 36299:case 36307:return w2;case 35680:case 36300:case 36308:case 36293:return C2;case 36289:case 36303:case 36311:case 36292:return D2}}class L2{constructor(e,i,s){this.id=e,this.addr=s,this.cache=[],this.type=i.type,this.setValue=f2(i.type)}}class N2{constructor(e,i,s){this.id=e,this.addr=s,this.cache=[],this.type=i.type,this.size=i.size,this.setValue=U2(i.type)}}class O2{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,i,s){const l=this.seq;for(let c=0,h=l.length;c!==h;++c){const d=l[c];d.setValue(e,i[d.id],s)}}}const Vh=/(\w+)(\])?(\[|\.)?/g;function T_(r,e){r.seq.push(e),r.map[e.id]=e}function P2(r,e,i){const s=r.name,l=s.length;for(Vh.lastIndex=0;;){const c=Vh.exec(s),h=Vh.lastIndex;let d=c[1];const p=c[2]==="]",m=c[3];if(p&&(d=d|0),m===void 0||m==="["&&h+2===l){T_(i,m===void 0?new L2(d,r,e):new N2(d,r,e));break}else{let x=i.map[d];x===void 0&&(x=new O2(d),T_(i,x)),i=x}}}class Wc{constructor(e,i){this.seq=[],this.map={};const s=e.getProgramParameter(i,e.ACTIVE_UNIFORMS);for(let l=0;l<s;++l){const c=e.getActiveUniform(i,l),h=e.getUniformLocation(i,c.name);P2(c,h,this)}}setValue(e,i,s,l){const c=this.map[i];c!==void 0&&c.setValue(e,s,l)}setOptional(e,i,s){const l=i[s];l!==void 0&&this.setValue(e,s,l)}static upload(e,i,s,l){for(let c=0,h=i.length;c!==h;++c){const d=i[c],p=s[d.id];p.needsUpdate!==!1&&d.setValue(e,p.value,l)}}static seqWithValue(e,i){const s=[];for(let l=0,c=e.length;l!==c;++l){const h=e[l];h.id in i&&s.push(h)}return s}}function A_(r,e,i){const s=r.createShader(e);return r.shaderSource(s,i),r.compileShader(s),s}const B2=37297;let z2=0;function I2(r,e){const i=r.split(`
`),s=[],l=Math.max(e-6,0),c=Math.min(e+6,i.length);for(let h=l;h<c;h++){const d=h+1;s.push(`${d===e?">":" "} ${d}: ${i[h]}`)}return s.join(`
`)}const R_=new st;function F2(r){Tt._getMatrix(R_,Tt.workingColorSpace,r);const e=`mat3( ${R_.elements.map(i=>i.toFixed(4))} )`;switch(Tt.getTransfer(r)){case Yc:return[e,"LinearTransferOETF"];case Ot:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",r),[e,"LinearTransferOETF"]}}function w_(r,e,i){const s=r.getShaderParameter(e,r.COMPILE_STATUS),l=r.getShaderInfoLog(e).trim();if(s&&l==="")return"";const c=/ERROR: 0:(\d+)/.exec(l);if(c){const h=parseInt(c[1]);return i.toUpperCase()+`

`+l+`

`+I2(r.getShaderSource(e),h)}else return l}function H2(r,e){const i=F2(e);return[`vec4 ${r}( vec4 value ) {`,`	return ${i[1]}( vec4( value.rgb * ${i[0]}, value.a ) );`,"}"].join(`
`)}function G2(r,e){let i;switch(e){case q1:i="Linear";break;case j1:i="Reinhard";break;case Y1:i="Cineon";break;case Z1:i="ACESFilmic";break;case Q1:i="AgX";break;case J1:i="Neutral";break;case K1:i="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),i="Linear"}return"vec3 "+r+"( vec3 color ) { return "+i+"ToneMapping( color ); }"}const Pc=new se;function V2(){Tt.getLuminanceCoefficients(Pc);const r=Pc.x.toFixed(4),e=Pc.y.toFixed(4),i=Pc.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${e}, ${i} );`,"	return dot( weights, rgb );","}"].join(`
`)}function k2(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Vo).join(`
`)}function X2(r){const e=[];for(const i in r){const s=r[i];s!==!1&&e.push("#define "+i+" "+s)}return e.join(`
`)}function W2(r,e){const i={},s=r.getProgramParameter(e,r.ACTIVE_ATTRIBUTES);for(let l=0;l<s;l++){const c=r.getActiveAttrib(e,l),h=c.name;let d=1;c.type===r.FLOAT_MAT2&&(d=2),c.type===r.FLOAT_MAT3&&(d=3),c.type===r.FLOAT_MAT4&&(d=4),i[h]={type:c.type,location:r.getAttribLocation(e,h),locationSize:d}}return i}function Vo(r){return r!==""}function C_(r,e){const i=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,i).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function D_(r,e){return r.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const q2=/^[ \t]*#include +<([\w\d./]+)>/gm;function Ld(r){return r.replace(q2,Y2)}const j2=new Map;function Y2(r,e){let i=lt[e];if(i===void 0){const s=j2.get(e);if(s!==void 0)i=lt[s],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,s);else throw new Error("Can not resolve #include <"+e+">")}return Ld(i)}const Z2=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function U_(r){return r.replace(Z2,K2)}function K2(r,e,i,s){let l="";for(let c=parseInt(e);c<parseInt(i);c++)l+=s.replace(/\[\s*i\s*\]/g,"[ "+c+" ]").replace(/UNROLLED_LOOP_INDEX/g,c);return l}function L_(r){let e=`precision ${r.precision} float;
...
#define LOW_PRECISION`),e}function Q2(r){let e="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===$_?e="SHADOWMAP_TYPE_PCF":r.shadowMapType===T1?e="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===ea&&(e="SHADOWMAP_TYPE_VSM"),e}function J2(r){let e="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Us:case Ls:e="ENVMAP_TYPE_CUBE";break;case $c:e="ENVMAP_TYPE_CUBE_UV";break}return e}function $2(r){let e="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Ls:e="ENVMAP_MODE_REFRACTION";break}return e}function eA(r){let e="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case ev:e="ENVMAP_BLENDING_MULTIPLY";break;case X1:e="ENVMAP_BLENDING_MIX";break;case W1:e="ENVMAP_BLENDING_ADD";break}return e}function tA(r){const e=r.envMapCubeUVHeight;if(e===null)return null;const i=Math.log2(e)-2,s=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,i),7*16)),texelHeight:s,maxMip:i}}function nA(r,e,i,s){const l=r.getContext(),c=i.defines;let h=i.vertexShader,d=i.fragmentShader;const p=Q2(i),m=J2(i),g=$2(i),x=eA(i),v=tA(i),M=k2(i),E=X2(c),A=l.createProgram();let y,_,O=i.glslVersion?"#version "+i.glslVersion+`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            opacity: 100%;
            }`}),z.jsx("ul",{className:"footer_links text-md text-left",children:z.jsx("li",{children:z.jsxs("a",{href:"mailto:jayhcrawford@gmail.com",children:[z.jsx("p",{className:"font-bold",children:jc}),z.jsxs("span",{className:"font-normal",style:{fontFamily:Xa},children:[z.jsx("p",{children:"Los Angeles, CA"}),z.jsx("p",{children:"jayhcrawford@gmail.com"})]})]})})})]}),z.jsxs("div",{className:"grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2 text-left",children:[z.jsxs("div",{children:[z.jsx("h2",{className:"text-sm font-bold uppercase",children:"Social"}),z.jsxs("ul",{id:"footer_social",style:{fontFamily:Xa},className:"footer_links font-medium mt-3 mb-10",children:[z.jsx("style",{children:`
                      #footer_social li {
                        
                      }
                    `}),z.jsx("li",{children:z.jsx("a",{href:UA,target:"new",className:"hover:underline",children:"LinkedIn"})}),z.jsx("li",{className:"",children:z.jsx("a",{href:Rv,target:"new",className:"hover:underline",children:"Instagram"})}),z.jsx("li",{children:z.jsx("a",{href:wv,target:"new",className:"hover:underline",children:"TikTok"})}),z.jsx("li",{children:z.jsx("a",{href:Nd,target:"new",className:"hover:underline",children:"Github"})})]})]}),z.jsx("div",{})]})]}),z.jsxs("div",{className:"sm:flex sm:items-center sm:justify-between",children:[z.jsxs("span",{style:{fontFamily:Xa},className:`font-normal text-sm text-white opacity-${Ic} sm:text-center`,children:[e," - ",jc]}),z.jsx("div",{className:"flex mt-4 sm:justify-center sm:mt-0",children:z.jsxs("a",{href:Nd,target:"new",className:`opacity-${Ic} hover:opacity-100 hover:white ms-5`,children:[z.jsx("svg",{className:"w-4 h-4","aria-hidden":"true",xmlns:"http://www.w3.org/2000/svg",fill:"currentColor",viewBox:"0 0 20 20",children:z.jsx("path",{fillRule:"evenodd",d:"M10 .333A9.911 9.911 0 0 0 6.866 19.65c.5.092.678-.215.678-.477 0-.237-.01-1.017-.014-1.845-2.757.6-3.338-1.169-3.338-1.169a2.627 2.627 0 0 0-1.1-1.451c-.9-.615.07-.6.07-.6a2.084 2.084 0 0 1 1.518 1.021 2.11 2.11 0 0 0 2.884.823c.044-.503.268-.973.63-1.325-2.2-.25-4.516-1.1-4.516-4.9A3.832 3.832 0 0 1 4.7 7.068a3.56 3.56 0 0 1 .095-2.623s.832-.266 2.726 1.016a9.409 9.409 0 0 1 4.962 0c1.89-1.282 2.717-1.016 2.717-1.016.366.83.402 1.768.1 2.623a3.827 3.827 0 0 1 1.02 2.659c0 3.807-2.319 4.644-4.525 4.889a2.366 2.366 0 0 1 .673 1.834c0 1.326-.012 2.394-.012 2.72 0 .263.18.572.681.475A9.911 9.911 0 0 0 10 .333Z",clipRule:"evenodd"})}),z.jsx("span",{className:"sr-only",children:"GitHub account"})]})})]})]})})},NA=()=>z.jsx("img",{className:"w-30 ",src:"./LinkedIn_Logo.svg"}),OA=r=>z.jsx("div",{className:"social_brick_icon_container",style:{width:"150px"},children:z.jsxs("svg",{id:"Layer_1","data-name":"Layer 1",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 40 40",className:"social-svg",children:[z.jsx("defs",{children:z.jsx("style",{children:`
                    .social-svg {
                        fill: white;
                    ...
                    `}),r.map((e,i)=>z.jsx("a",{"aria-label":`Our ${e.name}`,href:e.url,target:"_blank",className:"glow-button socialbrick-link",children:z.jsx(OA,{name:e.name})},i))]})})};function BA(r){return r?r.toLowerCase().split(" ").map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(" "):""}const bs=()=>z.jsx("span",{className:`${ko} ml-5 mr-5`,children:"|"}),Va=r=>z.jsx("li",{style:{transition:"opacity .1s .1s"},className:`${ko} hover:underline hover:opacity-100`,children:z.jsx(Ur,{to:`${r.name}`,children:BA(r.name)})}),zA=r=>r.path=="/"?z.jsxs(z.Fragment,{children:[z.jsx("nav",{className:"z-10 w-ful",children:z.jsxs("ul",{style:{fontFamily:Go},className:"list-none p-0 pb-4 m-0 flex justify-center text-xl sm:text-3xl md:text-5xl",children:[z.jsx(Va,{name:"about"}),z.jsx(bs,{}),z.jsx(Va,{name:"art"}),z.jsx(bs,{}),z.jsx(Va,{name:"projects"}),z.jsx(bs,{}),z.jsx(Va,{name:"contact"})]})}),z.jsxs("header",{style:{marginBottom:"70px"},children:[z.jsx("h1",{className:"text-center text-white",style:{fontFamily:Cs,fontSize:r.width<500?"3rem":"6rem",fontWeight:"bold"},children:jc}),z.jsx("p",{className:`${ko} text-5xl text-center`,style:{fontFamily:Go},children:"Interdisciplinary Creative & Programmer"}),z.jsx("p",{style:{fontFamily:Xa},className:`text-center p-4 ${ko} text-3xl`,children:"Los Angeles, CA"}),z.jsx(PA,{})]})]}):z.jsxs(z.Fragment,{children:[z.jsx("nav",{className:"z-10 w-full mb-5",children:z.jsxs("ul",{style:{fontFamily:Go},className:"list-none p-0 m-0 flex sm:text-2xl md:text-5xl",children:[z.jsx(Va,{name:"about"}),z.jsx(bs,{}),z.jsx(Va,{name:"art"}),z.jsx(bs,{}),z.jsx(Va,{name:"projects"}),z.jsx(bs,{}),z.jsx(Va,{name:"contact"})]})}),z.jsxs("header",{style:{marginBottom:"70px"},children:[z.jsx(Ur,{to:"/",children:z.jsx("h1",{className:"text-white",style:{fontFamily:Cs,fontSize:r.width<500?"1rem":"2rem",fontWeight:"bold"},children:jc})}),z.jsx("p",{className:`${ko} text-3xl text-left`,style:{fontFamily:Go},children:"Interdisciplinary Creative & Programmer"})]})]}),IA=r=>{let e="";return z.jsxs(z.Fragment,{children:[z.jsx("style",{children:`
        #location-bar {
        }
    ...
    `}),z.jsx("div",{id:"location-bar",children:r.split().map((i,s)=>(e+="/"+i,z.jsxs("span",{children:[z.jsx(Ur,{to:e,children:z.jsx("button",{className:"location-bar-bttn",children:i})}),s<r.split().length-1&&z.jsx("span",{className:"location-bar-arrow",children:">"})]},`${s}-location`)))})]})},FA=()=>z.jsxs("svg",{id:"Layer_6","data-name":"Layer 6",xmlns:"http://www.w3.org/2000/svg",xmlnsXlink:"http://www.w3.org/1999/xlink",viewBox:"0 0 1050 990",children:[z.jsx("defs",{children:z.jsx("style",{children:`
      ...
      }`}),z.jsx(Ur,{onMouseEnter:()=>i(!0),onMouseLeave:()=>i(!1),to:r.url?r.url:"",children:z.jsx("div",{className:`${r.url==""?"cursor-not-allowed":"cursor-pointer"} text-white m-6 justify-center ${r.width<750?"flex flex-col":"flex"}`,children:z.jsxs("div",{className:` ${r.width<750?"flex flex-col items-center":"flex w-[70%]"}`,children:[z.jsx("div",{className:"p-1 m-1",children:z.jsx("div",{className:"relative",children:z.jsxs("div",{className:" h-full w-full relative z-100",children:[z.jsx("div",{className:`${r.url==""&&e?"absolute":"hidden"} w-full text-white font-black absolute bg-red-600 top-[120px] p-4 text-center`,children:"Under Construction"}),z.jsx(GA,{img:r.img})]})})}),z.jsxs("div",{className:`ml-10 ${r.width<750?"mt-8 w-full pr-20":"flex flex-col justify-center mb-10"}`,children:[z.jsx("h4",{style:{fontFamily:Cs},className:"text-2xl",children:r.title}),z.jsx("p",{style:{fontFamily:Xa},children:r.about_txt})]})]})})}),z.jsx("hr",{})]})},GA=r=>z.jsxs(z.Fragment,{children:[z.jsx("div",{className:"h-30 w-30 absolute",children:z.jsx("img",{src:"./under_construction.svg"})}),z.jsx("div",{style:{boxShadow:"5px 5px 5px rgba(0, 0, 0, 1)"},className:"w-80 h-60",children:z.jsx("img",{className:"rounded-lg w-80 h-60",style:{objectFit:"cover"},src:r.img})})]}),VA=r=>z.jsxs("div",{style:{fontFamily:Xa},children:[z.jsx("hr",{}),r.blog_array.map((e,i)=>z.jsx(HA,{url:e.url?e.url:"",title:e.title,about_txt:e.about_txt,img:e.img,width:r.width},i))]}),kA=r=>z.jsx(VA,{width:r.width,blog_array:r.blog_array}),XA=[{title:"My Place",img:"https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/web-icons/Web+Hosted/3d-project-icons/orthographic-icon.jpg",about_txt:"Autodesk Maya and Arnold project."},{title:"Door Project",img:"https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/web-icons/Web+Hosted/3d-project-icons/3d-door-project-icon.jpg",about_txt:"Based on a drawing, built in Blender to emulate the drawing."},{title:"3D Me :-)",img:"https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/web-icons/Web+Hosted/3d-project-icons/3d-jay-icon.jpg",about_txt:"Fully rigged, simple 3D character modeled after me. This helped me to better understand topology, weight-painting, and rigging."}],WA=[{category:"3D Projects",img:"https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/web-icons/Web+Hosted/3d-project-icons/orthographic-icon.jpg",url:"3d"},{category:"UrFriends - SASS",img:"https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/web-icons/Web+Hosted/blog-images/UR_Friends.webp"},{category:"The Book",img:"https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/web-icons/Web+Hosted/blog-images/TheBook.webp"},{category:"The RIP Sheet",img:"https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/web-icons/Web+Hosted/blog-images/RIP.webp"},{category:"Widow Bags",img:"https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/web-icons/Web+Hosted/product-design-icons/widow-icon.jpg"}],qA=[{title:"Projects",url:"/projects"},{title:"3D Projects",url:"hi"}],jA=()=>{const{width:r,height:e}=M1(),i=pe.useRef(null),l=Za().pathname;function c(){return l.split("/").filter((h,d)=>d!==0)}return console.log(l,"is curernt"),pe.useEffect(()=>{const h=new GM,d=new li(75,window.innerWidth/window.innerHeight,.1,1e3),p=new DA({alpha:!0});p.setClearColor(0,0),p.setSize(window.innerWidth,window.innerHeight),p.domElement.style.position="absolute",p.domElement.style.top="0",p.domElement.style.left="0",p.domElement.style.zIndex="-1",i.current instanceof HTMLElement&&!i.current.hasChildNodes()&&i.current.appendChild(p.domElement);const m=new zs,g=new Zd({color:65280}),x=new Ri(m,g);h.add(x),d.position.z=5;const v=()=>{x.rotation.x+=.01,x.rotation.y+=.01,p.render(h,d),requestAnimationFrame(v)};return v(),()=>{i.current&&i.current.removeChild(p.domElement)}},[]),console.log(r,"is the width; and the height is: ",e),z.jsx(z.Fragment,{children:z.jsxs("div",{id:"outer_bg",children:[z.jsx("div",{style:{position:"fixed",top:0,left:0,width:`${r}px`,height:`${e}px`,overflow:"hidden"},children:z.jsx(FA,{})}),z.jsxs("div",{className:"pt-20",id:"inner_bg",ref:i,style:{position:"relative",width:"95vw",margin:"auto"},children:[z.jsxs("div",{children:[z.jsx(zA,{width:r,path:l}),c().length>1&&z.jsx(IA,{split:c,locationData:qA})]}),z.jsxs("div",{id:"body_div",children:[z.jsx("main",{children:z.jsxs(US,{children:[z.jsx(Ts,{path:"/about",element:z.jsx(f1,{})}),z.jsx(Ts,{path:"/projects/3d",element:z.jsx(kA,{width:r,blog_array:XA})}),z.jsx(Ts,{path:"/projects",element:z.jsx(g1,{width:r,category_array:WA})}),z.jsx(Ts,{path:"/art",element:z.jsx(y1,{width:r})}),z.jsx(Ts,{path:"/contact",element:z.jsx(S1,{})})]})}),z.jsx(LA,{path:l})]})]}),z.jsx("div",{className:"flex justify-end  fixed top-0 w-full z-100",children:z.jsx("button",{className:"p-3 bg-white",children:z.jsx(NA,{})})})]})})};Hy.createRoot(document.getElementById("root")).render(z.jsx(pe.StrictMode,{children:z.jsx(t1,{children:z.jsx(jA,{})})}));
