 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var R0;function Py(){return R0||(R0=1,function(r){function e(z,K){var Y=z.length;z.push(K);e:for(;0<Y;){var Ee=Y-1>>>1,N=z[Ee];if(0<l(N,K))z[Ee]=K,z[Y]=N,Y=Ee;else break e}}function i(z){return z.length===0?null:z[0]}function s(z){if(z.length===0)return null;var K=z[0],Y=z.pop();if(Y!==K){z[0]=Y;e:for(var Ee=0,N=z.length,ee=N>>>1;Ee<ee;){var ye=2*(Ee+1)-1,Me=z[ye],J=ye+1,me=z[J];if(0>l(Me,Y))J<N&&0>l(me,Me)?(z[Ee]=me,z[J]=Y,Ee=J):(z[Ee]=Me,z[ye]=Y,Ee=ye);else if(J<N&&0>l(me,Y))z[Ee]=me,z[J]=Y,Ee=J;else break e}}return K}function l(z,K){var Y=z.sortIndex-K.sortIndex;return Y!==0?Y:z.id-K.id}if(r.unstable_now=void 0,typeof performance=="object"&&typeof performance.now=="function"){var c=performance;r.unstable_now=function(){return c.now()}}else{var h=Date,d=h.now();r.unstable_now=function(){return h.now()-d}}var p=[],m=[],g=1,x=null,v=3,M=!1,E=!1,A=!1,y=!1,_=typeof setTimeout=="function"?setTimeout:null,O=typeof clearTimeout=="function"?clearTimeout:null,U=typeof setImmediate<"u"?setImmediate:null;function C(z){for(var K=i(m);K!==null;){if(K.callback===null)s(m);else if(K.startTime<=z)s(m),K.sortIndex=K.expirationTime,e(p,K);else break;K=i(m)}}function H(z){if(A=!1,C(z),!E)if(i(p)!==null)E=!0,k||(k=!0,ce());else{var K=i(m);K!==null&&de(H,K.startTime-z)}}var k=!1,I=-1,j=5,D=-1;function w(){return y?!0:!(r.unstable_now()-D<j)}function V(){if(y=!1,k){var z=r.unstable_now();D=z;var K=!0;try{e:{E=!1,A&&(A=!1,O(I),I=-1),M=!0;var Y=v;try{t:{for(C(z),x=i(p);x!==null&&!(x.expirationTime>z&&w());){var Ee=x.callback;if(typeof Ee=="function"){x.callback=null,v=x.priorityLevel;var N=Ee(x.expirationTime<=z);if(z=r.unstable_now(),typeof N=="function"){x.callback=N,C(z),K=!0;break t}x===i(p)&&s(p),C(z)}else s(p);x=i(p)}if(x!==null)K=!0;else{var ee=i(m);ee!==null&&de(H,ee.startTime-z),K=!1}}break e}finally{x=null,v=Y,M=!1}K=void 0}}finally{K?ce():k=!1}}}var ce;if(typeof U=="function")ce=function(){U(V)};else if(typeof MessageChannel<"u"){var oe=new MessageChannel,xe=oe.port2;oe.port1.onmessage=V,ce=function(){xe.postMessage(null)}}else ce=function(){_(V,0)};function de(z,K){I=_(function(){z(r.unstable_now())},K)}r.unstable_IdlePriority=5,r.unstable_ImmediatePriority=1,r.unstable_LowPriority=4,r.unstable_NormalPriority=3,r.unstable_Profiling=null,r.unstable_UserBlockingPriority=2,r.unstable_cancelCallback=function(z){z.callback=null},r.unstable_forceFrameRate=function(z){0>z||125<z?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):j=0<z?Math.floor(1e3/z):5},r.unstable_getCurrentPriorityLevel=function(){return v},r.unstable_next=function(z){switch(v){case 1:case 2:case 3:var K=3;break;default:K=v}var Y=v;v=K;try{return z()}finally{v=Y}},r.unstable_requestPaint=function(){y=!0},r.unstable_runWithPriority=function(z,K){switch(z){case 1:case 2:case 3:case 4:case 5:break;default:z=3}var Y=v;v=z;try{return K()}finally{v=Y}},r.unstable_scheduleCallback=function(z,K,Y){var Ee=r.unstable_now();switch(typeof Y=="object"&&Y!==null?(Y=Y.delay,Y=typeof Y=="number"&&0<Y?Ee+Y:Ee):Y=Ee,z){case 1:var N=-1;break;case 2:N=250;break;case 5:N=1073741823;break;case 4:N=1e4;break;default:N=5e3}return N=Y+N,z={id:g++,callback:K,priorityLevel:z,startTime:Y,expirationTime:N,sortIndex:-1},Y>Ee?(z.sortIndex=Y,e(m,z),i(p)===null&&z===i(m)&&(A?(O(I),I=-1):A=!0,de(H,Y-Ee))):(z.sortIndex=N,e(p,z),E||M||(E=!0,k||(k=!0,ce()))),z},r.unstable_shouldYield=w,r.unstable_wrapCallback=function(z){var K=v;return function(){var Y=v;v=K;try{return z.apply(this,arguments)}finally{v=Y}}}}(ch)),ch}var w0;function By(){return w0||(w0=1,lh.exports=Py()),lh.exports}var uh={exports:{}},Rn={};/**
 * @license React
...
Please change the parent <Route path="${U}"> to <Route path="${U==="/"?"*":`${U}/*`}">.`)}let v=Za(),M;if(e){let U=typeof e=="string"?Dr(e):e;qt(g==="/"||((O=U.pathname)==null?void 0:O.startsWith(g)),`When overriding the location using \`<Routes location>\` or \`useRoutes(routes, location)\`, the location pathname must begin with the portion of the URL pathname that was matched by all parent routes. The current pathname base is "${g}" but pathname "${U.pathname}" was given in the \`location\` prop.`),M=U}else M=v;let E=M.pathname||"/",A=E;if(g!=="/"){let U=g.replace(/^\//,"").split("/");A="/"+E.replace(/^\//,"").split("/").slice(U.length).join("/")}let y=!c&&i&&i.matches&&i.matches.length>0?i.matches:B_(r,{pathname:A});vi(x||y!=null,`No routes matched location "${M.pathname}${M.search}${M.hash}" `),vi(y==null||y[y.length-1].route.element!==void 0||y[y.length-1].route.Component!==void 0||y[y.length-1].route.lazy!==void 0,`Matched leaf route at location "${M.pathname}${M.search}${M.hash}" does not have an element or Component. This means it will render an <Outlet /> with a null value by default resulting in an "empty" page.`);let _=ES(y&&y.map(U=>Object.assign({},U,{params:Object.assign({},p,U.params),pathname:aa([g,l.encodeLocation?l.encodeLocation(U.pathname).pathname:U.pathname]),pathnameBase:U.pathnameBase==="/"?g:aa([g,l.encodeLocation?l.encodeLocation(U.pathnameBase).pathname:U.pathnameBase])})),h,i,s);return e&&_?pe.createElement(Zo.Provider,{value:{location:{pathname:"/",search:"",hash:"",state:null,key:"default",...M},navigationType:"POP"}},_):_}function xS(){let r=wS(),e=fS(r)?`${r.status} ${r.statusText}`:r instanceof Error?r.message:JSON.stringify(r),i=r instanceof Error?r.stack:null,s="rgba(200,200,200, 0.5)",l={padding:"0.5rem",backgroundColor:s},c={padding:"2px 4px",backgroundColor:s},h=null;return console.error("Error handled by React Router default ErrorBoundary:",r),h=pe.createElement(pe.Fragment,null,pe.createElement("p",null,"💿 Hey developer 👋"),pe.createElement("p",null,"You can provide a way better UX than this when your app throws errors by providing your own ",pe.createElement("code",{style:c},"ErrorBoundary")," or"," ",pe.createElement("code",{style:c},"errorElement")," prop on your route.")),pe.createElement(pe.Fragment,null,pe.createElement("h2",null,"Unexpected Application Error!"),pe.createElement("h3",{style:{fontStyle:"italic"}},e),i?pe.createElement("pre",{style:l},i):null,h)}var yS=pe.createElement(xS,null),SS=class extends pe.Component{constructor(r){super(r),this.state={location:r.location,revalidation:r.revalidation,error:r.error}}static getDerivedStateFromError(r){return{error:r}}static getDerivedStateFromProps(r,e){return e.location!==r.location||e.revalidation!=="idle"&&r.revalidation==="idle"?{error:r.error,location:r.location,revalidation:r.revalidation}:{error:r.error!==void 0?r.error:e.error,location:e.location,revalidation:r.revalidation||e.revalidation}}componentDidCatch(r,e){console.error("React Router caught the following error during render",r,e)}render(){return this.state.error!==void 0?pe.createElement(ca.Provider,{value:this.props.routeContext},pe.createElement(Pd.Provider,{value:this.state.error,children:this.props.component})):this.props.children}};function MS({routeContext:r,match:e,children:i}){let s=pe.useContext(Ps);return s&&s.static&&s.staticContext&&(e.route.errorElement||e.route.ErrorBoundary)&&(s.staticContext._deepestRenderedBoundaryId=e.route.id),pe.createElement(ca.Provider,{value:r},i)}function ES(r,e=[],i=null,s=null){if(r==null){if(!i)return null;if(i.errors)r=i.matches;else if(e.length===0&&!i.initialized&&i.matches.length>0)r=i.matches;else return null}let l=r,c=i==null?void 0:i.errors;if(c!=null){let p=l.findIndex(m=>m.route.id&&(c==null?void 0:c[m.route.id])!==void 0);qt(p>=0,`Could not find a matching route for errors on route IDs: ${Object.keys(c).join(",")}`),l=l.slice(0,Math.min(l.length,p+1))}let h=!1,d=-1;if(i)for(let p=0;p<l.length;p++){let m=l[p];if((m.route.HydrateFallback||m.route.hydrateFallbackElement)&&(d=p),m.route.id){let{loaderData:g,errors:x}=i,v=m.route.loader&&!g.hasOwnProperty(m.route.id)&&(!x||x[m.route.id]===void 0);if(m.route.lazy||v){h=!0,d>=0?l=l.slice(0,d+1):l=[l[0]];break}}}return l.reduceRight((p,m,g)=>{let x,v=!1,M=null,E=null;i&&(x=c&&m.route.id?c[m.route.id]:void 0,M=m.route.errorElement||yS,h&&(d<0&&g===0?(j_("route-fallback",!1,"No `HydrateFallback` element provided to render during initial hydration"),v=!0,E=null):d===g&&(v=!0,E=m.route.hydrateFallbackElement||null)));let A=e.concat(l.slice(0,g+1)),y=()=>{let _;return x?_=M:v?_=E:m.route.Component?_=pe.createElement(m.route.Component,null):m.route.element?_=m.route.element:_=p,pe.createElement(MS,{match:m,routeContext:{outlet:p,matches:A,isDataRoute:i!=null},children:_})};return i&&(m.route.ErrorBoundary||m.route.errorElement||g===0)?pe.createElement(SS,{location:i.location,revalidation:i.revalidation,component:M,error:x,children:y(),routeContext:{outlet:null,matches:A,isDataRoute:!0}}):y()},null)}function Bd(r){return`${r} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function bS(r){let e=pe.useContext(Ps);return qt(e,Bd(r)),e}function TS(r){let e=pe.useContext(Qc);return qt(e,Bd(r)),e}function AS(r){let e=pe.useContext(ca);return qt(e,Bd(r)),e}function zd(r){let e=AS(r),i=e.matches[e.matches.length-1];return qt(i.route.id,`${r} can only be used on routes that contain a unique "id"`),i.route.id}function RS(){return zd("useRouteId")}function wS(){var s;let r=pe.useContext(Pd),e=TS("useRouteError"),i=zd("useRouteError");return r!==void 0?r:(s=e.errors)==null?void 0:s[i]}function CS(){let{router:r}=bS("useNavigate"),e=zd("useNavigate"),i=pe.useRef(!1);return X_(()=>{i.current=!0}),pe.useCallback(async(l,c={})=>{vi(i.current,k_),i.current&&(typeof l=="number"?r.navigate(l):await r.navigate(l,{fromRouteId:e,...c}))},[r,e])}var z0={};function j_(r,e,i){!e&&!z0[r]&&(z0[r]=!0,vi(!1,i))}pe.memo(DS);function DS({routes:r,future:e,state:i}){return W_(r,void 0,i,e)}function Ts(r){qt(!1,"A <Route> is only ever to be used as the child of <Routes> element, never rendered directly. Please wrap your <Route> in a <Routes>.")}function US({basename:r="/",children:e=null,location:i,navigationType:s="POP",navigator:l,static:c=!1}){qt(!Ko(),"You cannot render a <Router> inside another <Router>. You should never have more than one in your app.");let h=r.replace(/^\/*/,"/"),d=pe.useMemo(()=>({basename:h,navigator:l,static:c,future:{}}),[h,l,c]);typeof i=="string"&&(i=Dr(i));let{pathname:p="/",search:m="",hash:g="",state:x=null,key:v="default"}=i,M=pe.useMemo(()=>{let E=sa(p,h);return E==null?null:{location:{pathname:E,search:m,hash:g,state:x,key:v},navigationType:s}},[h,p,m,g,x,v,s]);return vi(M!=null,`<Router basename="${h}"> is not able to match the URL "${p}${m}${g}" because it does not start with the basename, so the <Router> won't render anything.`),M==null?null:pe.createElement(Ci.Provider,{value:d},pe.createElement(Zo.Provider,{children:e,value:M}))}function LS({children:r,location:e}){return vS(Xh(r),e)}function Xh(r,e=[]){let i=[];return pe.Children.forEach(r,(s,l)=>{if(!pe.isValidElement(s))return;let c=[...e,l];if(s.type===pe.Fragment){i.push.apply(i,Xh(s.props.children,c));return}qt(s.type===Ts,`[${typeof s.type=="string"?s.type:s.type.name}] is not a <Route> component. All component children of <Routes> must be a <Route> or <React.Fragment>`),qt(!s.props.index||!s.props.children,"An index route cannot have child routes.");let h={id:s.props.id||c.join("-"),caseSensitive:s.props.caseSensitive,element:s.props.element,Component:s.props.Component,index:s.props.index,path:s.props.path,loader:s.props.loader,action:s.props.action,hydrateFallbackElement:s.props.hydrateFallbackElement,HydrateFallback:s.props.HydrateFallback,errorElement:s.props.errorElement,ErrorBoundary:s.props.ErrorBoundary,hasErrorBoundary:s.props.hasErrorBoundary===!0||s.props.ErrorBoundary!=null||s.props.errorElement!=null,shouldRevalidate:s.props.shouldRevalidate,handle:s.props.handle,lazy:s.props.lazy};s.props.children&&(h.children=Xh(s.props.children,c)),i.push(h)}),i}var Bc="get",zc="application/x-www-form-urlencoded";function Jc(r){return r!=null&&typeof r.tagName=="string"}function NS(r){return Jc(r)&&r.tagName.toLowerCase()==="button"}function OS(r){return Jc(r)&&r.tagName.toLowerCase()==="form"}function PS(r){return Jc(r)&&r.tagName.toLowerCase()==="input"}function BS(r){return!!(r.metaKey||r.altKey||r.ctrlKey||r.shiftKey)}function zS(r,e){return r.button===0&&(!e||e==="_self")&&!BS(r)}var hc=null;function IS(){if(hc===null)try{new FormData(document.createElement("form"),0),hc=!1}catch{hc=!0}return hc}var FS=new Set(["application/x-www-form-urlencoded","multipart/form-data","text/plain"]);function hh(r){return r!=null&&!FS.has(r)?(vi(!1,`"${r}" is not a valid \`encType\` for \`<Form>\`/\`<fetcher.Form>\` and will default to "${zc}"`),null):r}function HS(r,e){let i,s,l,c,h;if(OS(r)){let d=r.getAttribute("action");s=d?sa(d,e):null,i=r.getAttribute("method")||Bc,l=hh(r.getAttribute("enctype"))||zc,c=new FormData(r)}else if(NS(r)||PS(r)&&(r.type==="submit"||r.type==="image")){let d=r.form;if(d==null)throw new Error('Cannot submit a <button> or <input type="submit"> without a <form>');let p=r.getAttribute("formaction")||d.getAttribute("action");if(s=p?sa(p,e):null,i=r.getAttribute("formmethod")||d.getAttribute("method")||Bc,l=hh(r.getAttribute("formenctype"))||hh(d.getAttribute("enctype"))||zc,c=new FormData(d,r),!IS()){let{name:m,type:g,value:x}=r;if(g==="image"){let v=m?`${m}.`:"";c.append(`${v}x`,"0"),c.append(`${v}y`,"0")}else m&&c.append(m,x)}}else{if(Jc(r))throw new Error('Cannot submit element that is not <form>, <button>, or <input type="submit|image">');i=Bc,s=null,l=zc,h=r}return c&&l==="text/plain"&&(h=c,c=void 0),{action:s,method:i.toLowerCase(),encType:l,formData:c,body:h}}function Id(r,e){if(r===!1||r===null||typeof r>"u")throw new Error(e)}async function GS(r,e){if(r.id in e)return e[r.id];try{let i=await import(r.module);return e[r.id]=i,i}catch(i){return console.error(`Error loading route module \`${r.module}\`, reloading page...`),console.error(i),window.__reactRouterContext&&window.__reactRouterContext.isSpaMode,window.location.reload(),new Promise(()=>{})}}function VS(r){return r==null?!1:r.href==null?r.rel==="preload"&&typeof r.imageSrcSet=="string"&&typeof r.imageSizes=="string":typeof r.rel=="string"&&typeof r.href=="string"}async function kS(r,e,i){let s=await Promise.all(r.map(async l=>{let c=e.routes[l.route.id];if(c){let h=await GS(c,i);return h.links?h.links():[]}return[]}));return qS(s.flat(1).filter(VS).filter(l=>l.rel==="stylesheet"||l.rel==="preload").map(l=>l.rel==="stylesheet"?{...l,rel:"prefetch",as:"style"}:{...l,rel:"prefetch"}))}function I0(r,e,i,s,l,c){let h=(p,m)=>i[m]?p.route.id!==i[m].route.id:!0,d=(p,m)=>{var g;return i[m].pathname!==p.pathname||((g=i[m].route.path)==null?void 0:g.endsWith("*"))&&i[m].params["*"]!==p.params["*"]};return c==="assets"?e.filter((p,m)=>h(p,m)||d(p,m)):c==="data"?e.filter((p,m)=>{var x;let g=s.routes[p.route.id];if(!g||!g.hasLoader)return!1;if(h(p,m)||d(p,m))return!0;if(p.route.shouldRevalidate){let v=p.route.shouldRevalidate({currentUrl:new URL(l.pathname+l.search+l.hash,window.origin),currentParams:((x=i[0])==null?void 0:x.params)||{},nextUrl:new URL(r,window.origin),nextParams:p.params,defaultShouldRevalidate:!0});if(typeof v=="boolean")return v}return!0}):[]}function XS(r,e,{includeHydrateFallback:i}={}){return WS(r.map(s=>{let l=e.routes[s.route.id];if(!l)return[];let c=[l.module];return l.clientActionModule&&(c=c.concat(l.clientActionModule)),l.clientLoaderModule&&(c=c.concat(l.clientLoaderModule)),i&&l.hydrateFallbackModule&&(c=c.concat(l.hydrateFallbackModule)),l.imports&&(c=c.concat(l.imports)),c}).flat(1))}function WS(r){return[...new Set(r)]}function jS(r){let e={},i=Object.keys(r).sort();for(let s of i)e[s]=r[s];return e}function qS(r,e){let i=new Set;return new Set(e),r.reduce((s,l)=>{let c=JSON.stringify(jS(l));return i.has(c)||(i.add(c),s.push({key:c,link:l})),s},[])}var YS=new Set([100,101,204,205]);function ZS(r,e){let i=typeof r=="string"?new URL(r,typeof window>"u"?"server://singlefetch/":window.location.origin):r;return i.pathname==="/"?i.pathname="_root.data":e&&sa(i.pathname,e)==="/"?i.pathname=`${e.replace(/\/$/,"")}/_root.data`:i.pathname=`${i.pathname.replace(/\/$/,"")}.data`,i}function q_(){let r=pe.useContext(Ps);return Id(r,"You must render this element inside a <DataRouterContext.Provider> element"),r}function KS(){let r=pe.useContext(Qc);return Id(r,"You must render this element inside a <DataRouterStateContext.Provider> element"),r}var Fd=pe.createContext(void 0);Fd.displayName="FrameworkContext";function Y_(){let r=pe.useContext(Fd);return Id(r,"You must render this element inside a <HydratedRouter> element"),r}function QS(r,e){let i=pe.useContext(Fd),[s,l]=pe.useState(!1),[c,h]=pe.useState(!1),{onFocus:d,onBlur:p,onMouseEnter:m,onMouseLeave:g,onTouchStart:x}=e,v=pe.useRef(null);pe.useEffect(()=>{if(r==="render"&&h(!0),r==="viewport"){let A=_=>{_.forEach(O=>{h(O.isIntersecting)})},y=new IntersectionObserver(A,{threshold:.5});return v.current&&y.observe(v.current),()=>{y.disconnect()}}},[r]),pe.useEffect(()=>{if(s){let A=setTimeout(()=>{h(!0)},100);return()=>{clearTimeout(A)}}},[s]);let M=()=>{l(!0)},E=()=>{l(!1),h(!1)};return i?r!=="intent"?[c,v,{}]:[c,v,{onFocus:Po(d,M),onBlur:Po(p,E),onMouseEnter:Po(m,M),onMouseLeave:Po(g,E),onTouchStart:Po(x,M)}]:[!1,v,{}]}function Po(r,e){return i=>{r&&r(i),i.defaultPrevented||e(i)}}function JS({page:r,...e}){let{router:i}=q_(),s=pe.useMemo(()=>B_(i.routes,r,i.basename),[i.routes,r,i.basename]);return s?pe.createElement(e1,{page:r,matches:s,...e}):null}function $S(r){let{manifest:e,routeModules:i}=Y_(),[s,l]=pe.useState([]);return pe.useEffect(()=>{let c=!1;return kS(r,e,i).then(h=>{c||l(h)}),()=>{c=!0}},[r,e,i]),s}function e1({page:r,matches:e,...i}){let s=Za(),{manifest:l,routeModules:c}=Y_(),{basename:h}=q_(),{loaderData:d,matches:p}=KS(),m=pe.useMemo(()=>I0(r,e,p,l,s,"data"),[r,e,p,l,s]),g=pe.useMemo(()=>I0(r,e,p,l,s,"assets"),[r,e,p,l,s]),x=pe.useMemo(()=>{if(r===s.pathname+s.search+s.hash)return[];let E=new Set,A=!1;if(e.forEach(_=>{var U;let O=l.routes[_.route.id];!O||!O.hasLoader||(!m.some(C=>C.route.id===_.route.id)&&_.route.id in d&&((U=c[_.route.id])!=null&&U.shouldRevalidate)||O.hasClientLoader?A=!0:E.add(_.route.id))}),E.size===0)return[];let y=ZS(r,h);return A&&E.size>0&&y.searchParams.set("_routes",e.filter(_=>E.has(_.route.id)).map(_=>_.route.id).join(",")),[y.pathname+y.search]},[h,d,s,l,m,e,r,c]),v=pe.useMemo(()=>XS(g,l),[g,l]),M=$S(g);return pe.createElement(pe.Fragment,null,x.map(E=>pe.createElement("link",{key:E,rel:"prefetch",as:"fetch",href:E,...i})),v.map(E=>pe.createElement("link",{key:E,rel:"modulepreload",href:E,...i})),M.map(({key:E,link:A})=>pe.createElement("link",{key:E,...A})))}function t1(...r){return e=>{r.forEach(i=>{typeof i=="function"?i(e):i!=null&&(i.current=e)})}}var Z_=typeof window<"u"&&typeof window.document<"u"&&typeof window.document.createElement<"u";try{Z_&&(window.__reactRouterVersion="7.5.3")}catch{}function n1({basename:r,children:e,window:i}){let s=pe.useRef();s.current==null&&(s.current=ky({window:i,v5Compat:!0}));let l=s.current,[c,h]=pe.useState({action:l.action,location:l.location}),d=pe.useCallback(p=>{pe.startTransition(()=>h(p))},[h]);return pe.useLayoutEffect(()=>l.listen(d),[l,d]),pe.createElement(US,{basename:r,children:e,location:c.location,navigationType:c.action,navigator:l})}var K_=/^(?:[a-z][a-z0-9+.-]*:|\/\/)/i,Ur=pe.forwardRef(function({onClick:e,discover:i="render",prefetch:s="none",relative:l,reloadDocument:c,replace:h,state:d,target:p,to:m,preventScrollReset:g,viewTransition:x,...v},M){let{basename:E}=pe.useContext(Ci),A=typeof m=="string"&&K_.test(m),y,_=!1;if(typeof m=="string"&&A&&(y=m,Z_))try{let D=new URL(window.location.href),w=m.startsWith("//")?new URL(D.protocol+m):new URL(m),V=sa(w.pathname,E);w.origin===D.origin&&V!=null?m=V+w.search+w.hash:_=!0}catch{vi(!1,`<Link to="${m}"> contains an invalid URL which will probably break when clicked - please update to a valid URL path.`)}let O=mS(m,{relative:l}),[U,C,H]=QS(s,v),k=s1(m,{replace:h,state:d,target:p,preventScrollReset:g,relative:l,viewTransition:x});function I(D){e&&e(D),D.defaultPrevented||k(D)}let j=pe.createElement("a",{...v,...H,href:y||O,onClick:_||c?e:I,ref:t1(M,C),target:p,"data-discover":!A&&i==="render"?"true":void 0});return U&&!A?pe.createElement(pe.Fragment,null,j,pe.createElement(JS,{page:O})):j});Ur.displayName="Link";var i1=pe.forwardRef(function({"aria-current":e="page",caseSensitive:i=!1,className:s="",end:l=!1,style:c,to:h,viewTransition:d,children:p,...m},g){let x=Qo(h,{relative:m.relative}),v=Za(),M=pe.useContext(Qc),{navigator:E,basename:A}=pe.useContext(Ci),y=M!=null&&f1(x)&&d===!0,_=E.encodeLocation?E.encodeLocation(x).pathname:x.pathname,O=v.pathname,U=M&&M.navigation&&M.navigation.location?M.navigation.location.pathname:null;i||(O=O.toLowerCase(),U=U?U.toLowerCase():null,_=_.toLowerCase()),U&&A&&(U=sa(U,A)||U);const C=_!=="/"&&_.endsWith("/")?_.length-1:_.length;let H=O===_||!l&&O.startsWith(_)&&O.charAt(C)==="/",k=U!=null&&(U===_||!l&&U.startsWith(_)&&U.charAt(_.length)==="/"),I={isActive:H,isPending:k,isTransitioning:y},j=H?e:void 0,D;typeof s=="function"?D=s(I):D=[s,H?"active":null,k?"pending":null,y?"transitioning":null].filter(Boolean).join(" ");let w=typeof c=="function"?c(I):c;return pe.createElement(Ur,{...m,"aria-current":j,className:D,ref:g,style:w,to:h,viewTransition:d},typeof p=="function"?p(I):p)});i1.displayName="NavLink";var a1=pe.forwardRef(({discover:r="render",fetcherKey:e,navigate:i,reloadDocument:s,replace:l,state:c,method:h=Bc,action:d,onSubmit:p,relative:m,preventScrollReset:g,viewTransition:x,...v},M)=>{let E=c1(),A=u1(d,{relative:m}),y=h.toLowerCase()==="get"?"get":"post",_=typeof d=="string"&&K_.test(d),O=U=>{if(p&&p(U),U.defaultPrevented)return;U.preventDefault();let C=U.nativeEvent.submitter,H=(C==null?void 0:C.getAttribute("formmethod"))||h;E(C||U.currentTarget,{fetcherKey:e,method:H,navigate:i,replace:l,state:c,relative:m,preventScrollReset:g,viewTransition:x})};return pe.createElement("form",{ref:M,method:y,action:A,onSubmit:s?p:O,...v,"data-discover":!_&&r==="render"?"true":void 0})});a1.displayName="Form";function r1(r){return`${r} must be used within a data router.  See https://reactrouter.com/en/main/routers/picking-a-router.`}function Q_(r){let e=pe.useContext(Ps);return qt(e,r1(r)),e}function s1(r,{target:e,replace:i,state:s,preventScrollReset:l,relative:c,viewTransition:h}={}){let d=gS(),p=Za(),m=Qo(r,{relative:c});return pe.useCallback(g=>{if(zS(g,e)){g.preventDefault();let x=i!==void 0?i:Xo(p)===Xo(m);d(r,{replace:x,state:s,preventScrollReset:l,relative:c,viewTransition:h})}},[p,d,m,i,s,e,r,l,c,h])}var o1=0,l1=()=>`__${String(++o1)}__`;function c1(){let{router:r}=Q_("useSubmit"),{basename:e}=pe.useContext(Ci),i=RS();return pe.useCallback(async(s,l={})=>{let{action:c,method:h,encType:d,formData:p,body:m}=HS(s,e);if(l.navigate===!1){let g=l.fetcherKey||l1();await r.fetch(g,i,l.action||c,{preventScrollReset:l.preventScrollReset,formData:p,body:m,formMethod:l.method||h,formEncType:l.encType||d,flushSync:l.flushSync})}else await r.navigate(l.action||c,{preventScrollReset:l.preventScrollReset,formData:p,body:m,formMethod:l.method||h,formEncType:l.encType||d,replace:l.replace,state:l.state,fromRouteId:i,flushSync:l.flushSync,viewTransition:l.viewTransition})},[r,e,i])}function u1(r,{relative:e}={}){let{basename:i}=pe.useContext(Ci),s=pe.useContext(ca);qt(s,"useFormAction must be used inside a RouteContext");let[l]=s.matches.slice(-1),c={...Qo(r||".",{relative:e})},h=Za();if(r==null){c.search=h.search;let d=new URLSearchParams(c.search),p=d.getAll("index");if(p.some(g=>g==="")){d.delete("index"),p.filter(x=>x).forEach(x=>d.append("index",x));let g=d.toString();c.search=g?`?${g}`:""}}return(!r||r===".")&&l.route.index&&(c.search=c.search?c.search.replace(/^\?/,"?index&"):"?index"),i!=="/"&&(c.pathname=c.pathname==="/"?i:aa([i,c.pathname])),Xo(c)}function f1(r,e={}){let i=pe.useContext(V_);qt(i!=null,"`useViewTransitionState` must be used within `react-router-dom`'s `RouterProvider`.  Did you accidentally import `RouterProvider` from `react-router`?");let{basename:s}=Q_("useViewTransitionState"),l=Qo(r,{relative:e.relative});if(!i.isTransitioning)return!1;let c=sa(i.currentLocation.pathname,s)||i.currentLocation.pathname,h=sa(i.nextLocation.pathname,s)||i.nextLocation.pathname;return jc(l.pathname,h)!=null||jc(l.pathname,c)!=null}new TextEncoder;[...YS];const h1=()=>B.jsxs(B.Fragment,{children:[B.jsx("style",{children:`
        ...
        `}),B.jsxs("div",{id:"about_me_txt",className:"w-[80%] ml-10 mb-10 text-white",children:[B.jsxs("p",{children:["I’m an artist and engineering student based in Los Angeles. I grew up in Kentucky and earned my BFA from the School of the Art Institute of Chicago before moving to LA in 2017. My goal was to study alongside great acting teachers and I did that twice weekly, for four years. (Performance and emotion are ",B.jsx("span",{style:{fontStyle:"italic"},children:"other"})," fascinations of mine) "]}),B.jsx("p",{children:`My paintings explore the tension between painting as image and painting as object, where flatness meets surface. Something about the line in between object and image draws me into experimenting with what I consider to be "wrong-ness" in the work. I’m drawn to that moment when something feels just slightly off, when a move on a painting initially strikes me with revolting inadequacy—I'll often stop there.`}),B.jsx("p",{children:"Alongside my art practice, my studies as an engineering student have a focus on product design, app interfaces, and data analysis. I’m interested in how systems break down and reassemble—whether in a canvas or a codebase. My work moves between those worlds, and they feed each other in unexpected ways."}),B.jsx("p",{children:"As an artist, I like breaking things. As an engineer, creating things."})]})]}),Cs="Cal Sans",Go="Oswald",Xa="Arial, sans",d1=1e3,qc="Jay H. Crawford",Ic="65",ko="opacity-65 font-bold text-white",p1=r=>B.jsxs(B.Fragment,{children:["      ",r.url==""&&B.jsx("div",{id:"this_one",className:"h-30 w-30 absolute",children:B.jsx("img",{src:"./under_construction.svg"})}),B.jsx("div",{style:{boxShadow:"5px 5px 5px rgba(0, 0, 0, 1)"},className:"gridPhoto_Image_container w-80 h-60",children:B.jsx("img",{className:"rounded-lg w-80 h-60",style:{objectFit:"cover"},src:r.img})})]}),m1=r=>{const[e,i]=pe.useState(!1);return B.jsx("div",{onMouseEnter:()=>i(!0),onMouseLeave:()=>i(!1),children:B.jsx(Ur,{id:"",to:r.url?r.url:"",children:B.jsx("div",{className:"gridPhoto_container p-1 m-2 flex justify-center",children:B.jsxs("div",{className:`gridPhoto_item_container m-2 inline ${r.url==""&&"cursor-not-allowed"}`,children:[B.jsx("style",{children:`
              ...
              `}),B.jsx("div",{className:"relative",children:B.jsxs("div",{className:" h-full w-full relative z-100",children:[B.jsx("div",{className:`${r.url==""&&e?"absolute":"hidden"} w-full absolute text-white font-black bg-red-600 top-[120px] p-4 text-center`,children:"Under Construction"}),B.jsx(p1,{img:r.img,url:r.url})]})}),B.jsx("div",{children:B.jsx("h4",{style:{fontFamily:Cs},className:"text-2xl text-white p-4 abt_gridPhotoItem",children:r.title})})]})})})})},g1=r=>{const e=()=>r.width<2e3?"w-full":"w-[60%]",i=()=>r.width<750?"grid-cols-1":"grid-cols-2";return B.jsx("div",{id:"grid_container",className:`grid ${e()} ${i()}`,children:r.categories.map((s,l)=>B.jsx("span",{children:B.jsx(m1,{title:s.category,img:s.img,url:s.url?s.url:""})},`${l}-${s.category}`))})},_1=r=>B.jsx(g1,{width:r.width,categories:r.category_array}),v1="https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/painting/",Wh=["KP.webp","G.webp","alien_invasion.webp","alley.webp","bad_painting.webp","bada_bing.webp","behind.webp","blinker.webp","blue_girl_1.webp","blue_girl_2.webp","bouquet.webp","bright_lights_big_city.webp","business_card.webp","california_onlookers.webp","connection.webp","dips.webp","eyes.webp","following.webp","funny_mustache_guy.webp","hilltop_city.webp","hollywood_hills.webp","house.webp","in_the_city.webp","jacks.webp","jacks_2.webp","james.webp","locked_away.webp","network.webp","night.webp","one_way.webp","online.webp","outlooker.webp","perspective.webp","pictures_of_then.webp","portrait_copy.webp","rainy_sun.webp","researchers.webp","street_corner.webp","sunday.webp","time.webp","tornado.webp","transfer.webp","victorian.webp","what_do_you.webp","woah_dude.webp","worm.webp","x.webp"],F0=r=>r&&r.endsWith(".webp")?r.slice(0,-5):"",H0=r=>{const e=()=>r.current>=Ln.length-5?Ln.slice(Ln.length-5,Ln.length):Ln.slice(r.current+1,r.current+6);return B.jsx("div",{className:"gallery_subImages",children:e().map(i=>B.jsxs("button",{className:"mini_gallery_image",onClick:()=>r.setCurrent(r.images_array.indexOf(i.title?i.title:"")),children:[B.jsx("style",{children:`
            ...
            `}),B.jsx("img",{src:i.src,alt:i.alt,title:i.title,className:"inline max-w-25 max-h-25 m-1 rounded-sm",loading:"lazy"},i.src)]}))})},Ln=Wh.map(r=>({src:`${v1}${r}`,alt:r,title:r})),J_="rgba(255,255,255,0.2)",x1={border:`3px solid ${J_}`,cursor:"not-allowed"},dc=r=>{const e=r.direction==="left"&&r.current===0||r.direction==="right"&&r.current===Ln.length-1;console.log(r.current,r.direction);const i=()=>{switch(r.graphic){case"caret-right":return B.jsx("div",{className:"h-10 w-10",children:B.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 320 512",children:B.jsx("path",{d:"M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"})})});case"caret-left":return B.jsx("div",{className:"h-10 w-10",children:B.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 320 512",children:B.jsx("path",{d:"M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l192 192c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L77.3 256 246.6 86.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-192 192z"})})});case"arrow-right":return B.jsx("div",{className:" h-8 w-8",children:B.jsx("svg",{className:"",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 448 512",children:B.jsx("path",{d:"M438.6 278.6c12.5-12.5 12.5-32.8 0-45.3l-160-160c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L338.8 224 32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l306.7 0L233.4 393.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l160-160z"})})});case"arrow-left":return B.jsx("div",{className:" h-8 w-8",children:B.jsx("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 448 512",children:B.jsx("path",{d:"M9.4 233.4c-12.5 12.5-12.5 32.8 0 45.3l160 160c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L109.2 288 416 288c17.7 0 32-14.3 32-32s-14.3-32-32-32l-306.7 0L214.6 118.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0l-160 160z"})})})}};return B.jsxs("button",{style:{...(r.graphic=="arrow-left"||r.graphic=="arrow-right")&&e?x1:{}},className:`inline-block ${r.graphic=="caret-left"||r.graphic=="caret-right"?"LR_bttn":"border-3 border-white LR_bttn"} cursor-pointer p-1 h-20 w-20 bg-none rounded-[50%]`,onClick:r.onclick_func,disabled:e,"aria-label":r.direction==="right"?"Next painting":"Previous painting",type:"button",children:[B.jsx("style",{children:`
        .LR_bttn:hover {
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            opacity: 100%;
            }`}),B.jsx("ul",{className:"footer_links text-md text-left",children:B.jsx("li",{children:B.jsxs("a",{href:"mailto:jayhcrawford@gmail.com",children:[B.jsx("p",{className:"font-bold",children:qc}),B.jsxs("span",{className:"font-normal",style:{fontFamily:Xa},children:[B.jsx("p",{children:"Los Angeles, CA"}),B.jsx("p",{children:"jayhcrawford@gmail.com"})]})]})})})]}),B.jsxs("div",{className:"grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2 text-left",children:[B.jsxs("div",{children:[B.jsx("h2",{className:"text-sm font-bold uppercase",children:"Social"}),B.jsxs("ul",{id:"footer_social",style:{fontFamily:Xa},className:"footer_links font-medium mt-3 mb-10",children:[B.jsx("style",{children:`
                      #footer_social li {
                        
                      }
                    `}),B.jsx("li",{children:B.jsx("a",{href:Cv,target:"new",className:"hover:underline",children:"LinkedIn"})}),B.jsx("li",{className:"",children:B.jsx("a",{href:Rv,target:"new",className:"hover:underline",children:"Instagram"})}),B.jsx("li",{children:B.jsx("a",{href:wv,target:"new",className:"hover:underline",children:"TikTok"})}),B.jsx("li",{children:B.jsx("a",{href:Nd,target:"new",className:"hover:underline",children:"Github"})})]})]}),B.jsx("div",{})]})]}),B.jsxs("div",{className:"sm:flex sm:items-center sm:justify-between",children:[B.jsxs("span",{style:{fontFamily:Xa},className:`font-normal text-sm text-white opacity-${Ic} sm:text-center`,children:[e," - ",qc]}),B.jsx("div",{className:"flex mt-4 sm:justify-center sm:mt-0",children:B.jsxs("a",{href:Nd,target:"new",className:`opacity-${Ic} hover:opacity-100 hover:white ms-5`,children:[B.jsx("svg",{className:"w-4 h-4","aria-hidden":"true",xmlns:"http://www.w3.org/2000/svg",fill:"currentColor",viewBox:"0 0 20 20",children:B.jsx("path",{fillRule:"evenodd",d:"M10 .333A9.911 9.911 0 0 0 6.866 19.65c.5.092.678-.215.678-.477 0-.237-.01-1.017-.014-1.845-2.757.6-3.338-1.169-3.338-1.169a2.627 2.627 0 0 0-1.1-1.451c-.9-.615.07-.6.07-.6a2.084 2.084 0 0 1 1.518 1.021 2.11 2.11 0 0 0 2.884.823c.044-.503.268-.973.63-1.325-2.2-.25-4.516-1.1-4.516-4.9A3.832 3.832 0 0 1 4.7 7.068a3.56 3.56 0 0 1 .095-2.623s.832-.266 2.726 1.016a9.409 9.409 0 0 1 4.962 0c1.89-1.282 2.717-1.016 2.717-1.016.366.83.402 1.768.1 2.623a3.827 3.827 0 0 1 1.02 2.659c0 3.807-2.319 4.644-4.525 4.889a2.366 2.366 0 0 1 .673 1.834c0 1.326-.012 2.394-.012 2.72 0 .263.18.572.681.475A9.911 9.911 0 0 0 10 .333Z",clipRule:"evenodd"})}),B.jsx("span",{className:"sr-only",children:"GitHub account"})]})})]})]})})},NA=()=>B.jsx("img",{className:"w-30 ",src:"./LinkedIn_Logo.svg"}),OA=r=>B.jsx("div",{className:"social_brick_icon_container",style:{width:"150px"},children:B.jsxs("svg",{id:"Layer_1","data-name":"Layer 1",xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 40 40",className:"social-svg",children:[B.jsx("defs",{children:B.jsx("style",{children:`
                    .social-svg {
                        fill: white;
                    ...
                    `}),r.map((e,i)=>B.jsx("a",{"aria-label":`Our ${e.name}`,href:e.url,target:"_blank",className:"glow-button socialbrick-link",children:B.jsx(OA,{name:e.name})},i))]})})};function BA(r){return r?r.toLowerCase().split(" ").map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(" "):""}const bs=()=>B.jsx("span",{className:`${ko} ml-5 mr-5`,children:"|"}),Va=r=>B.jsx("li",{style:{transition:"opacity .1s .1s"},className:`${ko} hover:underline hover:opacity-100`,children:B.jsx(Ur,{to:`${r.name}`,children:BA(r.name)})}),zA=r=>r.path=="/"?B.jsxs(B.Fragment,{children:[B.jsx("nav",{className:"z-10 w-ful",children:B.jsxs("ul",{style:{fontFamily:Go},className:"list-none p-0 pb-4 m-0 flex justify-center text-xl sm:text-3xl md:text-5xl",children:[B.jsx(Va,{name:"about"}),B.jsx(bs,{}),B.jsx(Va,{name:"art"}),B.jsx(bs,{}),B.jsx(Va,{name:"projects"}),B.jsx(bs,{}),B.jsx(Va,{name:"contact"})]})}),B.jsxs("header",{style:{marginBottom:"70px"},children:[B.jsx("h1",{className:"text-center text-white",style:{fontFamily:Cs,fontSize:r.width<500?"3rem":"6rem",fontWeight:"bold"},children:qc}),B.jsx("p",{className:`${ko} text-5xl text-center`,style:{fontFamily:Go},children:"Interdisciplinary Creative & Programmer"}),B.jsx("p",{style:{fontFamily:Xa},className:`text-center p-4 ${ko} text-3xl`,children:"Los Angeles, CA"}),B.jsx(PA,{})]})]}):B.jsxs(B.Fragment,{children:[B.jsx("nav",{className:"z-10 w-full mb-5",children:B.jsxs("ul",{style:{fontFamily:Go},className:"list-none p-0 m-0 flex sm:text-2xl md:text-5xl",children:[B.jsx(Va,{name:"about"}),B.jsx(bs,{}),B.jsx(Va,{name:"art"}),B.jsx(bs,{}),B.jsx(Va,{name:"projects"}),B.jsx(bs,{}),B.jsx(Va,{name:"contact"})]})}),B.jsxs("header",{style:{marginBottom:"70px"},children:[B.jsx(Ur,{to:"/",children:B.jsx("h1",{className:"text-white",style:{fontFamily:Cs,fontSize:r.width<500?"1rem":"2rem",fontWeight:"bold"},children:qc})}),B.jsx("p",{className:`${ko} text-3xl text-left`,style:{fontFamily:Go},children:"Interdisciplinary Creative & Programmer"})]})]}),IA=r=>{let e="";return B.jsxs(B.Fragment,{children:[B.jsx("style",{children:`
        #location-bar {
        }
    ...
    `}),B.jsx("div",{id:"location-bar",children:r.split().map((i,s)=>(e+="/"+i,B.jsxs("span",{children:[B.jsx(Ur,{to:e,children:B.jsx("button",{className:"location-bar-bttn",children:i})}),s<r.split().length-1&&B.jsx("span",{className:"location-bar-arrow",children:">"})]},`${s}-location`)))})]})},FA=()=>B.jsxs("svg",{id:"Layer_6","data-name":"Layer 6",xmlns:"http://www.w3.org/2000/svg",xmlnsXlink:"http://www.w3.org/1999/xlink",viewBox:"0 0 1050 990",children:[B.jsx("defs",{children:B.jsx("style",{children:`
      .cls-1 {
        fill: #0e1a34;
      }
