 ...
 */var Wv;function uS(){if(Wv)return Wo;Wv=1;var a=Symbol.for("react.transitional.element"),e=Symbol.for("react.fragment");function n(s,l,c){var f=null;if(c!==void 0&&(f=""+c),l.key!==void 0&&(f=""+l.key),"key"in l){c={};for(var h in l)h!=="key"&&(c[h]=l[h])}else c=l;return l=c.ref,{$$typeof:a,type:s,key:f,ref:l!==void 0?l:null,props:c}}return Wo.Fragment=e,Wo.jsx=n,Wo.jsxs=n,Wo}var qv;function fS(){return qv||(qv=1,Mh.exports=uS()),Mh.exports}var b=fS(),bh={exports:{}},rt={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
	...
	if ( coord.x >= 1.0 ) {
		...
		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;
            ...
            opacity: 100%;
                    ...
                    `}),a.map((e,n)=>b.jsx("a",{"aria-label":`Our ${e.name}`,href:e.url,target:"_blank",className:"glow-button socialbrick-link",children:b.jsx(ow,{name:e.name})},n))]})})};function cw(a){return a?a.toLowerCase().split(" ").map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join(" "):""}const Fs=()=>b.jsx("span",{className:`${il} ml-5 mr-5`,children:"|"}),rr=a=>b.jsx("li",{style:{transition:"opacity .1s .1s"},className:`outline_nav_elem_text ${il} hover:underline hover:opacity-100`,children:b.jsxs(Wr,{to:`${a.name}`,children:[b.jsx("style",{children:`
 
        
        `}),cw(a.name)]})}),uw=a=>a.path=="/"?b.jsxs(b.Fragment,{children:[b.jsx("nav",{className:"z-10 w-ful",children:b.jsxs("ul",{style:{fontFamily:kr},className:"list-none p-0 pb-4 m-0 flex justify-center text-xl sm:text-3xl md:text-5xl",children:[b.jsx(rr,{name:"about"}),b.jsx(Fs,{}),b.jsx(rr,{name:"art"}),b.jsx(Fs,{}),b.jsx(rr,{name:"projects"}),b.jsx(Fs,{}),b.jsx(rr,{name:"contact"})]})}),b.jsxs("header",{style:{marginBottom:"70px"},children:[b.jsx("h1",{className:"text-center text-white",style:{fontFamily:ki,fontSize:a.width<500?"3rem":"6rem",fontWeight:"bold"},children:ol}),b.jsxs("p",{className:`${il} text-5xl text-center`,style:{fontFamily:kr},children:[b.jsx("span",{className:"block",children:"Engineering Student,"}),b.jsx("span",{children:"Interdisciplinary Creative & Programmer"})]}),b.jsx("p",{style:{fontFamily:Vi},className:`text-center p-4 ${il} text-3xl`,children:"Los Angeles, CA"}),b.jsx(lw,{})]})]}):b.jsxs(b.Fragment,{children:[b.jsx("nav",{className:"z-10 w-full mb-5",children:b.jsxs("ul",{style:{fontFamily:kr},className:"list-none p-0 m-0 flex sm:text-2xl md:text-5xl",children:[b.jsx(rr,{name:"about"}),b.jsx(Fs,{}),b.jsx(rr,{name:"art"}),b.jsx(Fs,{}),b.jsx(rr,{name:"projects"}),b.jsx(Fs,{}),b.jsx(rr,{name:"contact"})]})}),b.jsxs("header",{style:{marginBottom:"70px"},children:[b.jsx(Wr,{to:"/",children:b.jsx("h1",{className:"text-white",style:{fontFamily:ki,fontSize:a.width<500?"1rem":"2rem",fontWeight:"bold"},children:ol})}),b.jsx("p",{className:`${il} text-3xl text-left`,style:{fontFamily:kr},children:"Interdisciplinary Creative & Programmer"})]})]}),fw=()=>b.jsx("img",{className:"w-30 ",src:"./LinkedIn_Logo.svg"}),hw=a=>{let e="";const n=new Map(a.locationData.map(l=>[l.url.replace(/^\//,""),l.title])),s=l=>l.replace(/[_-]/g," ").trim().split(" ").filter(Boolean).map(f=>f.charAt(0).toUpperCase()+f.slice(1)).join(" ");return b.jsxs(b.Fragment,{children:[b.jsx("style",{children:`
        #location-bar {
        }
...
#`));this.skipRendering=e===0,this.needsSwap=!this.skipRendering,this.fullscreenMaterial.setShaderData(a)}recompile(){this.updateMaterial()}getDepthTexture(){return this.fullscreenMaterial.depthBuffer}setDepthTexture(a,e=dl){this.fullscreenMaterial.depthBuffer=a,this.fullscreenMaterial.depthPacking=e;for(const n of this.effects)n.setDepthTexture(a,e)}render(a,e,n,s,l){for(const c of this.effects)c.update(a,e,s);if(!this.skipRendering||this.renderToScreen){const c=this.fullscreenMaterial;c.inputBuffer=e.texture,c.time+=s*this.timeScale,a.setRenderTarget(this.renderToScreen?null:n),a.render(this.scene,this.camera)}}setSize(a,e){this.fullscreenMaterial.setSize(a,e);for(const n of this.effects)n.setSize(a,e)}initialize(a,e,n){this.renderer=a;for(const s of this.effects)s.initialize(a,e,n);this.updateMaterial(),n!==void 0&&n!==In&&(this.fullscreenMaterial.defines.FRAMEBUFFER_PRECISION_HIGH="1")}dispose(){super.dispose();for(const a of this.effects)a.removeEventListener("change",this.listener),a.dispose()}handleEvent(a){switch(a.type){case"change":this.recompile();break}}};const wR=()=>{const{width:a,height:e}=Q_(),n=he.useRef(null);return he.useEffect(()=>{const s=new fu,l=new Kn(75,a/e,.1,1e3),c=new K_({alpha:!0});c.setClearColor(0,0),c.setSize(a,e),c.domElement.style.position="absolute",c.domElement.style.top="0",c.domElement.style.left="0",c.domElement.style.zIndex="-1";const f=n.current;f instanceof HTMLElement&&!f.hasChildNodes()&&f.appendChild(c.domElement);const h=new tl;for(let x=0;x<50;x++){const S=.03+Math.random()*.07,M=new gp(S,7,7),w=new vu({color:"white"}),y=new xi(M,w);y.position.x=(Math.random()-.5)*10,y.position.y=(Math.random()-.5)*10,y.position.z=(Math.random()-.5)*10,h.add(y)}s.add(h),l.position.z=5,h.children.forEach(x=>{});const p=new Sw(c);p.addPass(new SR(s,l));const m=new yR({intensity:.15,luminanceThreshold:.007,luminanceSmoothing:.2,radius:15}),g=new AR(l,m);g.renderToScreen=!0,p.addPass(g);const _=()=>{requestAnimationFrame(_),h.rotation.x+=89e-6,h.rotation.y+=99e-6,p.render()};return _(),()=>{f&&f.removeChild(c.domElement)}},[a,e]),b.jsx("div",{id:"three_background",style:{position:"fixed",top:0,left:0,width:`${a}px`,height:`${e}px`,overflow:"hidden"},ref:n})},cd=a=>(console.log(a),b.jsx("div",{children:b.jsx($_,{width:a.width,categories:a.category_array})})),RR=()=>b.jsx("div",{children:b.jsxs(vl,{construction:!0,title:"The Book",children:[b.jsx(Mn,{text:"The Book is a project that I started in highschool. This is an expansive collection of great thoughts, ideas, practices, and philosphies."}),b.jsx(Mn,{text:`
                    ...
                    `})]})}),or=["https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_ALL_WORKOUTS.png","https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_DATA_BOARD.png","https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_DATA_BOARD_REGRESSION.png","https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_DATA_CHART.png","https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_ORIGIN_SHEET.png","https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_G_SHEET.png","https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_RAW_JSON.png","https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/rip_sheet_python_images/RIP_FILE.jpg"],CR=()=>b.jsx("div",{children:b.jsxs(vl,{construction:!0,title:"The Rip Sheet",children:[b.jsxs("section",{className:"rip-section rip-section--intro",children:[b.jsx(Is,{quote:"In 2018, I decided to learn weightlifting."}),b.jsx(Is,{quote:"Since then, I’ve been developing tools and systems to stay consistent."}),b.jsx(Mn,{text:"In 2018, I set out to learn weightlifting. Over time, through repeated iteration, I built a system I call the RIP Sheet. Early versions failed to track progress and enforce consistency—but I kept refining, testing, and improving. The name is a double entendre: a memento mori and a call to get ripped. Today is the day you make that change—this very rep."}),b.jsx("div",{className:"rip-figure rip-figure--single",children:b.jsx(ar,{variant:"quarter",src:or[4],alt:"Origin version of the RIP sheet layout",figureLabel:"Figure 1",figureCaption:"Early RIP sheet concept and structure.",imgClassName:"max-w-xs sm:max-w-sm lg:max-w-md"})})]}),b.jsxs("section",{className:"rip-section rip-section--analog",children:[b.jsx(Mn,{text:"The first version of the RIP Sheet was a physical worksheet—a structured attempt to bring discipline into the gym without relying on screens. The layout was clear, but the medium wasn’t. Tracking progress across loose pages quickly became impractical, and paper doesn’t hold up well in a gym environment."}),b.jsx(Mn,{text:"Alongside the sheet, I created a small reference packet for stretching and brought both with me to train."})]}),b.jsxs("section",{className:"rip-section rip-section--workbook",children:[b.jsx("div",{className:"rip-figure rip-figure--single",children:b.jsx(ar,{variant:"half",src:or[7],alt:"Original workbook used for tracking workouts in the initial prototyping phase",figureLabel:"Figure 2",figureCaption:"The workbook taken to the gym in the initial prototyping phase.",imgClassName:"max-w-xs sm:max-w-sm lg:max-w-md"})}),b.jsx(Mn,{text:"This workbook was the version I brought with me to the gym during early prototyping—an attempt to turn structure into habit. I found keeping track of the physical worksheets and transferring them into a digital format was very inconvenient."})]}),b.jsxs("section",{className:"rip-section rip-section--digital",children:[b.jsx(Mn,{text:"Eventually, I moved to Google Sheets, which made tracking progress far more efficient and reliable allowing me to track every rep I've made since 2022."}),b.jsx(Mn,{text:"Because I had already been collecting this data, I was able to analyze it later in a Linear Algebra for Data Science course in 2025. That work produced visualizations that made progress—both strong and weak—immediately visible."}),b.jsx(Mn,{text:"Early on, processing the data was inconsistent, and I experimented with both JavaScript and C++. Over time, I simplified the system: each set is stored as JSON, defined by exercise name, weight, reps, and date. This structure makes generating visualizations straightforward, with same-day workouts naturally aligning in the data."}),b.jsxs("div",{className:"rip-cta",children:[b.jsx("p",{className:"rip-cta__label",children:"Explore the notebooks + regression overlays"}),b.jsx(J_,{href:"https://colab.research.google.com/drive/1ENZlQbCl78q4ilT7lTgQ9YkcPgvTLV9d?usp=sharing",label:"View the Python analysis in Google Colab"})]}),b.jsxs("div",{className:"rip-gallery rip-gallery--grid",children:[b.jsx(ar,{variant:"half",src:or[6],alt:"Origin version of the RIP sheet layout",figureLabel:"Figure 3",figureCaption:"The data is stored in a way that makes it easy to analyze.",imgClassName:"max-w-xs sm:max-w-sm lg:max-w-md"}),b.jsx(ar,{variant:"half",src:or[5],alt:"Origin version of the RIP sheet layout",figureLabel:"Figure 4",figureCaption:"Although it looks basic, this is the system I've found supports consistency.",imgClassName:"max-w-xs sm:max-w-sm lg:max-w-md"}),b.jsx(ar,{variant:"half",src:or[0],alt:"Collection of all workouts tracked in the RIP sheet",figureLabel:"Figure 5",figureCaption:"Consolidated workout history view."})]})]}),b.jsxs("section",{className:"rip-section rip-section--insights",children:[b.jsx(Is,{quote:"Today is the day you make that life change—this very rep.",sizePreset:"balanced"}),b.jsx("div",{className:"rip-figure rip-figure--wide",children:b.jsx(ar,{variant:"centered",src:or[1],alt:"RIP sheet data board showing tracked exercise metrics",figureLabel:"Figure 6",figureCaption:"Data board used to monitor progress over time."})}),b.jsx(Is,{quote:"Fitting a linear regression to the data shows interesting trends.",sizePreset:"balanced"}),b.jsx(Mn,{text:"You can see the linear regression on the data sets that could be fit, and it shows trends which illuminate my habits."}),b.jsxs("div",{className:"rip-gallery rip-gallery--dual",children:[b.jsx(ar,{variant:"centered",src:or[2],alt:"Regression analysis chart generated from RIP sheet data",figureLabel:"Figure 7",figureCaption:"Least-squares regression snapshot for exercise trends."}),b.jsx(ar,{variant:"centered",src:or[3],alt:"Progress chart visualizing workout performance changes",figureLabel:"Figure 8",figureCaption:"Bar chart showing exercise type counts for the data captured."})]}),b.jsx(Mn,{text:"Recently, I took a linear algebra for data analysis course, and used Python to create least square regression analyses of each one of my exercises over the past 2.5 years. Seeing a visualization was highly motivational and validating for my stronger routines, but it also showed me clearly where I've been slacking recently."}),b.jsx(Is,{quote:"You can see below that I am trying to make my arms bigger 🤣😅",sizePreset:"balanced"})]}),b.jsxs("section",{className:"rip-section rip-section--future",children:[b.jsx(Mn,{text:"My hope is to create a fitness app that allows people to develop realistic and healthy physical fitness routines and give useful visualizations that will let users know for sure how to generate real physical progress. The gym habit can be challenging to adopt, and I want to help people to realize that learning that habit is counter-intuitive to initial first impressions. By dispelling the myth that you have to work really hard to get gains, I believe I can help people to adopt a habit that they love."}),b.jsx(Is,{quote:"I believe I can help people to adopt a habit that they love.",sizePreset:"balanced"})]})]})}),UR=()=>b.jsx("div",{children:b.jsxs(vl,{construction:!1,title:"UrFriends",children:[b.jsx(Mn,{text:"UrFriends is designed to help you build real, lasting relationships using your device. "}),b.jsx(QA,{url:"https://public--urfriends-beta.us-central1.hosted.app/",linkText:"The Latest UrFriends Deployment"}),b.jsx(Mn,{text:`
