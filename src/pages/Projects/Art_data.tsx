// TODO: Create new img icons for the relevant art categories
// TODO: integrate string substitutions for url names into LocationBar

export const art_array = [
    {
        category: "Painting",
        img: "https://jayhcrawford-webimages.s3.us-east-2.amazonaws.com/images/painting_dir/painting-web-icons/painting-web-icon.jpg",
        url: "painting"
    },
    {
        category: "Drawing",
