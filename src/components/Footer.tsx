        ...
        <div id="footer_content">
          <div className="md:flex md:justify-between">
            ...
            text-decoration: underline;
              ...
              <ul id="footer-contact-ul" className="text-md text-left">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2 text-left">
              ...
              <ul className="text-black  font-medium">
                <li className="mb-4">
                  <a  className="text-left text-black hover:underline">MLH Conduct Policy
                  </a></li>
              </ul>
            </div> */}

              <div>
                <h2 className="text-sm font-bold uppercase text-white">Social</h2>
                <ul style={{fontFamily: tertiaryFont}} className="text-white  font-medium mt-3 mb-10">
                  <li>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span style={{fontFamily: tertiaryFont}} className="font-normal text-sm text-white sm:text-center">{this_year} - {artist_name}
            </span>
            <div className="flex mt-4 sm:justify-center sm:mt-0">



              <a href={github} target="new" className="text-white hover:white ms-5">
