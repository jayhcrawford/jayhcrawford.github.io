...
/**
 * Shell component used by all long-form blog/case-study pages.
 * Handles the under-construction banner, shared padding, and typography
 * so the child pages only worry about content blocks.
 */
