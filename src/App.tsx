...
const SpaceBD = () => {
  return (
    ...
    <svg id="Layer_6" data-name="Layer 6" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" viewBox="0 0 1050 990">
      <defs>
        <style>
          {`
      .cls-1 {
...
const LocationBar = () => {
  return (
    ...
    background-color: var(--standard-location-bar-bttn-shadow);
    box-shadow: 3px 3px 10px black;
    border: solid 3px var(--standard-page-color);
    outline: solid 3px var(--standard-location-bar-bttn-shadow);
}
...
.location-bar-bttn {
    color: var(--standard-page-color);
    background-color: #9aaefc;
    cursor: pointer;
    font-size: 1rem;
    border: solid 3px var(--standard-page-color);
    outline: solid 3px #9aaefc;
}
        .location-bar-arrow {
            color: var(--standard-location-bar-bttn-shadow);
            margin-top: .3em;
            font-size: 2em;
        }
    ...
    `}</style>
      <div id="location-bar">
        <button onClick={() => console.log("click")} className="location-bar-bttn">Home</button>
        <span className="location-bar-arrow">{">"}</span>
        <button onClick={() => console.log("click")} className="location-bar-bttn">Art + Design</button>
        <span className="location-bar-arrow">{">"}</span>
        <button onClick={() => console.log("click")} className="location-bar-bttn">3D Projects</button>
      </div>
    </>
  )
}